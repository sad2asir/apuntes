const oc="modulepreload",tc=function(e){return"/apuntes/"+e},et={},z=function(r,n,a){if(!n||n.length===0)return r();const o=document.getElementsByTagName("link");return Promise.all(n.map(t=>{if(t=tc(t),t in et)return;et[t]=!0;const s=t.endsWith(".css"),c=s?'[rel="stylesheet"]':"";if(!!a)for(let d=o.length-1;d>=0;d--){const u=o[d];if(u.href===t&&(!s||u.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${t}"]${c}`))return;const l=document.createElement("link");if(l.rel=s?"stylesheet":oc,s||(l.as="script",l.crossOrigin=""),l.href=t,document.head.appendChild(l),s)return new Promise((d,u)=>{l.addEventListener("load",d),l.addEventListener("error",()=>u(new Error(`Unable to preload CSS for ${t}`)))})})).then(()=>r()).catch(t=>{const s=new Event("vite:preloadError",{cancelable:!0});if(s.payload=t,window.dispatchEvent(s),!s.defaultPrevented)throw t})};function bo(e,r){const n=Object.create(null),a=e.split(",");for(let o=0;o<a.length;o++)n[a[o]]=!0;return r?o=>!!n[o.toLowerCase()]:o=>!!n[o]}const qe={},on=[],or=()=>{},sc=()=>!1,ic=/^on[^a-z]/,Fn=e=>ic.test(e),vo=e=>e.startsWith("onUpdate:"),Ce=Object.assign,yo=(e,r)=>{const n=e.indexOf(r);n>-1&&e.splice(n,1)},cc=Object.prototype.hasOwnProperty,me=(e,r)=>cc.call(e,r),X=Array.isArray,tn=e=>_a(e)==="[object Map]",Ps=e=>_a(e)==="[object Set]",se=e=>typeof e=="function",be=e=>typeof e=="string",wo=e=>typeof e=="symbol",xe=e=>e!==null&&typeof e=="object",Ss=e=>xe(e)&&se(e.then)&&se(e.catch),qs=Object.prototype.toString,_a=e=>qs.call(e),lc=e=>_a(e).slice(8,-1),xs=e=>_a(e)==="[object Object]",Po=e=>be(e)&&e!=="NaN"&&e[0]!=="-"&&""+parseInt(e,10)===e,En=bo(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),ka=e=>{const r=Object.create(null);return n=>r[n]||(r[n]=e(n))},dc=/-(\w)/g,ur=ka(e=>e.replace(dc,(r,n)=>n?n.toUpperCase():"")),uc=/\B([A-Z])/g,Zr=ka(e=>e.replace(uc,"-$1").toLowerCase()),Ea=ka(e=>e.charAt(0).toUpperCase()+e.slice(1)),Ma=ka(e=>e?`on${Ea(e)}`:""),In=(e,r)=>!Object.is(e,r),Da=(e,r)=>{for(let n=0;n<e.length;n++)e[n](r)},da=(e,r,n)=>{Object.defineProperty(e,r,{configurable:!0,enumerable:!1,value:n})},pc=e=>{const r=parseFloat(e);return isNaN(r)?e:r},mc=e=>{const r=be(e)?Number(e):NaN;return isNaN(r)?e:r};let rt;const eo=()=>rt||(rt=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});function Bn(e){if(X(e)){const r={};for(let n=0;n<e.length;n++){const a=e[n],o=be(a)?bc(a):Bn(a);if(o)for(const t in o)r[t]=o[t]}return r}else{if(be(e))return e;if(xe(e))return e}}const hc=/;(?![^(]*\))/g,fc=/:([^]+)/,gc=/\/\*[^]*?\*\//g;function bc(e){const r={};return e.replace(gc,"").split(hc).forEach(n=>{if(n){const a=n.split(fc);a.length>1&&(r[a[0].trim()]=a[1].trim())}}),r}function Je(e){let r="";if(be(e))r=e;else if(X(e))for(let n=0;n<e.length;n++){const a=Je(e[n]);a&&(r+=a+" ")}else if(xe(e))for(const n in e)e[n]&&(r+=n+" ");return r.trim()}const vc="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",yc=bo(vc);function _s(e){return!!e||e===""}const Ae=e=>be(e)?e:e==null?"":X(e)||xe(e)&&(e.toString===qs||!se(e.toString))?JSON.stringify(e,ks,2):String(e),ks=(e,r)=>r&&r.__v_isRef?ks(e,r.value):tn(r)?{[`Map(${r.size})`]:[...r.entries()].reduce((n,[a,o])=>(n[`${a} =>`]=o,n),{})}:Ps(r)?{[`Set(${r.size})`]:[...r.values()]}:xe(r)&&!X(r)&&!xs(r)?String(r):r;let Ye;class wc{constructor(r=!1){this.detached=r,this._active=!0,this.effects=[],this.cleanups=[],this.parent=Ye,!r&&Ye&&(this.index=(Ye.scopes||(Ye.scopes=[])).push(this)-1)}get active(){return this._active}run(r){if(this._active){const n=Ye;try{return Ye=this,r()}finally{Ye=n}}}on(){Ye=this}off(){Ye=this.parent}stop(r){if(this._active){let n,a;for(n=0,a=this.effects.length;n<a;n++)this.effects[n].stop();for(n=0,a=this.cleanups.length;n<a;n++)this.cleanups[n]();if(this.scopes)for(n=0,a=this.scopes.length;n<a;n++)this.scopes[n].stop(!0);if(!this.detached&&this.parent&&!r){const o=this.parent.scopes.pop();o&&o!==this&&(this.parent.scopes[this.index]=o,o.index=this.index)}this.parent=void 0,this._active=!1}}}function Pc(e,r=Ye){r&&r.active&&r.effects.push(e)}function Es(){return Ye}function Sc(e){Ye&&Ye.cleanups.push(e)}const So=e=>{const r=new Set(e);return r.w=0,r.n=0,r},js=e=>(e.w&Lr)>0,Ts=e=>(e.n&Lr)>0,qc=({deps:e})=>{if(e.length)for(let r=0;r<e.length;r++)e[r].w|=Lr},xc=e=>{const{deps:r}=e;if(r.length){let n=0;for(let a=0;a<r.length;a++){const o=r[a];js(o)&&!Ts(o)?o.delete(e):r[n++]=o,o.w&=~Lr,o.n&=~Lr}r.length=n}},ua=new WeakMap;let _n=0,Lr=1;const ro=30;let nr;const $r=Symbol(""),no=Symbol("");class qo{constructor(r,n=null,a){this.fn=r,this.scheduler=n,this.active=!0,this.deps=[],this.parent=void 0,Pc(this,a)}run(){if(!this.active)return this.fn();let r=nr,n=zr;for(;r;){if(r===this)return;r=r.parent}try{return this.parent=nr,nr=this,zr=!0,Lr=1<<++_n,_n<=ro?qc(this):nt(this),this.fn()}finally{_n<=ro&&xc(this),Lr=1<<--_n,nr=this.parent,zr=n,this.parent=void 0,this.deferStop&&this.stop()}}stop(){nr===this?this.deferStop=!0:this.active&&(nt(this),this.onStop&&this.onStop(),this.active=!1)}}function nt(e){const{deps:r}=e;if(r.length){for(let n=0;n<r.length;n++)r[n].delete(e);r.length=0}}let zr=!0;const Cs=[];function gn(){Cs.push(zr),zr=!1}function bn(){const e=Cs.pop();zr=e===void 0?!0:e}function $e(e,r,n){if(zr&&nr){let a=ua.get(e);a||ua.set(e,a=new Map);let o=a.get(n);o||a.set(n,o=So()),zs(o)}}function zs(e,r){let n=!1;_n<=ro?Ts(e)||(e.n|=Lr,n=!js(e)):n=!e.has(nr),n&&(e.add(nr),nr.deps.push(e))}function vr(e,r,n,a,o,t){const s=ua.get(e);if(!s)return;let c=[];if(r==="clear")c=[...s.values()];else if(n==="length"&&X(e)){const i=Number(a);s.forEach((l,d)=>{(d==="length"||d>=i)&&c.push(l)})}else switch(n!==void 0&&c.push(s.get(n)),r){case"add":X(e)?Po(n)&&c.push(s.get("length")):(c.push(s.get($r)),tn(e)&&c.push(s.get(no)));break;case"delete":X(e)||(c.push(s.get($r)),tn(e)&&c.push(s.get(no)));break;case"set":tn(e)&&c.push(s.get($r));break}if(c.length===1)c[0]&&ao(c[0]);else{const i=[];for(const l of c)l&&i.push(...l);ao(So(i))}}function ao(e,r){const n=X(e)?e:[...e];for(const a of n)a.computed&&at(a);for(const a of n)a.computed||at(a)}function at(e,r){(e!==nr||e.allowRecurse)&&(e.scheduler?e.scheduler():e.run())}function _c(e,r){var n;return(n=ua.get(e))==null?void 0:n.get(r)}const kc=bo("__proto__,__v_isRef,__isVue"),As=new Set(Object.getOwnPropertyNames(Symbol).filter(e=>e!=="arguments"&&e!=="caller").map(e=>Symbol[e]).filter(wo)),Ec=xo(),jc=xo(!1,!0),Tc=xo(!0),ot=Cc();function Cc(){const e={};return["includes","indexOf","lastIndexOf"].forEach(r=>{e[r]=function(...n){const a=fe(this);for(let t=0,s=this.length;t<s;t++)$e(a,"get",t+"");const o=a[r](...n);return o===-1||o===!1?a[r](...n.map(fe)):o}}),["push","pop","shift","unshift","splice"].forEach(r=>{e[r]=function(...n){gn();const a=fe(this)[r].apply(this,n);return bn(),a}}),e}function zc(e){const r=fe(this);return $e(r,"has",e),r.hasOwnProperty(e)}function xo(e=!1,r=!1){return function(a,o,t){if(o==="__v_isReactive")return!e;if(o==="__v_isReadonly")return e;if(o==="__v_isShallow")return r;if(o==="__v_raw"&&t===(e?r?$c:Ns:r?Os:Rs).get(a))return a;const s=X(a);if(!e){if(s&&me(ot,o))return Reflect.get(ot,o,t);if(o==="hasOwnProperty")return zc}const c=Reflect.get(a,o,t);return(wo(o)?As.has(o):kc(o))||(e||$e(a,"get",o),r)?c:Le(c)?s&&Po(o)?c:c.value:xe(c)?e?vn(c):Un(c):c}}const Ac=Is(),Ic=Is(!0);function Is(e=!1){return function(n,a,o,t){let s=n[a];if(dn(s)&&Le(s)&&!Le(o))return!1;if(!e&&(!pa(o)&&!dn(o)&&(s=fe(s),o=fe(o)),!X(n)&&Le(s)&&!Le(o)))return s.value=o,!0;const c=X(n)&&Po(a)?Number(a)<n.length:me(n,a),i=Reflect.set(n,a,o,t);return n===fe(t)&&(c?In(o,s)&&vr(n,"set",a,o):vr(n,"add",a,o)),i}}function Lc(e,r){const n=me(e,r);e[r];const a=Reflect.deleteProperty(e,r);return a&&n&&vr(e,"delete",r,void 0),a}function Rc(e,r){const n=Reflect.has(e,r);return(!wo(r)||!As.has(r))&&$e(e,"has",r),n}function Oc(e){return $e(e,"iterate",X(e)?"length":$r),Reflect.ownKeys(e)}const Ls={get:Ec,set:Ac,deleteProperty:Lc,has:Rc,ownKeys:Oc},Nc={get:Tc,set(e,r){return!0},deleteProperty(e,r){return!0}},Mc=Ce({},Ls,{get:jc,set:Ic}),_o=e=>e,ja=e=>Reflect.getPrototypeOf(e);function Yn(e,r,n=!1,a=!1){e=e.__v_raw;const o=fe(e),t=fe(r);n||(r!==t&&$e(o,"get",r),$e(o,"get",t));const{has:s}=ja(o),c=a?_o:n?jo:Ln;if(s.call(o,r))return c(e.get(r));if(s.call(o,t))return c(e.get(t));e!==o&&e.get(r)}function Zn(e,r=!1){const n=this.__v_raw,a=fe(n),o=fe(e);return r||(e!==o&&$e(a,"has",e),$e(a,"has",o)),e===o?n.has(e):n.has(e)||n.has(o)}function Xn(e,r=!1){return e=e.__v_raw,!r&&$e(fe(e),"iterate",$r),Reflect.get(e,"size",e)}function tt(e){e=fe(e);const r=fe(this);return ja(r).has.call(r,e)||(r.add(e),vr(r,"add",e,e)),this}function st(e,r){r=fe(r);const n=fe(this),{has:a,get:o}=ja(n);let t=a.call(n,e);t||(e=fe(e),t=a.call(n,e));const s=o.call(n,e);return n.set(e,r),t?In(r,s)&&vr(n,"set",e,r):vr(n,"add",e,r),this}function it(e){const r=fe(this),{has:n,get:a}=ja(r);let o=n.call(r,e);o||(e=fe(e),o=n.call(r,e)),a&&a.call(r,e);const t=r.delete(e);return o&&vr(r,"delete",e,void 0),t}function ct(){const e=fe(this),r=e.size!==0,n=e.clear();return r&&vr(e,"clear",void 0,void 0),n}function Kn(e,r){return function(a,o){const t=this,s=t.__v_raw,c=fe(s),i=r?_o:e?jo:Ln;return!e&&$e(c,"iterate",$r),s.forEach((l,d)=>a.call(o,i(l),i(d),t))}}function Qn(e,r,n){return function(...a){const o=this.__v_raw,t=fe(o),s=tn(t),c=e==="entries"||e===Symbol.iterator&&s,i=e==="keys"&&s,l=o[e](...a),d=n?_o:r?jo:Ln;return!r&&$e(t,"iterate",i?no:$r),{next(){const{value:u,done:m}=l.next();return m?{value:u,done:m}:{value:c?[d(u[0]),d(u[1])]:d(u),done:m}},[Symbol.iterator](){return this}}}}function xr(e){return function(...r){return e==="delete"?!1:this}}function Dc(){const e={get(t){return Yn(this,t)},get size(){return Xn(this)},has:Zn,add:tt,set:st,delete:it,clear:ct,forEach:Kn(!1,!1)},r={get(t){return Yn(this,t,!1,!0)},get size(){return Xn(this)},has:Zn,add:tt,set:st,delete:it,clear:ct,forEach:Kn(!1,!0)},n={get(t){return Yn(this,t,!0)},get size(){return Xn(this,!0)},has(t){return Zn.call(this,t,!0)},add:xr("add"),set:xr("set"),delete:xr("delete"),clear:xr("clear"),forEach:Kn(!0,!1)},a={get(t){return Yn(this,t,!0,!0)},get size(){return Xn(this,!0)},has(t){return Zn.call(this,t,!0)},add:xr("add"),set:xr("set"),delete:xr("delete"),clear:xr("clear"),forEach:Kn(!0,!0)};return["keys","values","entries",Symbol.iterator].forEach(t=>{e[t]=Qn(t,!1,!1),n[t]=Qn(t,!0,!1),r[t]=Qn(t,!1,!0),a[t]=Qn(t,!0,!0)}),[e,n,r,a]}const[Fc,Bc,Uc,Hc]=Dc();function ko(e,r){const n=r?e?Hc:Uc:e?Bc:Fc;return(a,o,t)=>o==="__v_isReactive"?!e:o==="__v_isReadonly"?e:o==="__v_raw"?a:Reflect.get(me(n,o)&&o in a?n:a,o,t)}const Wc={get:ko(!1,!1)},Vc={get:ko(!1,!0)},Jc={get:ko(!0,!1)},Rs=new WeakMap,Os=new WeakMap,Ns=new WeakMap,$c=new WeakMap;function Gc(e){switch(e){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function Yc(e){return e.__v_skip||!Object.isExtensible(e)?0:Gc(lc(e))}function Un(e){return dn(e)?e:Eo(e,!1,Ls,Wc,Rs)}function Ms(e){return Eo(e,!1,Mc,Vc,Os)}function vn(e){return Eo(e,!0,Nc,Jc,Ns)}function Eo(e,r,n,a,o){if(!xe(e)||e.__v_raw&&!(r&&e.__v_isReactive))return e;const t=o.get(e);if(t)return t;const s=Yc(e);if(s===0)return e;const c=new Proxy(e,s===2?a:n);return o.set(e,c),c}function sn(e){return dn(e)?sn(e.__v_raw):!!(e&&e.__v_isReactive)}function dn(e){return!!(e&&e.__v_isReadonly)}function pa(e){return!!(e&&e.__v_isShallow)}function Ds(e){return sn(e)||dn(e)}function fe(e){const r=e&&e.__v_raw;return r?fe(r):e}function Fs(e){return da(e,"__v_skip",!0),e}const Ln=e=>xe(e)?Un(e):e,jo=e=>xe(e)?vn(e):e;function Bs(e){zr&&nr&&(e=fe(e),zs(e.dep||(e.dep=So())))}function Us(e,r){e=fe(e);const n=e.dep;n&&ao(n)}function Le(e){return!!(e&&e.__v_isRef===!0)}function ge(e){return Hs(e,!1)}function To(e){return Hs(e,!0)}function Hs(e,r){return Le(e)?e:new Zc(e,r)}class Zc{constructor(r,n){this.__v_isShallow=n,this.dep=void 0,this.__v_isRef=!0,this._rawValue=n?r:fe(r),this._value=n?r:Ln(r)}get value(){return Bs(this),this._value}set value(r){const n=this.__v_isShallow||pa(r)||dn(r);r=n?r:fe(r),In(r,this._rawValue)&&(this._rawValue=r,this._value=n?r:Ln(r),Us(this))}}function ee(e){return Le(e)?e.value:e}const Xc={get:(e,r,n)=>ee(Reflect.get(e,r,n)),set:(e,r,n,a)=>{const o=e[r];return Le(o)&&!Le(n)?(o.value=n,!0):Reflect.set(e,r,n,a)}};function Ws(e){return sn(e)?e:new Proxy(e,Xc)}function Ta(e){const r=X(e)?new Array(e.length):{};for(const n in e)r[n]=Qc(e,n);return r}class Kc{constructor(r,n,a){this._object=r,this._key=n,this._defaultValue=a,this.__v_isRef=!0}get value(){const r=this._object[this._key];return r===void 0?this._defaultValue:r}set value(r){this._object[this._key]=r}get dep(){return _c(fe(this._object),this._key)}}function Qc(e,r,n){const a=e[r];return Le(a)?a:new Kc(e,r,n)}class el{constructor(r,n,a,o){this._setter=n,this.dep=void 0,this.__v_isRef=!0,this.__v_isReadonly=!1,this._dirty=!0,this.effect=new qo(r,()=>{this._dirty||(this._dirty=!0,Us(this))}),this.effect.computed=this,this.effect.active=this._cacheable=!o,this.__v_isReadonly=a}get value(){const r=fe(this);return Bs(r),(r._dirty||!r._cacheable)&&(r._dirty=!1,r._value=r.effect.run()),r._value}set value(r){this._setter(r)}}function rl(e,r,n=!1){let a,o;const t=se(e);return t?(a=e,o=or):(a=e.get,o=e.set),new el(a,o,t||!o,n)}function Ar(e,r,n,a){let o;try{o=a?e(...a):e()}catch(t){Hn(t,r,n)}return o}function Qe(e,r,n,a){if(se(e)){const t=Ar(e,r,n,a);return t&&Ss(t)&&t.catch(s=>{Hn(s,r,n)}),t}const o=[];for(let t=0;t<e.length;t++)o.push(Qe(e[t],r,n,a));return o}function Hn(e,r,n,a=!0){const o=r?r.vnode:null;if(r){let t=r.parent;const s=r.proxy,c=n;for(;t;){const l=t.ec;if(l){for(let d=0;d<l.length;d++)if(l[d](e,s,c)===!1)return}t=t.parent}const i=r.appContext.config.errorHandler;if(i){Ar(i,null,10,[e,s,c]);return}}nl(e,n,o,a)}function nl(e,r,n,a=!0){console.error(e)}let Rn=!1,oo=!1;const Fe=[];let dr=0;const cn=[];let fr=null,Hr=0;const Vs=Promise.resolve();let Co=null;function Wn(e){const r=Co||Vs;return e?r.then(this?e.bind(this):e):r}function al(e){let r=dr+1,n=Fe.length;for(;r<n;){const a=r+n>>>1;On(Fe[a])<e?r=a+1:n=a}return r}function Ca(e){(!Fe.length||!Fe.includes(e,Rn&&e.allowRecurse?dr+1:dr))&&(e.id==null?Fe.push(e):Fe.splice(al(e.id),0,e),Js())}function Js(){!Rn&&!oo&&(oo=!0,Co=Vs.then($s))}function ol(e){const r=Fe.indexOf(e);r>dr&&Fe.splice(r,1)}function tl(e){X(e)?cn.push(...e):(!fr||!fr.includes(e,e.allowRecurse?Hr+1:Hr))&&cn.push(e),Js()}function lt(e,r=Rn?dr+1:0){for(;r<Fe.length;r++){const n=Fe[r];n&&n.pre&&(Fe.splice(r,1),r--,n())}}function ma(e){if(cn.length){const r=[...new Set(cn)];if(cn.length=0,fr){fr.push(...r);return}for(fr=r,fr.sort((n,a)=>On(n)-On(a)),Hr=0;Hr<fr.length;Hr++)fr[Hr]();fr=null,Hr=0}}const On=e=>e.id==null?1/0:e.id,sl=(e,r)=>{const n=On(e)-On(r);if(n===0){if(e.pre&&!r.pre)return-1;if(r.pre&&!e.pre)return 1}return n};function $s(e){oo=!1,Rn=!0,Fe.sort(sl);const r=or;try{for(dr=0;dr<Fe.length;dr++){const n=Fe[dr];n&&n.active!==!1&&Ar(n,null,14)}}finally{dr=0,Fe.length=0,ma(),Rn=!1,Co=null,(Fe.length||cn.length)&&$s()}}function il(e,r,...n){if(e.isUnmounted)return;const a=e.vnode.props||qe;let o=n;const t=r.startsWith("update:"),s=t&&r.slice(7);if(s&&s in a){const d=`${s==="modelValue"?"model":s}Modifiers`,{number:u,trim:m}=a[d]||qe;m&&(o=n.map(f=>be(f)?f.trim():f)),u&&(o=n.map(pc))}let c,i=a[c=Ma(r)]||a[c=Ma(ur(r))];!i&&t&&(i=a[c=Ma(Zr(r))]),i&&Qe(i,e,6,o);const l=a[c+"Once"];if(l){if(!e.emitted)e.emitted={};else if(e.emitted[c])return;e.emitted[c]=!0,Qe(l,e,6,o)}}function Gs(e,r,n=!1){const a=r.emitsCache,o=a.get(e);if(o!==void 0)return o;const t=e.emits;let s={},c=!1;if(!se(e)){const i=l=>{const d=Gs(l,r,!0);d&&(c=!0,Ce(s,d))};!n&&r.mixins.length&&r.mixins.forEach(i),e.extends&&i(e.extends),e.mixins&&e.mixins.forEach(i)}return!t&&!c?(xe(e)&&a.set(e,null),null):(X(t)?t.forEach(i=>s[i]=null):Ce(s,t),xe(e)&&a.set(e,s),s)}function za(e,r){return!e||!Fn(r)?!1:(r=r.slice(2).replace(/Once$/,""),me(e,r[0].toLowerCase()+r.slice(1))||me(e,Zr(r))||me(e,r))}let Ne=null,Ys=null;function ha(e){const r=Ne;return Ne=e,Ys=e&&e.type.__scopeId||null,r}function Oe(e,r=Ne,n){if(!r||e._n)return e;const a=(...o)=>{a._d&&Pt(-1);const t=ha(r);let s;try{s=e(...o)}finally{ha(t),a._d&&Pt(1)}return s};return a._n=!0,a._c=!0,a._d=!0,a}function Fa(e){const{type:r,vnode:n,proxy:a,withProxy:o,props:t,propsOptions:[s],slots:c,attrs:i,emit:l,render:d,renderCache:u,data:m,setupState:f,ctx:w,inheritAttrs:P}=e;let q,b;const y=ha(e);try{if(n.shapeFlag&4){const j=o||a;q=rr(d.call(j,j,u,t,f,m,w)),b=i}else{const j=r;q=rr(j.length>1?j(t,{attrs:i,slots:c,emit:l}):j(t,null)),b=r.props?i:cl(i)}}catch(j){Cn.length=0,Hn(j,e,1),q=ne(Ze)}let T=q;if(b&&P!==!1){const j=Object.keys(b),{shapeFlag:V}=T;j.length&&V&7&&(s&&j.some(vo)&&(b=ll(b,s)),T=Or(T,b))}return n.dirs&&(T=Or(T),T.dirs=T.dirs?T.dirs.concat(n.dirs):n.dirs),n.transition&&(T.transition=n.transition),q=T,ha(y),q}const cl=e=>{let r;for(const n in e)(n==="class"||n==="style"||Fn(n))&&((r||(r={}))[n]=e[n]);return r},ll=(e,r)=>{const n={};for(const a in e)(!vo(a)||!(a.slice(9)in r))&&(n[a]=e[a]);return n};function dl(e,r,n){const{props:a,children:o,component:t}=e,{props:s,children:c,patchFlag:i}=r,l=t.emitsOptions;if(r.dirs||r.transition)return!0;if(n&&i>=0){if(i&1024)return!0;if(i&16)return a?dt(a,s,l):!!s;if(i&8){const d=r.dynamicProps;for(let u=0;u<d.length;u++){const m=d[u];if(s[m]!==a[m]&&!za(l,m))return!0}}}else return(o||c)&&(!c||!c.$stable)?!0:a===s?!1:a?s?dt(a,s,l):!0:!!s;return!1}function dt(e,r,n){const a=Object.keys(r);if(a.length!==Object.keys(e).length)return!0;for(let o=0;o<a.length;o++){const t=a[o];if(r[t]!==e[t]&&!za(n,t))return!0}return!1}function ul({vnode:e,parent:r},n){for(;r&&r.subTree===e;)(e=r.vnode).el=n,r=r.parent}const pl=e=>e.__isSuspense;function Zs(e,r){r&&r.pendingBranch?X(e)?r.effects.push(...e):r.effects.push(e):tl(e)}function Xs(e,r){return zo(e,null,r)}const ea={};function tr(e,r,n){return zo(e,r,n)}function zo(e,r,{immediate:n,deep:a,flush:o,onTrack:t,onTrigger:s}=qe){var c;const i=Es()===((c=ze)==null?void 0:c.scope)?ze:null;let l,d=!1,u=!1;if(Le(e)?(l=()=>e.value,d=pa(e)):sn(e)?(l=()=>e,a=!0):X(e)?(u=!0,d=e.some(j=>sn(j)||pa(j)),l=()=>e.map(j=>{if(Le(j))return j.value;if(sn(j))return Jr(j);if(se(j))return Ar(j,i,2)})):se(e)?r?l=()=>Ar(e,i,2):l=()=>{if(!(i&&i.isUnmounted))return m&&m(),Qe(e,i,3,[f])}:l=or,r&&a){const j=l;l=()=>Jr(j())}let m,f=j=>{m=y.onStop=()=>{Ar(j,i,4)}},w;if(mn)if(f=or,r?n&&Qe(r,i,3,[l(),u?[]:void 0,f]):l(),o==="sync"){const j=id();w=j.__watcherHandles||(j.__watcherHandles=[])}else return or;let P=u?new Array(e.length).fill(ea):ea;const q=()=>{if(y.active)if(r){const j=y.run();(a||d||(u?j.some((V,K)=>In(V,P[K])):In(j,P)))&&(m&&m(),Qe(r,i,3,[j,P===ea?void 0:u&&P[0]===ea?[]:P,f]),P=j)}else y.run()};q.allowRecurse=!!r;let b;o==="sync"?b=q:o==="post"?b=()=>Ve(q,i&&i.suspense):(q.pre=!0,i&&(q.id=i.uid),b=()=>Ca(q));const y=new qo(l,b);r?n?q():P=y.run():o==="post"?Ve(y.run.bind(y),i&&i.suspense):y.run();const T=()=>{y.stop(),i&&i.scope&&yo(i.scope.effects,y)};return w&&w.push(T),T}function ml(e,r,n){const a=this.proxy,o=be(e)?e.includes(".")?Ks(a,e):()=>a[e]:e.bind(a,a);let t;se(r)?t=r:(t=r.handler,n=r);const s=ze;pn(this);const c=zo(o,t.bind(a),n);return s?pn(s):Yr(),c}function Ks(e,r){const n=r.split(".");return()=>{let a=e;for(let o=0;o<n.length&&a;o++)a=a[n[o]];return a}}function Jr(e,r){if(!xe(e)||e.__v_skip||(r=r||new Set,r.has(e)))return e;if(r.add(e),Le(e))Jr(e.value,r);else if(X(e))for(let n=0;n<e.length;n++)Jr(e[n],r);else if(Ps(e)||tn(e))e.forEach(n=>{Jr(n,r)});else if(xs(e))for(const n in e)Jr(e[n],r);return e}function fa(e,r){const n=Ne;if(n===null)return e;const a=Ra(n)||n.proxy,o=e.dirs||(e.dirs=[]);for(let t=0;t<r.length;t++){let[s,c,i,l=qe]=r[t];s&&(se(s)&&(s={mounted:s,updated:s}),s.deep&&Jr(c),o.push({dir:s,instance:a,value:c,oldValue:void 0,arg:i,modifiers:l}))}return e}function lr(e,r,n,a){const o=e.dirs,t=r&&r.dirs;for(let s=0;s<o.length;s++){const c=o[s];t&&(c.oldValue=t[s].value);let i=c.dir[a];i&&(gn(),Qe(i,n,8,[e.el,c,e,r]),bn())}}function hl(){const e={isMounted:!1,isLeaving:!1,isUnmounting:!1,leavingVNodes:new Map};return He(()=>{e.isMounted=!0}),Jn(()=>{e.isUnmounting=!0}),e}const Xe=[Function,Array],Qs={mode:String,appear:Boolean,persisted:Boolean,onBeforeEnter:Xe,onEnter:Xe,onAfterEnter:Xe,onEnterCancelled:Xe,onBeforeLeave:Xe,onLeave:Xe,onAfterLeave:Xe,onLeaveCancelled:Xe,onBeforeAppear:Xe,onAppear:Xe,onAfterAppear:Xe,onAppearCancelled:Xe},fl={name:"BaseTransition",props:Qs,setup(e,{slots:r}){const n=Ro(),a=hl();let o;return()=>{const t=r.default&&ri(r.default(),!0);if(!t||!t.length)return;let s=t[0];if(t.length>1){for(const P of t)if(P.type!==Ze){s=P;break}}const c=fe(e),{mode:i}=c;if(a.isLeaving)return Ba(s);const l=ut(s);if(!l)return Ba(s);const d=to(l,c,a,n);so(l,d);const u=n.subTree,m=u&&ut(u);let f=!1;const{getTransitionKey:w}=l.type;if(w){const P=w();o===void 0?o=P:P!==o&&(o=P,f=!0)}if(m&&m.type!==Ze&&(!Wr(l,m)||f)){const P=to(m,c,a,n);if(so(m,P),i==="out-in")return a.isLeaving=!0,P.afterLeave=()=>{a.isLeaving=!1,n.update.active!==!1&&n.update()},Ba(s);i==="in-out"&&l.type!==Ze&&(P.delayLeave=(q,b,y)=>{const T=ei(a,m);T[String(m.key)]=m,q._leaveCb=()=>{b(),q._leaveCb=void 0,delete d.delayedLeave},d.delayedLeave=y})}return s}}},gl=fl;function ei(e,r){const{leavingVNodes:n}=e;let a=n.get(r.type);return a||(a=Object.create(null),n.set(r.type,a)),a}function to(e,r,n,a){const{appear:o,mode:t,persisted:s=!1,onBeforeEnter:c,onEnter:i,onAfterEnter:l,onEnterCancelled:d,onBeforeLeave:u,onLeave:m,onAfterLeave:f,onLeaveCancelled:w,onBeforeAppear:P,onAppear:q,onAfterAppear:b,onAppearCancelled:y}=r,T=String(e.key),j=ei(n,e),V=(g,H)=>{g&&Qe(g,a,9,H)},K=(g,H)=>{const D=H[1];V(g,H),X(g)?g.every(G=>G.length<=1)&&D():g.length<=1&&D()},R={mode:t,persisted:s,beforeEnter(g){let H=c;if(!n.isMounted)if(o)H=P||c;else return;g._leaveCb&&g._leaveCb(!0);const D=j[T];D&&Wr(e,D)&&D.el._leaveCb&&D.el._leaveCb(),V(H,[g])},enter(g){let H=i,D=l,G=d;if(!n.isMounted)if(o)H=q||i,D=b||l,G=y||d;else return;let k=!1;const I=g._enterCb=L=>{k||(k=!0,L?V(G,[g]):V(D,[g]),R.delayedLeave&&R.delayedLeave(),g._enterCb=void 0)};H?K(H,[g,I]):I()},leave(g,H){const D=String(e.key);if(g._enterCb&&g._enterCb(!0),n.isUnmounting)return H();V(u,[g]);let G=!1;const k=g._leaveCb=I=>{G||(G=!0,H(),I?V(w,[g]):V(f,[g]),g._leaveCb=void 0,j[D]===e&&delete j[D])};j[D]=e,m?K(m,[g,k]):k()},clone(g){return to(g,r,n,a)}};return R}function Ba(e){if(Vn(e))return e=Or(e),e.children=null,e}function ut(e){return Vn(e)?e.children?e.children[0]:void 0:e}function so(e,r){e.shapeFlag&6&&e.component?so(e.component.subTree,r):e.shapeFlag&128?(e.ssContent.transition=r.clone(e.ssContent),e.ssFallback.transition=r.clone(e.ssFallback)):e.transition=r}function ri(e,r=!1,n){let a=[],o=0;for(let t=0;t<e.length;t++){let s=e[t];const c=n==null?s.key:String(n)+String(s.key!=null?s.key:t);s.type===Se?(s.patchFlag&128&&o++,a=a.concat(ri(s.children,r,c))):(r||s.type!==Ze)&&a.push(c!=null?Or(s,{key:c}):s)}if(o>1)for(let t=0;t<a.length;t++)a[t].patchFlag=-2;return a}function ue(e,r){return se(e)?(()=>Ce({name:e.name},r,{setup:e}))():e}const ln=e=>!!e.type.__asyncLoader;function re(e){se(e)&&(e={loader:e});const{loader:r,loadingComponent:n,errorComponent:a,delay:o=200,timeout:t,suspensible:s=!0,onError:c}=e;let i=null,l,d=0;const u=()=>(d++,i=null,m()),m=()=>{let f;return i||(f=i=r().catch(w=>{if(w=w instanceof Error?w:new Error(String(w)),c)return new Promise((P,q)=>{c(w,()=>P(u()),()=>q(w),d+1)});throw w}).then(w=>f!==i&&i?i:(w&&(w.__esModule||w[Symbol.toStringTag]==="Module")&&(w=w.default),l=w,w)))};return ue({name:"AsyncComponentWrapper",__asyncLoader:m,get __asyncResolved(){return l},setup(){const f=ze;if(l)return()=>Ua(l,f);const w=y=>{i=null,Hn(y,f,13,!a)};if(s&&f.suspense||mn)return m().then(y=>()=>Ua(y,f)).catch(y=>(w(y),()=>a?ne(a,{error:y}):null));const P=ge(!1),q=ge(),b=ge(!!o);return o&&setTimeout(()=>{b.value=!1},o),t!=null&&setTimeout(()=>{if(!P.value&&!q.value){const y=new Error(`Async component timed out after ${t}ms.`);w(y),q.value=y}},t),m().then(()=>{P.value=!0,f.parent&&Vn(f.parent.vnode)&&Ca(f.parent.update)}).catch(y=>{w(y),q.value=y}),()=>{if(P.value&&l)return Ua(l,f);if(q.value&&a)return ne(a,{error:q.value});if(n&&!b.value)return ne(n)}}})}function Ua(e,r){const{ref:n,props:a,children:o,ce:t}=r.vnode,s=ne(e,a,o);return s.ref=n,s.ce=t,delete r.vnode.ce,s}const Vn=e=>e.type.__isKeepAlive;function bl(e,r){ni(e,"a",r)}function vl(e,r){ni(e,"da",r)}function ni(e,r,n=ze){const a=e.__wdc||(e.__wdc=()=>{let o=n;for(;o;){if(o.isDeactivated)return;o=o.parent}return e()});if(Aa(r,a,n),n){let o=n.parent;for(;o&&o.parent;)Vn(o.parent.vnode)&&yl(a,r,n,o),o=o.parent}}function yl(e,r,n,a){const o=Aa(r,e,a,!0);Ia(()=>{yo(a[r],o)},n)}function Aa(e,r,n=ze,a=!1){if(n){const o=n[e]||(n[e]=[]),t=r.__weh||(r.__weh=(...s)=>{if(n.isUnmounted)return;gn(),pn(n);const c=Qe(r,n,e,s);return Yr(),bn(),c});return a?o.unshift(t):o.push(t),t}}const wr=e=>(r,n=ze)=>(!mn||e==="sp")&&Aa(e,(...a)=>r(...a),n),wl=wr("bm"),He=wr("m"),Pl=wr("bu"),Sl=wr("u"),Jn=wr("bum"),Ia=wr("um"),ql=wr("sp"),xl=wr("rtg"),_l=wr("rtc");function kl(e,r=ze){Aa("ec",e,r)}const ai="components";function yr(e,r){return jl(ai,e,!0,r)||e}const El=Symbol.for("v-ndc");function jl(e,r,n=!0,a=!1){const o=Ne||ze;if(o){const t=o.type;if(e===ai){const c=od(t,!1);if(c&&(c===r||c===ur(r)||c===Ea(ur(r))))return t}const s=pt(o[e]||t[e],r)||pt(o.appContext[e],r);return!s&&a?t:s}}function pt(e,r){return e&&(e[r]||e[ur(r)]||e[Ea(ur(r))])}function Rr(e,r,n,a){let o;const t=n&&n[a];if(X(e)||be(e)){o=new Array(e.length);for(let s=0,c=e.length;s<c;s++)o[s]=r(e[s],s,void 0,t&&t[s])}else if(typeof e=="number"){o=new Array(e);for(let s=0;s<e;s++)o[s]=r(s+1,s,void 0,t&&t[s])}else if(xe(e))if(e[Symbol.iterator])o=Array.from(e,(s,c)=>r(s,c,void 0,t&&t[c]));else{const s=Object.keys(e);o=new Array(s.length);for(let c=0,i=s.length;c<i;c++){const l=s[c];o[c]=r(e[l],l,c,t&&t[c])}}else o=[];return n&&(n[a]=o),o}function Pe(e,r,n={},a,o){if(Ne.isCE||Ne.parent&&ln(Ne.parent)&&Ne.parent.isCE)return r!=="default"&&(n.name=r),ne("slot",n,a&&a());let t=e[r];t&&t._c&&(t._d=!1),B();const s=t&&oi(t(n)),c=je(Se,{key:n.key||s&&s.key||`_${r}`},s||(a?a():[]),s&&e._===1?64:-2);return!o&&c.scopeId&&(c.slotScopeIds=[c.scopeId+"-s"]),t&&t._c&&(t._d=!0),c}function oi(e){return e.some(r=>ya(r)?!(r.type===Ze||r.type===Se&&!oi(r.children)):!0)?e:null}const io=e=>e?fi(e)?Ra(e)||e.proxy:io(e.parent):null,jn=Ce(Object.create(null),{$:e=>e,$el:e=>e.vnode.el,$data:e=>e.data,$props:e=>e.props,$attrs:e=>e.attrs,$slots:e=>e.slots,$refs:e=>e.refs,$parent:e=>io(e.parent),$root:e=>io(e.root),$emit:e=>e.emit,$options:e=>Ao(e),$forceUpdate:e=>e.f||(e.f=()=>Ca(e.update)),$nextTick:e=>e.n||(e.n=Wn.bind(e.proxy)),$watch:e=>ml.bind(e)}),Ha=(e,r)=>e!==qe&&!e.__isScriptSetup&&me(e,r),Tl={get({_:e},r){const{ctx:n,setupState:a,data:o,props:t,accessCache:s,type:c,appContext:i}=e;let l;if(r[0]!=="$"){const f=s[r];if(f!==void 0)switch(f){case 1:return a[r];case 2:return o[r];case 4:return n[r];case 3:return t[r]}else{if(Ha(a,r))return s[r]=1,a[r];if(o!==qe&&me(o,r))return s[r]=2,o[r];if((l=e.propsOptions[0])&&me(l,r))return s[r]=3,t[r];if(n!==qe&&me(n,r))return s[r]=4,n[r];co&&(s[r]=0)}}const d=jn[r];let u,m;if(d)return r==="$attrs"&&$e(e,"get",r),d(e);if((u=c.__cssModules)&&(u=u[r]))return u;if(n!==qe&&me(n,r))return s[r]=4,n[r];if(m=i.config.globalProperties,me(m,r))return m[r]},set({_:e},r,n){const{data:a,setupState:o,ctx:t}=e;return Ha(o,r)?(o[r]=n,!0):a!==qe&&me(a,r)?(a[r]=n,!0):me(e.props,r)||r[0]==="$"&&r.slice(1)in e?!1:(t[r]=n,!0)},has({_:{data:e,setupState:r,accessCache:n,ctx:a,appContext:o,propsOptions:t}},s){let c;return!!n[s]||e!==qe&&me(e,s)||Ha(r,s)||(c=t[0])&&me(c,s)||me(a,s)||me(jn,s)||me(o.config.globalProperties,s)},defineProperty(e,r,n){return n.get!=null?e._.accessCache[r]=0:me(n,"value")&&this.set(e,r,n.value,null),Reflect.defineProperty(e,r,n)}};function mt(e){return X(e)?e.reduce((r,n)=>(r[n]=null,r),{}):e}let co=!0;function Cl(e){const r=Ao(e),n=e.proxy,a=e.ctx;co=!1,r.beforeCreate&&ht(r.beforeCreate,e,"bc");const{data:o,computed:t,methods:s,watch:c,provide:i,inject:l,created:d,beforeMount:u,mounted:m,beforeUpdate:f,updated:w,activated:P,deactivated:q,beforeDestroy:b,beforeUnmount:y,destroyed:T,unmounted:j,render:V,renderTracked:K,renderTriggered:R,errorCaptured:g,serverPrefetch:H,expose:D,inheritAttrs:G,components:k,directives:I,filters:L}=r;if(l&&zl(l,a,null),s)for(const oe in s){const te=s[oe];se(te)&&(a[oe]=te.bind(n))}if(o){const oe=o.call(n,n);xe(oe)&&(e.data=Un(oe))}if(co=!0,t)for(const oe in t){const te=t[oe],Me=se(te)?te.bind(n,n):se(te.get)?te.get.bind(n,n):or,Re=!se(te)&&se(te.set)?te.set.bind(n):or,We=M({get:Me,set:Re});Object.defineProperty(a,oe,{enumerable:!0,configurable:!0,get:()=>We.value,set:De=>We.value=De})}if(c)for(const oe in c)ti(c[oe],a,n,oe);if(i){const oe=se(i)?i.call(n):i;Reflect.ownKeys(oe).forEach(te=>{Gr(te,oe[te])})}d&&ht(d,e,"c");function W(oe,te){X(te)?te.forEach(Me=>oe(Me.bind(n))):te&&oe(te.bind(n))}if(W(wl,u),W(He,m),W(Pl,f),W(Sl,w),W(bl,P),W(vl,q),W(kl,g),W(_l,K),W(xl,R),W(Jn,y),W(Ia,j),W(ql,H),X(D))if(D.length){const oe=e.exposed||(e.exposed={});D.forEach(te=>{Object.defineProperty(oe,te,{get:()=>n[te],set:Me=>n[te]=Me})})}else e.exposed||(e.exposed={});V&&e.render===or&&(e.render=V),G!=null&&(e.inheritAttrs=G),k&&(e.components=k),I&&(e.directives=I)}function zl(e,r,n=or){X(e)&&(e=lo(e));for(const a in e){const o=e[a];let t;xe(o)?"default"in o?t=Te(o.from||a,o.default,!0):t=Te(o.from||a):t=Te(o),Le(t)?Object.defineProperty(r,a,{enumerable:!0,configurable:!0,get:()=>t.value,set:s=>t.value=s}):r[a]=t}}function ht(e,r,n){Qe(X(e)?e.map(a=>a.bind(r.proxy)):e.bind(r.proxy),r,n)}function ti(e,r,n,a){const o=a.includes(".")?Ks(n,a):()=>n[a];if(be(e)){const t=r[e];se(t)&&tr(o,t)}else if(se(e))tr(o,e.bind(n));else if(xe(e))if(X(e))e.forEach(t=>ti(t,r,n,a));else{const t=se(e.handler)?e.handler.bind(n):r[e.handler];se(t)&&tr(o,t,e)}}function Ao(e){const r=e.type,{mixins:n,extends:a}=r,{mixins:o,optionsCache:t,config:{optionMergeStrategies:s}}=e.appContext,c=t.get(r);let i;return c?i=c:!o.length&&!n&&!a?i=r:(i={},o.length&&o.forEach(l=>ga(i,l,s,!0)),ga(i,r,s)),xe(r)&&t.set(r,i),i}function ga(e,r,n,a=!1){const{mixins:o,extends:t}=r;t&&ga(e,t,n,!0),o&&o.forEach(s=>ga(e,s,n,!0));for(const s in r)if(!(a&&s==="expose")){const c=Al[s]||n&&n[s];e[s]=c?c(e[s],r[s]):r[s]}return e}const Al={data:ft,props:gt,emits:gt,methods:kn,computed:kn,beforeCreate:Be,created:Be,beforeMount:Be,mounted:Be,beforeUpdate:Be,updated:Be,beforeDestroy:Be,beforeUnmount:Be,destroyed:Be,unmounted:Be,activated:Be,deactivated:Be,errorCaptured:Be,serverPrefetch:Be,components:kn,directives:kn,watch:Ll,provide:ft,inject:Il};function ft(e,r){return r?e?function(){return Ce(se(e)?e.call(this,this):e,se(r)?r.call(this,this):r)}:r:e}function Il(e,r){return kn(lo(e),lo(r))}function lo(e){if(X(e)){const r={};for(let n=0;n<e.length;n++)r[e[n]]=e[n];return r}return e}function Be(e,r){return e?[...new Set([].concat(e,r))]:r}function kn(e,r){return e?Ce(Object.create(null),e,r):r}function gt(e,r){return e?X(e)&&X(r)?[...new Set([...e,...r])]:Ce(Object.create(null),mt(e),mt(r??{})):r}function Ll(e,r){if(!e)return r;if(!r)return e;const n=Ce(Object.create(null),e);for(const a in r)n[a]=Be(e[a],r[a]);return n}function si(){return{app:null,config:{isNativeTag:sc,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let Rl=0;function Ol(e,r){return function(a,o=null){se(a)||(a=Ce({},a)),o!=null&&!xe(o)&&(o=null);const t=si(),s=new Set;let c=!1;const i=t.app={_uid:Rl++,_component:a,_props:o,_container:null,_context:t,_instance:null,version:cd,get config(){return t.config},set config(l){},use(l,...d){return s.has(l)||(l&&se(l.install)?(s.add(l),l.install(i,...d)):se(l)&&(s.add(l),l(i,...d))),i},mixin(l){return t.mixins.includes(l)||t.mixins.push(l),i},component(l,d){return d?(t.components[l]=d,i):t.components[l]},directive(l,d){return d?(t.directives[l]=d,i):t.directives[l]},mount(l,d,u){if(!c){const m=ne(a,o);return m.appContext=t,d&&r?r(m,l):e(m,l,u),c=!0,i._container=l,l.__vue_app__=i,Ra(m.component)||m.component.proxy}},unmount(){c&&(e(null,i._container),delete i._container.__vue_app__)},provide(l,d){return t.provides[l]=d,i},runWithContext(l){ba=i;try{return l()}finally{ba=null}}};return i}}let ba=null;function Gr(e,r){if(ze){let n=ze.provides;const a=ze.parent&&ze.parent.provides;a===n&&(n=ze.provides=Object.create(a)),n[e]=r}}function Te(e,r,n=!1){const a=ze||Ne;if(a||ba){const o=a?a.parent==null?a.vnode.appContext&&a.vnode.appContext.provides:a.parent.provides:ba._context.provides;if(o&&e in o)return o[e];if(arguments.length>1)return n&&se(r)?r.call(a&&a.proxy):r}}function Nl(e,r,n,a=!1){const o={},t={};da(t,La,1),e.propsDefaults=Object.create(null),ii(e,r,o,t);for(const s in e.propsOptions[0])s in o||(o[s]=void 0);n?e.props=a?o:Ms(o):e.type.props?e.props=o:e.props=t,e.attrs=t}function Ml(e,r,n,a){const{props:o,attrs:t,vnode:{patchFlag:s}}=e,c=fe(o),[i]=e.propsOptions;let l=!1;if((a||s>0)&&!(s&16)){if(s&8){const d=e.vnode.dynamicProps;for(let u=0;u<d.length;u++){let m=d[u];if(za(e.emitsOptions,m))continue;const f=r[m];if(i)if(me(t,m))f!==t[m]&&(t[m]=f,l=!0);else{const w=ur(m);o[w]=uo(i,c,w,f,e,!1)}else f!==t[m]&&(t[m]=f,l=!0)}}}else{ii(e,r,o,t)&&(l=!0);let d;for(const u in c)(!r||!me(r,u)&&((d=Zr(u))===u||!me(r,d)))&&(i?n&&(n[u]!==void 0||n[d]!==void 0)&&(o[u]=uo(i,c,u,void 0,e,!0)):delete o[u]);if(t!==c)for(const u in t)(!r||!me(r,u))&&(delete t[u],l=!0)}l&&vr(e,"set","$attrs")}function ii(e,r,n,a){const[o,t]=e.propsOptions;let s=!1,c;if(r)for(let i in r){if(En(i))continue;const l=r[i];let d;o&&me(o,d=ur(i))?!t||!t.includes(d)?n[d]=l:(c||(c={}))[d]=l:za(e.emitsOptions,i)||(!(i in a)||l!==a[i])&&(a[i]=l,s=!0)}if(t){const i=fe(n),l=c||qe;for(let d=0;d<t.length;d++){const u=t[d];n[u]=uo(o,i,u,l[u],e,!me(l,u))}}return s}function uo(e,r,n,a,o,t){const s=e[n];if(s!=null){const c=me(s,"default");if(c&&a===void 0){const i=s.default;if(s.type!==Function&&!s.skipFactory&&se(i)){const{propsDefaults:l}=o;n in l?a=l[n]:(pn(o),a=l[n]=i.call(null,r),Yr())}else a=i}s[0]&&(t&&!c?a=!1:s[1]&&(a===""||a===Zr(n))&&(a=!0))}return a}function ci(e,r,n=!1){const a=r.propsCache,o=a.get(e);if(o)return o;const t=e.props,s={},c=[];let i=!1;if(!se(e)){const d=u=>{i=!0;const[m,f]=ci(u,r,!0);Ce(s,m),f&&c.push(...f)};!n&&r.mixins.length&&r.mixins.forEach(d),e.extends&&d(e.extends),e.mixins&&e.mixins.forEach(d)}if(!t&&!i)return xe(e)&&a.set(e,on),on;if(X(t))for(let d=0;d<t.length;d++){const u=ur(t[d]);bt(u)&&(s[u]=qe)}else if(t)for(const d in t){const u=ur(d);if(bt(u)){const m=t[d],f=s[u]=X(m)||se(m)?{type:m}:Ce({},m);if(f){const w=wt(Boolean,f.type),P=wt(String,f.type);f[0]=w>-1,f[1]=P<0||w<P,(w>-1||me(f,"default"))&&c.push(u)}}}const l=[s,c];return xe(e)&&a.set(e,l),l}function bt(e){return e[0]!=="$"}function vt(e){const r=e&&e.toString().match(/^\s*(function|class) (\w+)/);return r?r[2]:e===null?"null":""}function yt(e,r){return vt(e)===vt(r)}function wt(e,r){return X(r)?r.findIndex(n=>yt(n,e)):se(r)&&yt(r,e)?0:-1}const li=e=>e[0]==="_"||e==="$stable",Io=e=>X(e)?e.map(rr):[rr(e)],Dl=(e,r,n)=>{if(r._n)return r;const a=Oe((...o)=>Io(r(...o)),n);return a._c=!1,a},di=(e,r,n)=>{const a=e._ctx;for(const o in e){if(li(o))continue;const t=e[o];if(se(t))r[o]=Dl(o,t,a);else if(t!=null){const s=Io(t);r[o]=()=>s}}},ui=(e,r)=>{const n=Io(r);e.slots.default=()=>n},Fl=(e,r)=>{if(e.vnode.shapeFlag&32){const n=r._;n?(e.slots=fe(r),da(r,"_",n)):di(r,e.slots={})}else e.slots={},r&&ui(e,r);da(e.slots,La,1)},Bl=(e,r,n)=>{const{vnode:a,slots:o}=e;let t=!0,s=qe;if(a.shapeFlag&32){const c=r._;c?n&&c===1?t=!1:(Ce(o,r),!n&&c===1&&delete o._):(t=!r.$stable,di(r,o)),s=r}else r&&(ui(e,r),s={default:1});if(t)for(const c in o)!li(c)&&!(c in s)&&delete o[c]};function va(e,r,n,a,o=!1){if(X(e)){e.forEach((m,f)=>va(m,r&&(X(r)?r[f]:r),n,a,o));return}if(ln(a)&&!o)return;const t=a.shapeFlag&4?Ra(a.component)||a.component.proxy:a.el,s=o?null:t,{i:c,r:i}=e,l=r&&r.r,d=c.refs===qe?c.refs={}:c.refs,u=c.setupState;if(l!=null&&l!==i&&(be(l)?(d[l]=null,me(u,l)&&(u[l]=null)):Le(l)&&(l.value=null)),se(i))Ar(i,c,12,[s,d]);else{const m=be(i),f=Le(i);if(m||f){const w=()=>{if(e.f){const P=m?me(u,i)?u[i]:d[i]:i.value;o?X(P)&&yo(P,t):X(P)?P.includes(t)||P.push(t):m?(d[i]=[t],me(u,i)&&(u[i]=d[i])):(i.value=[t],e.k&&(d[e.k]=i.value))}else m?(d[i]=s,me(u,i)&&(u[i]=s)):f&&(i.value=s,e.k&&(d[e.k]=s))};s?(w.id=-1,Ve(w,n)):w()}}}let _r=!1;const ra=e=>/svg/.test(e.namespaceURI)&&e.tagName!=="foreignObject",na=e=>e.nodeType===8;function Ul(e){const{mt:r,p:n,o:{patchProp:a,createText:o,nextSibling:t,parentNode:s,remove:c,insert:i,createComment:l}}=e,d=(b,y)=>{if(!y.hasChildNodes()){n(null,b,y),ma(),y._vnode=b;return}_r=!1,u(y.firstChild,b,null,null,null),ma(),y._vnode=b,_r&&console.error("Hydration completed but contains mismatches.")},u=(b,y,T,j,V,K=!1)=>{const R=na(b)&&b.data==="[",g=()=>P(b,y,T,j,V,R),{type:H,ref:D,shapeFlag:G,patchFlag:k}=y;let I=b.nodeType;y.el=b,k===-2&&(K=!1,y.dynamicChildren=null);let L=null;switch(H){case un:I!==3?y.children===""?(i(y.el=o(""),s(b),b),L=b):L=g():(b.data!==y.children&&(_r=!0,b.data=y.children),L=t(b));break;case Ze:I!==8||R?L=g():L=t(b);break;case Tn:if(R&&(b=t(b),I=b.nodeType),I===1||I===3){L=b;const ie=!y.children.length;for(let W=0;W<y.staticCount;W++)ie&&(y.children+=L.nodeType===1?L.outerHTML:L.data),W===y.staticCount-1&&(y.anchor=L),L=t(L);return R?t(L):L}else g();break;case Se:R?L=w(b,y,T,j,V,K):L=g();break;default:if(G&1)I!==1||y.type.toLowerCase()!==b.tagName.toLowerCase()?L=g():L=m(b,y,T,j,V,K);else if(G&6){y.slotScopeIds=V;const ie=s(b);if(r(y,ie,null,T,j,ra(ie),K),L=R?q(b):t(b),L&&na(L)&&L.data==="teleport end"&&(L=t(L)),ln(y)){let W;R?(W=ne(Se),W.anchor=L?L.previousSibling:ie.lastChild):W=b.nodeType===3?Nr(""):ne("div"),W.el=b,y.component.subTree=W}}else G&64?I!==8?L=g():L=y.type.hydrate(b,y,T,j,V,K,e,f):G&128&&(L=y.type.hydrate(b,y,T,j,ra(s(b)),V,K,e,u))}return D!=null&&va(D,null,j,y),L},m=(b,y,T,j,V,K)=>{K=K||!!y.dynamicChildren;const{type:R,props:g,patchFlag:H,shapeFlag:D,dirs:G}=y,k=R==="input"&&G||R==="option";if(k||H!==-1){if(G&&lr(y,null,T,"created"),g)if(k||!K||H&48)for(const L in g)(k&&L.endsWith("value")||Fn(L)&&!En(L))&&a(b,L,null,g[L],!1,void 0,T);else g.onClick&&a(b,"onClick",null,g.onClick,!1,void 0,T);let I;if((I=g&&g.onVnodeBeforeMount)&&Ke(I,T,y),G&&lr(y,null,T,"beforeMount"),((I=g&&g.onVnodeMounted)||G)&&Zs(()=>{I&&Ke(I,T,y),G&&lr(y,null,T,"mounted")},j),D&16&&!(g&&(g.innerHTML||g.textContent))){let L=f(b.firstChild,y,b,T,j,V,K);for(;L;){_r=!0;const ie=L;L=L.nextSibling,c(ie)}}else D&8&&b.textContent!==y.children&&(_r=!0,b.textContent=y.children)}return b.nextSibling},f=(b,y,T,j,V,K,R)=>{R=R||!!y.dynamicChildren;const g=y.children,H=g.length;for(let D=0;D<H;D++){const G=R?g[D]:g[D]=rr(g[D]);if(b)b=u(b,G,j,V,K,R);else{if(G.type===un&&!G.children)continue;_r=!0,n(null,G,T,null,j,V,ra(T),K)}}return b},w=(b,y,T,j,V,K)=>{const{slotScopeIds:R}=y;R&&(V=V?V.concat(R):R);const g=s(b),H=f(t(b),y,g,T,j,V,K);return H&&na(H)&&H.data==="]"?t(y.anchor=H):(_r=!0,i(y.anchor=l("]"),g,H),H)},P=(b,y,T,j,V,K)=>{if(_r=!0,y.el=null,K){const H=q(b);for(;;){const D=t(b);if(D&&D!==H)c(D);else break}}const R=t(b),g=s(b);return c(b),n(null,y,g,R,T,j,ra(g),V),R},q=b=>{let y=0;for(;b;)if(b=t(b),b&&na(b)&&(b.data==="["&&y++,b.data==="]")){if(y===0)return t(b);y--}return b};return[d,u]}const Ve=Zs;function Hl(e){return Wl(e,Ul)}function Wl(e,r){const n=eo();n.__VUE__=!0;const{insert:a,remove:o,patchProp:t,createElement:s,createText:c,createComment:i,setText:l,setElementText:d,parentNode:u,nextSibling:m,setScopeId:f=or,insertStaticContent:w}=e,P=(p,h,v,S=null,_=null,E=null,F=!1,A=null,N=!!h.dynamicChildren)=>{if(p===h)return;p&&!Wr(p,h)&&(S=x(p),De(p,_,E,!0),p=null),h.patchFlag===-2&&(N=!1,h.dynamicChildren=null);const{type:C,ref:Y,shapeFlag:J}=h;switch(C){case un:q(p,h,v,S);break;case Ze:b(p,h,v,S);break;case Tn:p==null&&y(h,v,S,F);break;case Se:k(p,h,v,S,_,E,F,A,N);break;default:J&1?V(p,h,v,S,_,E,F,A,N):J&6?I(p,h,v,S,_,E,F,A,N):(J&64||J&128)&&C.process(p,h,v,S,_,E,F,A,N,O)}Y!=null&&_&&va(Y,p&&p.ref,E,h||p,!h)},q=(p,h,v,S)=>{if(p==null)a(h.el=c(h.children),v,S);else{const _=h.el=p.el;h.children!==p.children&&l(_,h.children)}},b=(p,h,v,S)=>{p==null?a(h.el=i(h.children||""),v,S):h.el=p.el},y=(p,h,v,S)=>{[p.el,p.anchor]=w(p.children,h,v,S,p.el,p.anchor)},T=({el:p,anchor:h},v,S)=>{let _;for(;p&&p!==h;)_=m(p),a(p,v,S),p=_;a(h,v,S)},j=({el:p,anchor:h})=>{let v;for(;p&&p!==h;)v=m(p),o(p),p=v;o(h)},V=(p,h,v,S,_,E,F,A,N)=>{F=F||h.type==="svg",p==null?K(h,v,S,_,E,F,A,N):H(p,h,_,E,F,A,N)},K=(p,h,v,S,_,E,F,A)=>{let N,C;const{type:Y,props:J,shapeFlag:Z,transition:ae,dirs:ce}=p;if(N=p.el=s(p.type,E,J&&J.is,J),Z&8?d(N,p.children):Z&16&&g(p.children,N,null,S,_,E&&Y!=="foreignObject",F,A),ce&&lr(p,null,S,"created"),R(N,p,p.scopeId,F,S),J){for(const ye in J)ye!=="value"&&!En(ye)&&t(N,ye,null,J[ye],E,p.children,S,_,Ie);"value"in J&&t(N,"value",null,J.value),(C=J.onVnodeBeforeMount)&&Ke(C,S,p)}ce&&lr(p,null,S,"beforeMount");const we=(!_||_&&!_.pendingBranch)&&ae&&!ae.persisted;we&&ae.beforeEnter(N),a(N,h,v),((C=J&&J.onVnodeMounted)||we||ce)&&Ve(()=>{C&&Ke(C,S,p),we&&ae.enter(N),ce&&lr(p,null,S,"mounted")},_)},R=(p,h,v,S,_)=>{if(v&&f(p,v),S)for(let E=0;E<S.length;E++)f(p,S[E]);if(_){let E=_.subTree;if(h===E){const F=_.vnode;R(p,F,F.scopeId,F.slotScopeIds,_.parent)}}},g=(p,h,v,S,_,E,F,A,N=0)=>{for(let C=N;C<p.length;C++){const Y=p[C]=A?jr(p[C]):rr(p[C]);P(null,Y,h,v,S,_,E,F,A)}},H=(p,h,v,S,_,E,F)=>{const A=h.el=p.el;let{patchFlag:N,dynamicChildren:C,dirs:Y}=h;N|=p.patchFlag&16;const J=p.props||qe,Z=h.props||qe;let ae;v&&Dr(v,!1),(ae=Z.onVnodeBeforeUpdate)&&Ke(ae,v,h,p),Y&&lr(h,p,v,"beforeUpdate"),v&&Dr(v,!0);const ce=_&&h.type!=="foreignObject";if(C?D(p.dynamicChildren,C,A,v,S,ce,E):F||te(p,h,A,null,v,S,ce,E,!1),N>0){if(N&16)G(A,h,J,Z,v,S,_);else if(N&2&&J.class!==Z.class&&t(A,"class",null,Z.class,_),N&4&&t(A,"style",J.style,Z.style,_),N&8){const we=h.dynamicProps;for(let ye=0;ye<we.length;ye++){const Ee=we[ye],er=J[Ee],Qr=Z[Ee];(Qr!==er||Ee==="value")&&t(A,Ee,er,Qr,_,p.children,v,S,Ie)}}N&1&&p.children!==h.children&&d(A,h.children)}else!F&&C==null&&G(A,h,J,Z,v,S,_);((ae=Z.onVnodeUpdated)||Y)&&Ve(()=>{ae&&Ke(ae,v,h,p),Y&&lr(h,p,v,"updated")},S)},D=(p,h,v,S,_,E,F)=>{for(let A=0;A<h.length;A++){const N=p[A],C=h[A],Y=N.el&&(N.type===Se||!Wr(N,C)||N.shapeFlag&70)?u(N.el):v;P(N,C,Y,null,S,_,E,F,!0)}},G=(p,h,v,S,_,E,F)=>{if(v!==S){if(v!==qe)for(const A in v)!En(A)&&!(A in S)&&t(p,A,v[A],null,F,h.children,_,E,Ie);for(const A in S){if(En(A))continue;const N=S[A],C=v[A];N!==C&&A!=="value"&&t(p,A,C,N,F,h.children,_,E,Ie)}"value"in S&&t(p,"value",v.value,S.value)}},k=(p,h,v,S,_,E,F,A,N)=>{const C=h.el=p?p.el:c(""),Y=h.anchor=p?p.anchor:c("");let{patchFlag:J,dynamicChildren:Z,slotScopeIds:ae}=h;ae&&(A=A?A.concat(ae):ae),p==null?(a(C,v,S),a(Y,v,S),g(h.children,v,Y,_,E,F,A,N)):J>0&&J&64&&Z&&p.dynamicChildren?(D(p.dynamicChildren,Z,v,_,E,F,A),(h.key!=null||_&&h===_.subTree)&&pi(p,h,!0)):te(p,h,v,Y,_,E,F,A,N)},I=(p,h,v,S,_,E,F,A,N)=>{h.slotScopeIds=A,p==null?h.shapeFlag&512?_.ctx.activate(h,v,S,F,N):L(h,v,S,_,E,F,N):ie(p,h,N)},L=(p,h,v,S,_,E,F)=>{const A=p.component=Ql(p,S,_);if(Vn(p)&&(A.ctx.renderer=O),ed(A),A.asyncDep){if(_&&_.registerDep(A,W),!p.el){const N=A.subTree=ne(Ze);b(null,N,h,v)}return}W(A,p,h,v,_,E,F)},ie=(p,h,v)=>{const S=h.component=p.component;if(dl(p,h,v))if(S.asyncDep&&!S.asyncResolved){oe(S,h,v);return}else S.next=h,ol(S.update),S.update();else h.el=p.el,S.vnode=h},W=(p,h,v,S,_,E,F)=>{const A=()=>{if(p.isMounted){let{next:Y,bu:J,u:Z,parent:ae,vnode:ce}=p,we=Y,ye;Dr(p,!1),Y?(Y.el=ce.el,oe(p,Y,F)):Y=ce,J&&Da(J),(ye=Y.props&&Y.props.onVnodeBeforeUpdate)&&Ke(ye,ae,Y,ce),Dr(p,!0);const Ee=Fa(p),er=p.subTree;p.subTree=Ee,P(er,Ee,u(er.el),x(er),p,_,E),Y.el=Ee.el,we===null&&ul(p,Ee.el),Z&&Ve(Z,_),(ye=Y.props&&Y.props.onVnodeUpdated)&&Ve(()=>Ke(ye,ae,Y,ce),_)}else{let Y;const{el:J,props:Z}=h,{bm:ae,m:ce,parent:we}=p,ye=ln(h);if(Dr(p,!1),ae&&Da(ae),!ye&&(Y=Z&&Z.onVnodeBeforeMount)&&Ke(Y,we,h),Dr(p,!0),J&&de){const Ee=()=>{p.subTree=Fa(p),de(J,p.subTree,p,_,null)};ye?h.type.__asyncLoader().then(()=>!p.isUnmounted&&Ee()):Ee()}else{const Ee=p.subTree=Fa(p);P(null,Ee,v,S,p,_,E),h.el=Ee.el}if(ce&&Ve(ce,_),!ye&&(Y=Z&&Z.onVnodeMounted)){const Ee=h;Ve(()=>Ke(Y,we,Ee),_)}(h.shapeFlag&256||we&&ln(we.vnode)&&we.vnode.shapeFlag&256)&&p.a&&Ve(p.a,_),p.isMounted=!0,h=v=S=null}},N=p.effect=new qo(A,()=>Ca(C),p.scope),C=p.update=()=>N.run();C.id=p.uid,Dr(p,!0),C()},oe=(p,h,v)=>{h.component=p;const S=p.vnode.props;p.vnode=h,p.next=null,Ml(p,h.props,S,v),Bl(p,h.children,v),gn(),lt(),bn()},te=(p,h,v,S,_,E,F,A,N=!1)=>{const C=p&&p.children,Y=p?p.shapeFlag:0,J=h.children,{patchFlag:Z,shapeFlag:ae}=h;if(Z>0){if(Z&128){Re(C,J,v,S,_,E,F,A,N);return}else if(Z&256){Me(C,J,v,S,_,E,F,A,N);return}}ae&8?(Y&16&&Ie(C,_,E),J!==C&&d(v,J)):Y&16?ae&16?Re(C,J,v,S,_,E,F,A,N):Ie(C,_,E,!0):(Y&8&&d(v,""),ae&16&&g(J,v,S,_,E,F,A,N))},Me=(p,h,v,S,_,E,F,A,N)=>{p=p||on,h=h||on;const C=p.length,Y=h.length,J=Math.min(C,Y);let Z;for(Z=0;Z<J;Z++){const ae=h[Z]=N?jr(h[Z]):rr(h[Z]);P(p[Z],ae,v,null,_,E,F,A,N)}C>Y?Ie(p,_,E,!0,!1,J):g(h,v,S,_,E,F,A,N,J)},Re=(p,h,v,S,_,E,F,A,N)=>{let C=0;const Y=h.length;let J=p.length-1,Z=Y-1;for(;C<=J&&C<=Z;){const ae=p[C],ce=h[C]=N?jr(h[C]):rr(h[C]);if(Wr(ae,ce))P(ae,ce,v,null,_,E,F,A,N);else break;C++}for(;C<=J&&C<=Z;){const ae=p[J],ce=h[Z]=N?jr(h[Z]):rr(h[Z]);if(Wr(ae,ce))P(ae,ce,v,null,_,E,F,A,N);else break;J--,Z--}if(C>J){if(C<=Z){const ae=Z+1,ce=ae<Y?h[ae].el:S;for(;C<=Z;)P(null,h[C]=N?jr(h[C]):rr(h[C]),v,ce,_,E,F,A,N),C++}}else if(C>Z)for(;C<=J;)De(p[C],_,E,!0),C++;else{const ae=C,ce=C,we=new Map;for(C=ce;C<=Z;C++){const Ge=h[C]=N?jr(h[C]):rr(h[C]);Ge.key!=null&&we.set(Ge.key,C)}let ye,Ee=0;const er=Z-ce+1;let Qr=!1,Xo=0;const wn=new Array(er);for(C=0;C<er;C++)wn[C]=0;for(C=ae;C<=J;C++){const Ge=p[C];if(Ee>=er){De(Ge,_,E,!0);continue}let cr;if(Ge.key!=null)cr=we.get(Ge.key);else for(ye=ce;ye<=Z;ye++)if(wn[ye-ce]===0&&Wr(Ge,h[ye])){cr=ye;break}cr===void 0?De(Ge,_,E,!0):(wn[cr-ce]=C+1,cr>=Xo?Xo=cr:Qr=!0,P(Ge,h[cr],v,null,_,E,F,A,N),Ee++)}const Ko=Qr?Vl(wn):on;for(ye=Ko.length-1,C=er-1;C>=0;C--){const Ge=ce+C,cr=h[Ge],Qo=Ge+1<Y?h[Ge+1].el:S;wn[C]===0?P(null,cr,v,Qo,_,E,F,A,N):Qr&&(ye<0||C!==Ko[ye]?We(cr,v,Qo,2):ye--)}}},We=(p,h,v,S,_=null)=>{const{el:E,type:F,transition:A,children:N,shapeFlag:C}=p;if(C&6){We(p.component.subTree,h,v,S);return}if(C&128){p.suspense.move(h,v,S);return}if(C&64){F.move(p,h,v,O);return}if(F===Se){a(E,h,v);for(let J=0;J<N.length;J++)We(N[J],h,v,S);a(p.anchor,h,v);return}if(F===Tn){T(p,h,v);return}if(S!==2&&C&1&&A)if(S===0)A.beforeEnter(E),a(E,h,v),Ve(()=>A.enter(E),_);else{const{leave:J,delayLeave:Z,afterLeave:ae}=A,ce=()=>a(E,h,v),we=()=>{J(E,()=>{ce(),ae&&ae()})};Z?Z(E,ce,we):we()}else a(E,h,v)},De=(p,h,v,S=!1,_=!1)=>{const{type:E,props:F,ref:A,children:N,dynamicChildren:C,shapeFlag:Y,patchFlag:J,dirs:Z}=p;if(A!=null&&va(A,null,v,p,!0),Y&256){h.ctx.deactivate(p);return}const ae=Y&1&&Z,ce=!ln(p);let we;if(ce&&(we=F&&F.onVnodeBeforeUnmount)&&Ke(we,h,p),Y&6)ir(p.component,v,S);else{if(Y&128){p.suspense.unmount(v,S);return}ae&&lr(p,null,h,"beforeUnmount"),Y&64?p.type.remove(p,h,v,_,O,S):C&&(E!==Se||J>0&&J&64)?Ie(C,h,v,!1,!0):(E===Se&&J&384||!_&&Y&16)&&Ie(N,h,v),S&&Sr(p)}(ce&&(we=F&&F.onVnodeUnmounted)||ae)&&Ve(()=>{we&&Ke(we,h,p),ae&&lr(p,null,h,"unmounted")},v)},Sr=p=>{const{type:h,el:v,anchor:S,transition:_}=p;if(h===Se){qr(v,S);return}if(h===Tn){j(p);return}const E=()=>{o(v),_&&!_.persisted&&_.afterLeave&&_.afterLeave()};if(p.shapeFlag&1&&_&&!_.persisted){const{leave:F,delayLeave:A}=_,N=()=>F(v,E);A?A(p.el,E,N):N()}else E()},qr=(p,h)=>{let v;for(;p!==h;)v=m(p),o(p),p=v;o(h)},ir=(p,h,v)=>{const{bum:S,scope:_,update:E,subTree:F,um:A}=p;S&&Da(S),_.stop(),E&&(E.active=!1,De(F,p,h,v)),A&&Ve(A,h),Ve(()=>{p.isUnmounted=!0},h),h&&h.pendingBranch&&!h.isUnmounted&&p.asyncDep&&!p.asyncResolved&&p.suspenseId===h.pendingId&&(h.deps--,h.deps===0&&h.resolve())},Ie=(p,h,v,S=!1,_=!1,E=0)=>{for(let F=E;F<p.length;F++)De(p[F],h,v,S,_)},x=p=>p.shapeFlag&6?x(p.component.subTree):p.shapeFlag&128?p.suspense.next():m(p.anchor||p.el),U=(p,h,v)=>{p==null?h._vnode&&De(h._vnode,null,null,!0):P(h._vnode||null,p,h,null,null,null,v),lt(),ma(),h._vnode=p},O={p:P,um:De,m:We,r:Sr,mt:L,mc:g,pc:te,pbc:D,n:x,o:e};let $,de;return r&&([$,de]=r(O)),{render:U,hydrate:$,createApp:Ol(U,$)}}function Dr({effect:e,update:r},n){e.allowRecurse=r.allowRecurse=n}function pi(e,r,n=!1){const a=e.children,o=r.children;if(X(a)&&X(o))for(let t=0;t<a.length;t++){const s=a[t];let c=o[t];c.shapeFlag&1&&!c.dynamicChildren&&((c.patchFlag<=0||c.patchFlag===32)&&(c=o[t]=jr(o[t]),c.el=s.el),n||pi(s,c)),c.type===un&&(c.el=s.el)}}function Vl(e){const r=e.slice(),n=[0];let a,o,t,s,c;const i=e.length;for(a=0;a<i;a++){const l=e[a];if(l!==0){if(o=n[n.length-1],e[o]<l){r[a]=o,n.push(a);continue}for(t=0,s=n.length-1;t<s;)c=t+s>>1,e[n[c]]<l?t=c+1:s=c;l<e[n[t]]&&(t>0&&(r[a]=n[t-1]),n[t]=a)}}for(t=n.length,s=n[t-1];t-- >0;)n[t]=s,s=r[s];return n}const Jl=e=>e.__isTeleport,Se=Symbol.for("v-fgt"),un=Symbol.for("v-txt"),Ze=Symbol.for("v-cmt"),Tn=Symbol.for("v-stc"),Cn=[];let ar=null;function B(e=!1){Cn.push(ar=e?null:[])}function $l(){Cn.pop(),ar=Cn[Cn.length-1]||null}let Nn=1;function Pt(e){Nn+=e}function mi(e){return e.dynamicChildren=Nn>0?ar||on:null,$l(),Nn>0&&ar&&ar.push(e),e}function Q(e,r,n,a,o,t){return mi(he(e,r,n,a,o,t,!0))}function je(e,r,n,a,o){return mi(ne(e,r,n,a,o,!0))}function ya(e){return e?e.__v_isVNode===!0:!1}function Wr(e,r){return e.type===r.type&&e.key===r.key}const La="__vInternal",hi=({key:e})=>e??null,ca=({ref:e,ref_key:r,ref_for:n})=>(typeof e=="number"&&(e=""+e),e!=null?be(e)||Le(e)||se(e)?{i:Ne,r:e,k:r,f:!!n}:e:null);function he(e,r=null,n=null,a=0,o=null,t=e===Se?0:1,s=!1,c=!1){const i={__v_isVNode:!0,__v_skip:!0,type:e,props:r,key:r&&hi(r),ref:r&&ca(r),scopeId:Ys,slotScopeIds:null,children:n,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetAnchor:null,staticCount:0,shapeFlag:t,patchFlag:a,dynamicProps:o,dynamicChildren:null,appContext:null,ctx:Ne};return c?(Lo(i,n),t&128&&e.normalize(i)):n&&(i.shapeFlag|=be(n)?8:16),Nn>0&&!s&&ar&&(i.patchFlag>0||t&6)&&i.patchFlag!==32&&ar.push(i),i}const ne=Gl;function Gl(e,r=null,n=null,a=0,o=null,t=!1){if((!e||e===El)&&(e=Ze),ya(e)){const c=Or(e,r,!0);return n&&Lo(c,n),Nn>0&&!t&&ar&&(c.shapeFlag&6?ar[ar.indexOf(e)]=c:ar.push(c)),c.patchFlag|=-2,c}if(td(e)&&(e=e.__vccOpts),r){r=Yl(r);let{class:c,style:i}=r;c&&!be(c)&&(r.class=Je(c)),xe(i)&&(Ds(i)&&!X(i)&&(i=Ce({},i)),r.style=Bn(i))}const s=be(e)?1:pl(e)?128:Jl(e)?64:xe(e)?4:se(e)?2:0;return he(e,r,n,a,o,s,t,!0)}function Yl(e){return e?Ds(e)||La in e?Ce({},e):e:null}function Or(e,r,n=!1){const{props:a,ref:o,patchFlag:t,children:s}=e,c=r?po(a||{},r):a;return{__v_isVNode:!0,__v_skip:!0,type:e.type,props:c,key:c&&hi(c),ref:r&&r.ref?n&&o?X(o)?o.concat(ca(r)):[o,ca(r)]:ca(r):o,scopeId:e.scopeId,slotScopeIds:e.slotScopeIds,children:s,target:e.target,targetAnchor:e.targetAnchor,staticCount:e.staticCount,shapeFlag:e.shapeFlag,patchFlag:r&&e.type!==Se?t===-1?16:t|16:t,dynamicProps:e.dynamicProps,dynamicChildren:e.dynamicChildren,appContext:e.appContext,dirs:e.dirs,transition:e.transition,component:e.component,suspense:e.suspense,ssContent:e.ssContent&&Or(e.ssContent),ssFallback:e.ssFallback&&Or(e.ssFallback),el:e.el,anchor:e.anchor,ctx:e.ctx,ce:e.ce}}function Nr(e=" ",r=0){return ne(un,null,e,r)}function Zl(e,r){const n=ne(Tn,null,e);return n.staticCount=r,n}function ke(e="",r=!1){return r?(B(),je(Ze,null,e)):ne(Ze,null,e)}function rr(e){return e==null||typeof e=="boolean"?ne(Ze):X(e)?ne(Se,null,e.slice()):typeof e=="object"?jr(e):ne(un,null,String(e))}function jr(e){return e.el===null&&e.patchFlag!==-1||e.memo?e:Or(e)}function Lo(e,r){let n=0;const{shapeFlag:a}=e;if(r==null)r=null;else if(X(r))n=16;else if(typeof r=="object")if(a&65){const o=r.default;o&&(o._c&&(o._d=!1),Lo(e,o()),o._c&&(o._d=!0));return}else{n=32;const o=r._;!o&&!(La in r)?r._ctx=Ne:o===3&&Ne&&(Ne.slots._===1?r._=1:(r._=2,e.patchFlag|=1024))}else se(r)?(r={default:r,_ctx:Ne},n=32):(r=String(r),a&64?(n=16,r=[Nr(r)]):n=8);e.children=r,e.shapeFlag|=n}function po(...e){const r={};for(let n=0;n<e.length;n++){const a=e[n];for(const o in a)if(o==="class")r.class!==a.class&&(r.class=Je([r.class,a.class]));else if(o==="style")r.style=Bn([r.style,a.style]);else if(Fn(o)){const t=r[o],s=a[o];s&&t!==s&&!(X(t)&&t.includes(s))&&(r[o]=t?[].concat(t,s):s)}else o!==""&&(r[o]=a[o])}return r}function Ke(e,r,n,a=null){Qe(e,r,7,[n,a])}const Xl=si();let Kl=0;function Ql(e,r,n){const a=e.type,o=(r?r.appContext:e.appContext)||Xl,t={uid:Kl++,vnode:e,type:a,parent:r,appContext:o,root:null,next:null,subTree:null,effect:null,update:null,scope:new wc(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:r?r.provides:Object.create(o.provides),accessCache:null,renderCache:[],components:null,directives:null,propsOptions:ci(a,o),emitsOptions:Gs(a,o),emit:null,emitted:null,propsDefaults:qe,inheritAttrs:a.inheritAttrs,ctx:qe,data:qe,props:qe,attrs:qe,slots:qe,refs:qe,setupState:qe,setupContext:null,attrsProxy:null,slotsProxy:null,suspense:n,suspenseId:n?n.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return t.ctx={_:t},t.root=r?r.root:t,t.emit=il.bind(null,t),e.ce&&e.ce(t),t}let ze=null;const Ro=()=>ze||Ne;let Oo,en,St="__VUE_INSTANCE_SETTERS__";(en=eo()[St])||(en=eo()[St]=[]),en.push(e=>ze=e),Oo=e=>{en.length>1?en.forEach(r=>r(e)):en[0](e)};const pn=e=>{Oo(e),e.scope.on()},Yr=()=>{ze&&ze.scope.off(),Oo(null)};function fi(e){return e.vnode.shapeFlag&4}let mn=!1;function ed(e,r=!1){mn=r;const{props:n,children:a}=e.vnode,o=fi(e);Nl(e,n,o,r),Fl(e,a);const t=o?rd(e,r):void 0;return mn=!1,t}function rd(e,r){const n=e.type;e.accessCache=Object.create(null),e.proxy=Fs(new Proxy(e.ctx,Tl));const{setup:a}=n;if(a){const o=e.setupContext=a.length>1?ad(e):null;pn(e),gn();const t=Ar(a,e,0,[e.props,o]);if(bn(),Yr(),Ss(t)){if(t.then(Yr,Yr),r)return t.then(s=>{qt(e,s,r)}).catch(s=>{Hn(s,e,0)});e.asyncDep=t}else qt(e,t,r)}else gi(e,r)}function qt(e,r,n){se(r)?e.type.__ssrInlineRender?e.ssrRender=r:e.render=r:xe(r)&&(e.setupState=Ws(r)),gi(e,n)}let xt;function gi(e,r,n){const a=e.type;if(!e.render){if(!r&&xt&&!a.render){const o=a.template||Ao(e).template;if(o){const{isCustomElement:t,compilerOptions:s}=e.appContext.config,{delimiters:c,compilerOptions:i}=a,l=Ce(Ce({isCustomElement:t,delimiters:c},s),i);a.render=xt(o,l)}}e.render=a.render||or}pn(e),gn(),Cl(e),bn(),Yr()}function nd(e){return e.attrsProxy||(e.attrsProxy=new Proxy(e.attrs,{get(r,n){return $e(e,"get","$attrs"),r[n]}}))}function ad(e){const r=n=>{e.exposed=n||{}};return{get attrs(){return nd(e)},slots:e.slots,emit:e.emit,expose:r}}function Ra(e){if(e.exposed)return e.exposeProxy||(e.exposeProxy=new Proxy(Ws(Fs(e.exposed)),{get(r,n){if(n in r)return r[n];if(n in jn)return jn[n](e)},has(r,n){return n in r||n in jn}}))}function od(e,r=!0){return se(e)?e.displayName||e.name:e.name||r&&e.__name}function td(e){return se(e)&&"__vccOpts"in e}const M=(e,r)=>rl(e,r,mn);function le(e,r,n){const a=arguments.length;return a===2?xe(r)&&!X(r)?ya(r)?ne(e,null,[r]):ne(e,r):ne(e,null,r):(a>3?n=Array.prototype.slice.call(arguments,2):a===3&&ya(n)&&(n=[n]),ne(e,r,n))}const sd=Symbol.for("v-scx"),id=()=>Te(sd),cd="3.3.4",ld="http://www.w3.org/2000/svg",Vr=typeof document<"u"?document:null,_t=Vr&&Vr.createElement("template"),dd={insert:(e,r,n)=>{r.insertBefore(e,n||null)},remove:e=>{const r=e.parentNode;r&&r.removeChild(e)},createElement:(e,r,n,a)=>{const o=r?Vr.createElementNS(ld,e):Vr.createElement(e,n?{is:n}:void 0);return e==="select"&&a&&a.multiple!=null&&o.setAttribute("multiple",a.multiple),o},createText:e=>Vr.createTextNode(e),createComment:e=>Vr.createComment(e),setText:(e,r)=>{e.nodeValue=r},setElementText:(e,r)=>{e.textContent=r},parentNode:e=>e.parentNode,nextSibling:e=>e.nextSibling,querySelector:e=>Vr.querySelector(e),setScopeId(e,r){e.setAttribute(r,"")},insertStaticContent(e,r,n,a,o,t){const s=n?n.previousSibling:r.lastChild;if(o&&(o===t||o.nextSibling))for(;r.insertBefore(o.cloneNode(!0),n),!(o===t||!(o=o.nextSibling)););else{_t.innerHTML=a?`<svg>${e}</svg>`:e;const c=_t.content;if(a){const i=c.firstChild;for(;i.firstChild;)c.appendChild(i.firstChild);c.removeChild(i)}r.insertBefore(c,n)}return[s?s.nextSibling:r.firstChild,n?n.previousSibling:r.lastChild]}};function ud(e,r,n){const a=e._vtc;a&&(r=(r?[r,...a]:[...a]).join(" ")),r==null?e.removeAttribute("class"):n?e.setAttribute("class",r):e.className=r}function pd(e,r,n){const a=e.style,o=be(n);if(n&&!o){if(r&&!be(r))for(const t in r)n[t]==null&&mo(a,t,"");for(const t in n)mo(a,t,n[t])}else{const t=a.display;o?r!==n&&(a.cssText=n):r&&e.removeAttribute("style"),"_vod"in e&&(a.display=t)}}const kt=/\s*!important$/;function mo(e,r,n){if(X(n))n.forEach(a=>mo(e,r,a));else if(n==null&&(n=""),r.startsWith("--"))e.setProperty(r,n);else{const a=md(e,r);kt.test(n)?e.setProperty(Zr(a),n.replace(kt,""),"important"):e[a]=n}}const Et=["Webkit","Moz","ms"],Wa={};function md(e,r){const n=Wa[r];if(n)return n;let a=ur(r);if(a!=="filter"&&a in e)return Wa[r]=a;a=Ea(a);for(let o=0;o<Et.length;o++){const t=Et[o]+a;if(t in e)return Wa[r]=t}return r}const jt="http://www.w3.org/1999/xlink";function hd(e,r,n,a,o){if(a&&r.startsWith("xlink:"))n==null?e.removeAttributeNS(jt,r.slice(6,r.length)):e.setAttributeNS(jt,r,n);else{const t=yc(r);n==null||t&&!_s(n)?e.removeAttribute(r):e.setAttribute(r,t?"":n)}}function fd(e,r,n,a,o,t,s){if(r==="innerHTML"||r==="textContent"){a&&s(a,o,t),e[r]=n??"";return}const c=e.tagName;if(r==="value"&&c!=="PROGRESS"&&!c.includes("-")){e._value=n;const l=c==="OPTION"?e.getAttribute("value"):e.value,d=n??"";l!==d&&(e.value=d),n==null&&e.removeAttribute(r);return}let i=!1;if(n===""||n==null){const l=typeof e[r];l==="boolean"?n=_s(n):n==null&&l==="string"?(n="",i=!0):l==="number"&&(n=0,i=!0)}try{e[r]=n}catch{}i&&e.removeAttribute(r)}function gd(e,r,n,a){e.addEventListener(r,n,a)}function bd(e,r,n,a){e.removeEventListener(r,n,a)}function vd(e,r,n,a,o=null){const t=e._vei||(e._vei={}),s=t[r];if(a&&s)s.value=a;else{const[c,i]=yd(r);if(a){const l=t[r]=Sd(a,o);gd(e,c,l,i)}else s&&(bd(e,c,s,i),t[r]=void 0)}}const Tt=/(?:Once|Passive|Capture)$/;function yd(e){let r;if(Tt.test(e)){r={};let a;for(;a=e.match(Tt);)e=e.slice(0,e.length-a[0].length),r[a[0].toLowerCase()]=!0}return[e[2]===":"?e.slice(3):Zr(e.slice(2)),r]}let Va=0;const wd=Promise.resolve(),Pd=()=>Va||(wd.then(()=>Va=0),Va=Date.now());function Sd(e,r){const n=a=>{if(!a._vts)a._vts=Date.now();else if(a._vts<=n.attached)return;Qe(qd(a,n.value),r,5,[a])};return n.value=e,n.attached=Pd(),n}function qd(e,r){if(X(r)){const n=e.stopImmediatePropagation;return e.stopImmediatePropagation=()=>{n.call(e),e._stopped=!0},r.map(a=>o=>!o._stopped&&a&&a(o))}else return r}const Ct=/^on[a-z]/,xd=(e,r,n,a,o=!1,t,s,c,i)=>{r==="class"?ud(e,a,o):r==="style"?pd(e,n,a):Fn(r)?vo(r)||vd(e,r,n,a,s):(r[0]==="."?(r=r.slice(1),!0):r[0]==="^"?(r=r.slice(1),!1):_d(e,r,a,o))?fd(e,r,a,t,s,c,i):(r==="true-value"?e._trueValue=a:r==="false-value"&&(e._falseValue=a),hd(e,r,a,o))};function _d(e,r,n,a){return a?!!(r==="innerHTML"||r==="textContent"||r in e&&Ct.test(r)&&se(n)):r==="spellcheck"||r==="draggable"||r==="translate"||r==="form"||r==="list"&&e.tagName==="INPUT"||r==="type"&&e.tagName==="TEXTAREA"||Ct.test(r)&&be(n)?!1:r in e}const kr="transition",Pn="animation",$n=(e,{slots:r})=>le(gl,kd(e),r);$n.displayName="Transition";const bi={name:String,type:String,css:{type:Boolean,default:!0},duration:[String,Number,Object],enterFromClass:String,enterActiveClass:String,enterToClass:String,appearFromClass:String,appearActiveClass:String,appearToClass:String,leaveFromClass:String,leaveActiveClass:String,leaveToClass:String};$n.props=Ce({},Qs,bi);const Fr=(e,r=[])=>{X(e)?e.forEach(n=>n(...r)):e&&e(...r)},zt=e=>e?X(e)?e.some(r=>r.length>1):e.length>1:!1;function kd(e){const r={};for(const k in e)k in bi||(r[k]=e[k]);if(e.css===!1)return r;const{name:n="v",type:a,duration:o,enterFromClass:t=`${n}-enter-from`,enterActiveClass:s=`${n}-enter-active`,enterToClass:c=`${n}-enter-to`,appearFromClass:i=t,appearActiveClass:l=s,appearToClass:d=c,leaveFromClass:u=`${n}-leave-from`,leaveActiveClass:m=`${n}-leave-active`,leaveToClass:f=`${n}-leave-to`}=e,w=Ed(o),P=w&&w[0],q=w&&w[1],{onBeforeEnter:b,onEnter:y,onEnterCancelled:T,onLeave:j,onLeaveCancelled:V,onBeforeAppear:K=b,onAppear:R=y,onAppearCancelled:g=T}=r,H=(k,I,L)=>{Br(k,I?d:c),Br(k,I?l:s),L&&L()},D=(k,I)=>{k._isLeaving=!1,Br(k,u),Br(k,f),Br(k,m),I&&I()},G=k=>(I,L)=>{const ie=k?R:y,W=()=>H(I,k,L);Fr(ie,[I,W]),At(()=>{Br(I,k?i:t),Er(I,k?d:c),zt(ie)||It(I,a,P,W)})};return Ce(r,{onBeforeEnter(k){Fr(b,[k]),Er(k,t),Er(k,s)},onBeforeAppear(k){Fr(K,[k]),Er(k,i),Er(k,l)},onEnter:G(!1),onAppear:G(!0),onLeave(k,I){k._isLeaving=!0;const L=()=>D(k,I);Er(k,u),Cd(),Er(k,m),At(()=>{k._isLeaving&&(Br(k,u),Er(k,f),zt(j)||It(k,a,q,L))}),Fr(j,[k,L])},onEnterCancelled(k){H(k,!1),Fr(T,[k])},onAppearCancelled(k){H(k,!0),Fr(g,[k])},onLeaveCancelled(k){D(k),Fr(V,[k])}})}function Ed(e){if(e==null)return null;if(xe(e))return[Ja(e.enter),Ja(e.leave)];{const r=Ja(e);return[r,r]}}function Ja(e){return mc(e)}function Er(e,r){r.split(/\s+/).forEach(n=>n&&e.classList.add(n)),(e._vtc||(e._vtc=new Set)).add(r)}function Br(e,r){r.split(/\s+/).forEach(a=>a&&e.classList.remove(a));const{_vtc:n}=e;n&&(n.delete(r),n.size||(e._vtc=void 0))}function At(e){requestAnimationFrame(()=>{requestAnimationFrame(e)})}let jd=0;function It(e,r,n,a){const o=e._endId=++jd,t=()=>{o===e._endId&&a()};if(n)return setTimeout(t,n);const{type:s,timeout:c,propCount:i}=Td(e,r);if(!s)return a();const l=s+"end";let d=0;const u=()=>{e.removeEventListener(l,m),t()},m=f=>{f.target===e&&++d>=i&&u()};setTimeout(()=>{d<i&&u()},c+1),e.addEventListener(l,m)}function Td(e,r){const n=window.getComputedStyle(e),a=w=>(n[w]||"").split(", "),o=a(`${kr}Delay`),t=a(`${kr}Duration`),s=Lt(o,t),c=a(`${Pn}Delay`),i=a(`${Pn}Duration`),l=Lt(c,i);let d=null,u=0,m=0;r===kr?s>0&&(d=kr,u=s,m=t.length):r===Pn?l>0&&(d=Pn,u=l,m=i.length):(u=Math.max(s,l),d=u>0?s>l?kr:Pn:null,m=d?d===kr?t.length:i.length:0);const f=d===kr&&/\b(transform|all)(,|$)/.test(a(`${kr}Property`).toString());return{type:d,timeout:u,propCount:m,hasTransform:f}}function Lt(e,r){for(;e.length<r.length;)e=e.concat(e);return Math.max(...r.map((n,a)=>Rt(n)+Rt(e[a])))}function Rt(e){return Number(e.slice(0,-1).replace(",","."))*1e3}function Cd(){return document.body.offsetHeight}const zd={esc:"escape",space:" ",up:"arrow-up",left:"arrow-left",right:"arrow-right",down:"arrow-down",delete:"backspace"},Ad=(e,r)=>n=>{if(!("key"in n))return;const a=Zr(n.key);if(r.some(o=>o===a||zd[o]===a))return e(n)},wa={beforeMount(e,{value:r},{transition:n}){e._vod=e.style.display==="none"?"":e.style.display,n&&r?n.beforeEnter(e):Sn(e,r)},mounted(e,{value:r},{transition:n}){n&&r&&n.enter(e)},updated(e,{value:r,oldValue:n},{transition:a}){!r!=!n&&(a?r?(a.beforeEnter(e),Sn(e,!0),a.enter(e)):a.leave(e,()=>{Sn(e,!1)}):Sn(e,r))},beforeUnmount(e,{value:r}){Sn(e,r)}};function Sn(e,r){e.style.display=r?e._vod:"none"}const Id=Ce({patchProp:xd},dd);let $a,Ot=!1;function Ld(){return $a=Ot?$a:Hl(Id),Ot=!0,$a}const Rd=(...e)=>{const r=Ld().createApp(...e),{mount:n}=r;return r.mount=a=>{const o=Od(a);if(o)return n(o,!0,o instanceof SVGElement)},r};function Od(e){return be(e)?document.querySelector(e):e}const Nd={"v-56dd2a2a":()=>z(()=>import("./InstallationNotes.html-9f398463.js"),[]).then(({data:e})=>e),"v-8daa1a0e":()=>z(()=>import("./index.html-a5f91f3a.js"),[]).then(({data:e})=>e),"v-2d0a7df8":()=>z(()=>import("./index.html-dd5e9d8e.js"),[]).then(({data:e})=>e),"v-2d0a870d":()=>z(()=>import("./index.html-fe14e3a3.js"),[]).then(({data:e})=>e),"v-2d0a87a8":()=>z(()=>import("./index.html-e6b54d7d.js"),[]).then(({data:e})=>e),"v-724914a8":()=>z(()=>import("./a UnderstandingETandPT.html-19bc0326.js"),[]).then(({data:e})=>e),"v-88f7c0c8":()=>z(()=>import("./b Pentesting methodologies.html-c1b150a0.js"),[]).then(({data:e})=>e),"v-bd71d732":()=>z(()=>import("./index.html-68f0de1a.js"),[]).then(({data:e})=>e),"v-f39b1880":()=>z(()=>import("./concurrency.html-c0fe19eb.js"),[]).then(({data:e})=>e),"v-3568b29a":()=>z(()=>import("./index.html-f5e65fb4.js"),[]).then(({data:e})=>e),"v-4d403dc3":()=>z(()=>import("./operatingsystem.html-13f637f4.js"),[]).then(({data:e})=>e),"v-62d86b64":()=>z(()=>import("./process.html-ab2e808f.js"),[]).then(({data:e})=>e),"v-02f7a31f":()=>z(()=>import("./curl_annex.html-8d6130cb.js"),[]).then(({data:e})=>e),"v-3568b2b9":()=>z(()=>import("./index.html-37f94e3a.js"),[]).then(({data:e})=>e),"v-0b12bee5":()=>z(()=>import("./iostreams.html-fe122d84.js"),[]).then(({data:e})=>e),"v-69cbc2b4":()=>z(()=>import("./processbuilder.html-6745db8f.js"),[]).then(({data:e})=>e),"v-4144fd3a":()=>z(()=>import("./runtime.html-5aaab033.js"),[]).then(({data:e})=>e),"v-45db6c9a":()=>z(()=>import("./a UnderstandingETandPT.html-9f57d1f5.js"),[]).then(({data:e})=>e),"v-1bb62067":()=>z(()=>import("./b Pentesting methodologies.html-1df01ef2.js"),[]).then(({data:e})=>e),"v-3804537c":()=>z(()=>import("./index.html-a710aefc.js"),[]).then(({data:e})=>e),"v-5aa74f15":()=>z(()=>import("./concurrency.html-bb241818.js"),[]).then(({data:e})=>e),"v-b73e5022":()=>z(()=>import("./index.html-7595e389.js"),[]).then(({data:e})=>e),"v-4b0532d0":()=>z(()=>import("./operatingsystem.html-6145359d.js"),[]).then(({data:e})=>e),"v-3f423939":()=>z(()=>import("./process.html-2d25c4cd.js"),[]).then(({data:e})=>e),"v-287508f8":()=>z(()=>import("./a UnderstandingETandPT.html-a098f9a9.js"),[]).then(({data:e})=>e),"v-4448d028":()=>z(()=>import("./b Pentesting methodologies.html-48943728.js"),[]).then(({data:e})=>e),"v-0eddbe17":()=>z(()=>import("./index.html-6f7211ca.js"),[]).then(({data:e})=>e),"v-8100edac":()=>z(()=>import("./curl_annex.html-cdc1e788.js"),[]).then(({data:e})=>e),"v-b73e4fe4":()=>z(()=>import("./index.html-c430bf9a.js"),[]).then(({data:e})=>e),"v-74406b7a":()=>z(()=>import("./iostreams.html-a589d640.js"),[]).then(({data:e})=>e),"v-348bab3f":()=>z(()=>import("./processbuilder.html-e1190a03.js"),[]).then(({data:e})=>e),"v-1daecb0f":()=>z(()=>import("./runtime.html-c0bc2c73.js"),[]).then(({data:e})=>e),"v-46af1970":()=>z(()=>import("./concurrency.html-86ce093c.js"),[]).then(({data:e})=>e),"v-a8728f6c":()=>z(()=>import("./index.html-0f29a414.js"),[]).then(({data:e})=>e),"v-e2dae91a":()=>z(()=>import("./operatingsystem.html-d832cb7d.js"),[]).then(({data:e})=>e),"v-75292dd8":()=>z(()=>import("./process.html-e371f778.js"),[]).then(({data:e})=>e),"v-3277876f":()=>z(()=>import("./curl_annex.html-4477b510.js"),[]).then(({data:e})=>e),"v-a8728f2e":()=>z(()=>import("./index.html-feca8f29.js"),[]).then(({data:e})=>e),"v-14dd1095":()=>z(()=>import("./iostreams.html-10a7d348.js"),[]).then(({data:e})=>e),"v-5320ff04":()=>z(()=>import("./processbuilder.html-6136c6c0.js"),[]).then(({data:e})=>e),"v-b8500a2c":()=>z(()=>import("./runtime.html-e2f0f66c.js"),[]).then(({data:e})=>e),"v-3706649a":()=>z(()=>import("./404.html-4b05ea4a.js"),[]).then(({data:e})=>e)},Md=JSON.parse('{"base":"/apuntes/","lang":"ca-ES","title":"SAD","description":"SAD, CFGS ASIR, FP, Seguridad, Alta disponibilidad, Hacking, Análisis Forense, Bastionado Redes, IES Doctor Balmis","head":[["meta",{"name":"theme-color","content":"#3eaf7c"}],["meta",{"name":"apple-mobile-web-app-capable","content":"yes"}],["meta",{"name":"apple-mobile-web-app-status-bar-style","content":"black"}],["link",{"rel":"icon","href":"/apuntes/sad_favicon.png"}]],"locales":{"/ca/":{"lang":"ca-ES","title":"Seguretat i Alta Disponibilitat","description":"Módul SAD 2n ASIX"},"/es/":{"lang":"es-ES","title":"Seguridad y Alta Disponibilidad","description":"Módulo SAD de 2º ASIR"},"/en/":{"lang":"en-US","title":"Security & High Availability","description":"SAD 2nd ASIR module"}}}');var Dd=([e,r,n])=>e==="meta"&&r.name?`${e}.${r.name}`:["title","base"].includes(e)?e:e==="template"&&r.id?`${e}.${r.id}`:JSON.stringify([e,r,n]),Fd=e=>{const r=new Set,n=[];return e.forEach(a=>{const o=Dd(a);r.has(o)||(r.add(o),n.push(a))}),n},Gn=e=>/^(https?:)?\/\//.test(e),Bd=e=>/^mailto:/.test(e),Ud=e=>/^tel:/.test(e),No=e=>Object.prototype.toString.call(e)==="[object Object]",vi=e=>e[e.length-1]==="/"?e.slice(0,-1):e,yi=e=>e[0]==="/"?e.slice(1):e,wi=(e,r)=>{const n=Object.keys(e).sort((a,o)=>{const t=o.split("/").length-a.split("/").length;return t!==0?t:o.length-a.length});for(const a of n)if(r.startsWith(a))return a;return"/"};const Pi={"v-56dd2a2a":re(()=>z(()=>import("./InstallationNotes.html-4847a279.js"),[])),"v-8daa1a0e":re(()=>z(()=>import("./index.html-5ad50fff.js"),[])),"v-2d0a7df8":re(()=>z(()=>import("./index.html-a1a96d72.js"),[])),"v-2d0a870d":re(()=>z(()=>import("./index.html-8a8e8293.js"),[])),"v-2d0a87a8":re(()=>z(()=>import("./index.html-cb92c251.js"),[])),"v-724914a8":re(()=>z(()=>import("./a UnderstandingETandPT.html-4c44039e.js"),[])),"v-88f7c0c8":re(()=>z(()=>import("./b Pentesting methodologies.html-510ef2d2.js"),[])),"v-bd71d732":re(()=>z(()=>import("./index.html-2f242b2e.js"),[])),"v-f39b1880":re(()=>z(()=>import("./concurrency.html-1215c14a.js"),["assets/concurrency.html-1215c14a.js","assets/gantt_parallel-cc549e79.js"])),"v-3568b29a":re(()=>z(()=>import("./index.html-5f7f7259.js"),[])),"v-4d403dc3":re(()=>z(()=>import("./operatingsystem.html-65213906.js"),["assets/operatingsystem.html-65213906.js","assets/roundrobin-3-400fdffd.js"])),"v-62d86b64":re(()=>z(()=>import("./process.html-2fd9eb44.js"),["assets/process.html-2fd9eb44.js","assets/threads_vs_process-5db8950b.js"])),"v-02f7a31f":re(()=>z(()=>import("./curl_annex.html-85ddd67d.js"),[])),"v-3568b2b9":re(()=>z(()=>import("./index.html-6f841768.js"),[])),"v-0b12bee5":re(()=>z(()=>import("./iostreams.html-5342084e.js"),["assets/iostreams.html-5342084e.js","assets/Java_Stream_Readers_BufferedReaders-a4e1bc0d.js"])),"v-69cbc2b4":re(()=>z(()=>import("./processbuilder.html-443116ee.js"),["assets/processbuilder.html-443116ee.js","assets/comandotree-ef7769e5.js"])),"v-4144fd3a":re(()=>z(()=>import("./runtime.html-6458f9d4.js"),[])),"v-45db6c9a":re(()=>z(()=>import("./a UnderstandingETandPT.html-57610afe.js"),[])),"v-1bb62067":re(()=>z(()=>import("./b Pentesting methodologies.html-1d4cf502.js"),[])),"v-3804537c":re(()=>z(()=>import("./index.html-f29422c3.js"),[])),"v-5aa74f15":re(()=>z(()=>import("./concurrency.html-aa7abf4d.js"),["assets/concurrency.html-aa7abf4d.js","assets/gantt_parallel-cc549e79.js"])),"v-b73e5022":re(()=>z(()=>import("./index.html-6fe92bf2.js"),[])),"v-4b0532d0":re(()=>z(()=>import("./operatingsystem.html-c1b38d32.js"),["assets/operatingsystem.html-c1b38d32.js","assets/roundrobin-3-400fdffd.js","assets/rendimiento-79519059.js"])),"v-3f423939":re(()=>z(()=>import("./process.html-8e18547a.js"),["assets/process.html-8e18547a.js","assets/threads_vs_process-5db8950b.js"])),"v-287508f8":re(()=>z(()=>import("./a UnderstandingETandPT.html-ce85f763.js"),[])),"v-4448d028":re(()=>z(()=>import("./b Pentesting methodologies.html-bf00156d.js"),[])),"v-0eddbe17":re(()=>z(()=>import("./index.html-a829a592.js"),[])),"v-8100edac":re(()=>z(()=>import("./curl_annex.html-b9c59f65.js"),[])),"v-b73e4fe4":re(()=>z(()=>import("./index.html-69aa2fbd.js"),[])),"v-74406b7a":re(()=>z(()=>import("./iostreams.html-b3076b3d.js"),["assets/iostreams.html-b3076b3d.js","assets/Java_Stream_Readers_BufferedReaders-a4e1bc0d.js"])),"v-348bab3f":re(()=>z(()=>import("./processbuilder.html-24cba6c6.js"),["assets/processbuilder.html-24cba6c6.js","assets/comandotree-ef7769e5.js"])),"v-1daecb0f":re(()=>z(()=>import("./runtime.html-6a834061.js"),[])),"v-46af1970":re(()=>z(()=>import("./concurrency.html-afb48b35.js"),["assets/concurrency.html-afb48b35.js","assets/gantt_parallel-cc549e79.js"])),"v-a8728f6c":re(()=>z(()=>import("./index.html-e4685808.js"),[])),"v-e2dae91a":re(()=>z(()=>import("./operatingsystem.html-4c2c98b4.js"),["assets/operatingsystem.html-4c2c98b4.js","assets/roundrobin-3-400fdffd.js","assets/rendimiento-79519059.js"])),"v-75292dd8":re(()=>z(()=>import("./process.html-94ffe18b.js"),["assets/process.html-94ffe18b.js","assets/threads_vs_process-5db8950b.js"])),"v-3277876f":re(()=>z(()=>import("./curl_annex.html-973d8f8f.js"),[])),"v-a8728f2e":re(()=>z(()=>import("./index.html-bfadc0f8.js"),[])),"v-14dd1095":re(()=>z(()=>import("./iostreams.html-c56966ee.js"),["assets/iostreams.html-c56966ee.js","assets/Java_Stream_Readers_BufferedReaders-a4e1bc0d.js"])),"v-5320ff04":re(()=>z(()=>import("./processbuilder.html-9a6bda4e.js"),["assets/processbuilder.html-9a6bda4e.js","assets/comandotree-ef7769e5.js"])),"v-b8500a2c":re(()=>z(()=>import("./runtime.html-7b5bd2a7.js"),[])),"v-3706649a":re(()=>z(()=>import("./404.html-61bdb309.js"),[]))};var Hd=Symbol(""),Wd=ge(Nd),Si=vn({key:"",path:"",title:"",lang:"",frontmatter:{},headers:[]}),Tr=ge(Si),Ir=()=>Tr,qi=Symbol(""),gr=()=>{const e=Te(qi);if(!e)throw new Error("usePageFrontmatter() is called without provider.");return e},xi=Symbol(""),Vd=()=>{const e=Te(xi);if(!e)throw new Error("usePageHead() is called without provider.");return e},Jd=Symbol(""),_i=Symbol(""),$d=()=>{const e=Te(_i);if(!e)throw new Error("usePageLang() is called without provider.");return e},ki=Symbol(""),Gd=()=>{const e=Te(ki);if(!e)throw new Error("usePageLayout() is called without provider.");return e},Mo=Symbol(""),yn=()=>{const e=Te(Mo);if(!e)throw new Error("useRouteLocale() is called without provider.");return e},an=ge(Md),Ei=()=>an,ji=Symbol(""),Do=()=>{const e=Te(ji);if(!e)throw new Error("useSiteLocaleData() is called without provider.");return e},Yd=Symbol(""),Zd="Layout",Xd="NotFound",mr=Un({resolveLayouts:e=>e.reduce((r,n)=>({...r,...n.layouts}),{}),resolvePageData:async e=>{const r=Wd.value[e];return await(r==null?void 0:r())??Si},resolvePageFrontmatter:e=>e.frontmatter,resolvePageHead:(e,r,n)=>{const a=be(r.description)?r.description:n.description,o=[...X(r.head)?r.head:[],...n.head,["title",{},e],["meta",{name:"description",content:a}]];return Fd(o)},resolvePageHeadTitle:(e,r)=>[e.title,r.title].filter(n=>!!n).join(" | "),resolvePageLang:(e,r)=>e.lang||r.lang||"en-US",resolvePageLayout:(e,r)=>{let n;if(e.path){const a=e.frontmatter.layout;be(a)?n=a:n=Zd}else n=Xd;return r[n]},resolveRouteLocale:(e,r)=>wi(e,r),resolveSiteLocaleData:(e,r)=>({...e,...e.locales[r]})}),Fo=ue({name:"ClientOnly",setup(e,r){const n=ge(!1);return He(()=>{n.value=!0}),()=>{var a,o;return n.value?(o=(a=r.slots).default)==null?void 0:o.call(a):null}}}),Kd=ue({name:"Content",props:{pageKey:{type:String,required:!1,default:""}},setup(e){const r=Ir(),n=M(()=>Pi[e.pageKey||r.value.key]);return()=>n.value?le(n.value):le("div","404 Not Found")}}),Pr=(e={})=>e,Bo=e=>Gn(e)?e:`/apuntes/${yi(e)}`;function Ti(e,r,n){var a,o,t;r===void 0&&(r=50),n===void 0&&(n={});var s=(a=n.isImmediate)!=null&&a,c=(o=n.callback)!=null&&o,i=n.maxWait,l=Date.now(),d=[];function u(){if(i!==void 0){var f=Date.now()-l;if(f+r>=i)return i-f}return r}var m=function(){var f=[].slice.call(arguments),w=this;return new Promise(function(P,q){var b=s&&t===void 0;if(t!==void 0&&clearTimeout(t),t=setTimeout(function(){if(t=void 0,l=Date.now(),!s){var T=e.apply(w,f);c&&c(T),d.forEach(function(j){return(0,j.resolve)(T)}),d=[]}},u()),b){var y=e.apply(w,f);return c&&c(y),P(y)}d.push({resolve:P,reject:q})})};return m.cancel=function(f){t!==void 0&&clearTimeout(t),d.forEach(function(w){return(0,w.reject)(f)}),d=[]},m}/*!
  * vue-router v4.2.4
  * (c) 2023 Eduardo San Martin Morote
  * @license MIT
  */const nn=typeof window<"u";function Qd(e){return e.__esModule||e[Symbol.toStringTag]==="Module"}const ve=Object.assign;function Ga(e,r){const n={};for(const a in r){const o=r[a];n[a]=sr(o)?o.map(e):e(o)}return n}const zn=()=>{},sr=Array.isArray,eu=/\/$/,ru=e=>e.replace(eu,"");function Ya(e,r,n="/"){let a,o={},t="",s="";const c=r.indexOf("#");let i=r.indexOf("?");return c<i&&c>=0&&(i=-1),i>-1&&(a=r.slice(0,i),t=r.slice(i+1,c>-1?c:r.length),o=e(t)),c>-1&&(a=a||r.slice(0,c),s=r.slice(c,r.length)),a=tu(a??r,n),{fullPath:a+(t&&"?")+t+s,path:a,query:o,hash:s}}function nu(e,r){const n=r.query?e(r.query):"";return r.path+(n&&"?")+n+(r.hash||"")}function Nt(e,r){return!r||!e.toLowerCase().startsWith(r.toLowerCase())?e:e.slice(r.length)||"/"}function au(e,r,n){const a=r.matched.length-1,o=n.matched.length-1;return a>-1&&a===o&&hn(r.matched[a],n.matched[o])&&Ci(r.params,n.params)&&e(r.query)===e(n.query)&&r.hash===n.hash}function hn(e,r){return(e.aliasOf||e)===(r.aliasOf||r)}function Ci(e,r){if(Object.keys(e).length!==Object.keys(r).length)return!1;for(const n in e)if(!ou(e[n],r[n]))return!1;return!0}function ou(e,r){return sr(e)?Mt(e,r):sr(r)?Mt(r,e):e===r}function Mt(e,r){return sr(r)?e.length===r.length&&e.every((n,a)=>n===r[a]):e.length===1&&e[0]===r}function tu(e,r){if(e.startsWith("/"))return e;if(!e)return r;const n=r.split("/"),a=e.split("/"),o=a[a.length-1];(o===".."||o===".")&&a.push("");let t=n.length-1,s,c;for(s=0;s<a.length;s++)if(c=a[s],c!==".")if(c==="..")t>1&&t--;else break;return n.slice(0,t).join("/")+"/"+a.slice(s-(s===a.length?1:0)).join("/")}var Mn;(function(e){e.pop="pop",e.push="push"})(Mn||(Mn={}));var An;(function(e){e.back="back",e.forward="forward",e.unknown=""})(An||(An={}));function su(e){if(!e)if(nn){const r=document.querySelector("base");e=r&&r.getAttribute("href")||"/",e=e.replace(/^\w+:\/\/[^\/]+/,"")}else e="/";return e[0]!=="/"&&e[0]!=="#"&&(e="/"+e),ru(e)}const iu=/^[^#]+#/;function cu(e,r){return e.replace(iu,"#")+r}function lu(e,r){const n=document.documentElement.getBoundingClientRect(),a=e.getBoundingClientRect();return{behavior:r.behavior,left:a.left-n.left-(r.left||0),top:a.top-n.top-(r.top||0)}}const Oa=()=>({left:window.pageXOffset,top:window.pageYOffset});function du(e){let r;if("el"in e){const n=e.el,a=typeof n=="string"&&n.startsWith("#"),o=typeof n=="string"?a?document.getElementById(n.slice(1)):document.querySelector(n):n;if(!o)return;r=lu(o,e)}else r=e;"scrollBehavior"in document.documentElement.style?window.scrollTo(r):window.scrollTo(r.left!=null?r.left:window.pageXOffset,r.top!=null?r.top:window.pageYOffset)}function Dt(e,r){return(history.state?history.state.position-r:-1)+e}const ho=new Map;function uu(e,r){ho.set(e,r)}function pu(e){const r=ho.get(e);return ho.delete(e),r}let mu=()=>location.protocol+"//"+location.host;function zi(e,r){const{pathname:n,search:a,hash:o}=r,t=e.indexOf("#");if(t>-1){let c=o.includes(e.slice(t))?e.slice(t).length:1,i=o.slice(c);return i[0]!=="/"&&(i="/"+i),Nt(i,"")}return Nt(n,e)+a+o}function hu(e,r,n,a){let o=[],t=[],s=null;const c=({state:m})=>{const f=zi(e,location),w=n.value,P=r.value;let q=0;if(m){if(n.value=f,r.value=m,s&&s===w){s=null;return}q=P?m.position-P.position:0}else a(f);o.forEach(b=>{b(n.value,w,{delta:q,type:Mn.pop,direction:q?q>0?An.forward:An.back:An.unknown})})};function i(){s=n.value}function l(m){o.push(m);const f=()=>{const w=o.indexOf(m);w>-1&&o.splice(w,1)};return t.push(f),f}function d(){const{history:m}=window;m.state&&m.replaceState(ve({},m.state,{scroll:Oa()}),"")}function u(){for(const m of t)m();t=[],window.removeEventListener("popstate",c),window.removeEventListener("beforeunload",d)}return window.addEventListener("popstate",c),window.addEventListener("beforeunload",d,{passive:!0}),{pauseListeners:i,listen:l,destroy:u}}function Ft(e,r,n,a=!1,o=!1){return{back:e,current:r,forward:n,replaced:a,position:window.history.length,scroll:o?Oa():null}}function fu(e){const{history:r,location:n}=window,a={value:zi(e,n)},o={value:r.state};o.value||t(a.value,{back:null,current:a.value,forward:null,position:r.length-1,replaced:!0,scroll:null},!0);function t(i,l,d){const u=e.indexOf("#"),m=u>-1?(n.host&&document.querySelector("base")?e:e.slice(u))+i:mu()+e+i;try{r[d?"replaceState":"pushState"](l,"",m),o.value=l}catch(f){console.error(f),n[d?"replace":"assign"](m)}}function s(i,l){const d=ve({},r.state,Ft(o.value.back,i,o.value.forward,!0),l,{position:o.value.position});t(i,d,!0),a.value=i}function c(i,l){const d=ve({},o.value,r.state,{forward:i,scroll:Oa()});t(d.current,d,!0);const u=ve({},Ft(a.value,i,null),{position:d.position+1},l);t(i,u,!1),a.value=i}return{location:a,state:o,push:c,replace:s}}function gu(e){e=su(e);const r=fu(e),n=hu(e,r.state,r.location,r.replace);function a(t,s=!0){s||n.pauseListeners(),history.go(t)}const o=ve({location:"",base:e,go:a,createHref:cu.bind(null,e)},r,n);return Object.defineProperty(o,"location",{enumerable:!0,get:()=>r.location.value}),Object.defineProperty(o,"state",{enumerable:!0,get:()=>r.state.value}),o}function bu(e){return typeof e=="string"||e&&typeof e=="object"}function Ai(e){return typeof e=="string"||typeof e=="symbol"}const hr={path:"/",name:void 0,params:{},query:{},hash:"",fullPath:"/",matched:[],meta:{},redirectedFrom:void 0},Ii=Symbol("");var Bt;(function(e){e[e.aborted=4]="aborted",e[e.cancelled=8]="cancelled",e[e.duplicated=16]="duplicated"})(Bt||(Bt={}));function fn(e,r){return ve(new Error,{type:e,[Ii]:!0},r)}function pr(e,r){return e instanceof Error&&Ii in e&&(r==null||!!(e.type&r))}const Ut="[^/]+?",vu={sensitive:!1,strict:!1,start:!0,end:!0},yu=/[.+*?^${}()[\]/\\]/g;function wu(e,r){const n=ve({},vu,r),a=[];let o=n.start?"^":"";const t=[];for(const l of e){const d=l.length?[]:[90];n.strict&&!l.length&&(o+="/");for(let u=0;u<l.length;u++){const m=l[u];let f=40+(n.sensitive?.25:0);if(m.type===0)u||(o+="/"),o+=m.value.replace(yu,"\\$&"),f+=40;else if(m.type===1){const{value:w,repeatable:P,optional:q,regexp:b}=m;t.push({name:w,repeatable:P,optional:q});const y=b||Ut;if(y!==Ut){f+=10;try{new RegExp(`(${y})`)}catch(j){throw new Error(`Invalid custom RegExp for param "${w}" (${y}): `+j.message)}}let T=P?`((?:${y})(?:/(?:${y}))*)`:`(${y})`;u||(T=q&&l.length<2?`(?:/${T})`:"/"+T),q&&(T+="?"),o+=T,f+=20,q&&(f+=-8),P&&(f+=-20),y===".*"&&(f+=-50)}d.push(f)}a.push(d)}if(n.strict&&n.end){const l=a.length-1;a[l][a[l].length-1]+=.7000000000000001}n.strict||(o+="/?"),n.end?o+="$":n.strict&&(o+="(?:/|$)");const s=new RegExp(o,n.sensitive?"":"i");function c(l){const d=l.match(s),u={};if(!d)return null;for(let m=1;m<d.length;m++){const f=d[m]||"",w=t[m-1];u[w.name]=f&&w.repeatable?f.split("/"):f}return u}function i(l){let d="",u=!1;for(const m of e){(!u||!d.endsWith("/"))&&(d+="/"),u=!1;for(const f of m)if(f.type===0)d+=f.value;else if(f.type===1){const{value:w,repeatable:P,optional:q}=f,b=w in l?l[w]:"";if(sr(b)&&!P)throw new Error(`Provided param "${w}" is an array but it is not repeatable (* or + modifiers)`);const y=sr(b)?b.join("/"):b;if(!y)if(q)m.length<2&&(d.endsWith("/")?d=d.slice(0,-1):u=!0);else throw new Error(`Missing required param "${w}"`);d+=y}}return d||"/"}return{re:s,score:a,keys:t,parse:c,stringify:i}}function Pu(e,r){let n=0;for(;n<e.length&&n<r.length;){const a=r[n]-e[n];if(a)return a;n++}return e.length<r.length?e.length===1&&e[0]===40+40?-1:1:e.length>r.length?r.length===1&&r[0]===40+40?1:-1:0}function Su(e,r){let n=0;const a=e.score,o=r.score;for(;n<a.length&&n<o.length;){const t=Pu(a[n],o[n]);if(t)return t;n++}if(Math.abs(o.length-a.length)===1){if(Ht(a))return 1;if(Ht(o))return-1}return o.length-a.length}function Ht(e){const r=e[e.length-1];return e.length>0&&r[r.length-1]<0}const qu={type:0,value:""},xu=/[a-zA-Z0-9_]/;function _u(e){if(!e)return[[]];if(e==="/")return[[qu]];if(!e.startsWith("/"))throw new Error(`Invalid path "${e}"`);function r(f){throw new Error(`ERR (${n})/"${l}": ${f}`)}let n=0,a=n;const o=[];let t;function s(){t&&o.push(t),t=[]}let c=0,i,l="",d="";function u(){l&&(n===0?t.push({type:0,value:l}):n===1||n===2||n===3?(t.length>1&&(i==="*"||i==="+")&&r(`A repeatable param (${l}) must be alone in its segment. eg: '/:ids+.`),t.push({type:1,value:l,regexp:d,repeatable:i==="*"||i==="+",optional:i==="*"||i==="?"})):r("Invalid state to consume buffer"),l="")}function m(){l+=i}for(;c<e.length;){if(i=e[c++],i==="\\"&&n!==2){a=n,n=4;continue}switch(n){case 0:i==="/"?(l&&u(),s()):i===":"?(u(),n=1):m();break;case 4:m(),n=a;break;case 1:i==="("?n=2:xu.test(i)?m():(u(),n=0,i!=="*"&&i!=="?"&&i!=="+"&&c--);break;case 2:i===")"?d[d.length-1]=="\\"?d=d.slice(0,-1)+i:n=3:d+=i;break;case 3:u(),n=0,i!=="*"&&i!=="?"&&i!=="+"&&c--,d="";break;default:r("Unknown state");break}}return n===2&&r(`Unfinished custom RegExp for param "${l}"`),u(),s(),o}function ku(e,r,n){const a=wu(_u(e.path),n),o=ve(a,{record:e,parent:r,children:[],alias:[]});return r&&!o.record.aliasOf==!r.record.aliasOf&&r.children.push(o),o}function Eu(e,r){const n=[],a=new Map;r=Jt({strict:!1,end:!0,sensitive:!1},r);function o(d){return a.get(d)}function t(d,u,m){const f=!m,w=ju(d);w.aliasOf=m&&m.record;const P=Jt(r,d),q=[w];if("alias"in d){const T=typeof d.alias=="string"?[d.alias]:d.alias;for(const j of T)q.push(ve({},w,{components:m?m.record.components:w.components,path:j,aliasOf:m?m.record:w}))}let b,y;for(const T of q){const{path:j}=T;if(u&&j[0]!=="/"){const V=u.record.path,K=V[V.length-1]==="/"?"":"/";T.path=u.record.path+(j&&K+j)}if(b=ku(T,u,P),m?m.alias.push(b):(y=y||b,y!==b&&y.alias.push(b),f&&d.name&&!Vt(b)&&s(d.name)),w.children){const V=w.children;for(let K=0;K<V.length;K++)t(V[K],b,m&&m.children[K])}m=m||b,(b.record.components&&Object.keys(b.record.components).length||b.record.name||b.record.redirect)&&i(b)}return y?()=>{s(y)}:zn}function s(d){if(Ai(d)){const u=a.get(d);u&&(a.delete(d),n.splice(n.indexOf(u),1),u.children.forEach(s),u.alias.forEach(s))}else{const u=n.indexOf(d);u>-1&&(n.splice(u,1),d.record.name&&a.delete(d.record.name),d.children.forEach(s),d.alias.forEach(s))}}function c(){return n}function i(d){let u=0;for(;u<n.length&&Su(d,n[u])>=0&&(d.record.path!==n[u].record.path||!Li(d,n[u]));)u++;n.splice(u,0,d),d.record.name&&!Vt(d)&&a.set(d.record.name,d)}function l(d,u){let m,f={},w,P;if("name"in d&&d.name){if(m=a.get(d.name),!m)throw fn(1,{location:d});P=m.record.name,f=ve(Wt(u.params,m.keys.filter(y=>!y.optional).map(y=>y.name)),d.params&&Wt(d.params,m.keys.map(y=>y.name))),w=m.stringify(f)}else if("path"in d)w=d.path,m=n.find(y=>y.re.test(w)),m&&(f=m.parse(w),P=m.record.name);else{if(m=u.name?a.get(u.name):n.find(y=>y.re.test(u.path)),!m)throw fn(1,{location:d,currentLocation:u});P=m.record.name,f=ve({},u.params,d.params),w=m.stringify(f)}const q=[];let b=m;for(;b;)q.unshift(b.record),b=b.parent;return{name:P,path:w,params:f,matched:q,meta:Cu(q)}}return e.forEach(d=>t(d)),{addRoute:t,resolve:l,removeRoute:s,getRoutes:c,getRecordMatcher:o}}function Wt(e,r){const n={};for(const a of r)a in e&&(n[a]=e[a]);return n}function ju(e){return{path:e.path,redirect:e.redirect,name:e.name,meta:e.meta||{},aliasOf:void 0,beforeEnter:e.beforeEnter,props:Tu(e),children:e.children||[],instances:{},leaveGuards:new Set,updateGuards:new Set,enterCallbacks:{},components:"components"in e?e.components||null:e.component&&{default:e.component}}}function Tu(e){const r={},n=e.props||!1;if("component"in e)r.default=n;else for(const a in e.components)r[a]=typeof n=="object"?n[a]:n;return r}function Vt(e){for(;e;){if(e.record.aliasOf)return!0;e=e.parent}return!1}function Cu(e){return e.reduce((r,n)=>ve(r,n.meta),{})}function Jt(e,r){const n={};for(const a in e)n[a]=a in r?r[a]:e[a];return n}function Li(e,r){return r.children.some(n=>n===e||Li(e,n))}const Ri=/#/g,zu=/&/g,Au=/\//g,Iu=/=/g,Lu=/\?/g,Oi=/\+/g,Ru=/%5B/g,Ou=/%5D/g,Ni=/%5E/g,Nu=/%60/g,Mi=/%7B/g,Mu=/%7C/g,Di=/%7D/g,Du=/%20/g;function Uo(e){return encodeURI(""+e).replace(Mu,"|").replace(Ru,"[").replace(Ou,"]")}function Fu(e){return Uo(e).replace(Mi,"{").replace(Di,"}").replace(Ni,"^")}function fo(e){return Uo(e).replace(Oi,"%2B").replace(Du,"+").replace(Ri,"%23").replace(zu,"%26").replace(Nu,"`").replace(Mi,"{").replace(Di,"}").replace(Ni,"^")}function Bu(e){return fo(e).replace(Iu,"%3D")}function Uu(e){return Uo(e).replace(Ri,"%23").replace(Lu,"%3F")}function Hu(e){return e==null?"":Uu(e).replace(Au,"%2F")}function Pa(e){try{return decodeURIComponent(""+e)}catch{}return""+e}function Wu(e){const r={};if(e===""||e==="?")return r;const a=(e[0]==="?"?e.slice(1):e).split("&");for(let o=0;o<a.length;++o){const t=a[o].replace(Oi," "),s=t.indexOf("="),c=Pa(s<0?t:t.slice(0,s)),i=s<0?null:Pa(t.slice(s+1));if(c in r){let l=r[c];sr(l)||(l=r[c]=[l]),l.push(i)}else r[c]=i}return r}function $t(e){let r="";for(let n in e){const a=e[n];if(n=Bu(n),a==null){a!==void 0&&(r+=(r.length?"&":"")+n);continue}(sr(a)?a.map(t=>t&&fo(t)):[a&&fo(a)]).forEach(t=>{t!==void 0&&(r+=(r.length?"&":"")+n,t!=null&&(r+="="+t))})}return r}function Vu(e){const r={};for(const n in e){const a=e[n];a!==void 0&&(r[n]=sr(a)?a.map(o=>o==null?null:""+o):a==null?a:""+a)}return r}const Ju=Symbol(""),Gt=Symbol(""),Na=Symbol(""),Ho=Symbol(""),go=Symbol("");function qn(){let e=[];function r(a){return e.push(a),()=>{const o=e.indexOf(a);o>-1&&e.splice(o,1)}}function n(){e=[]}return{add:r,list:()=>e.slice(),reset:n}}function Cr(e,r,n,a,o){const t=a&&(a.enterCallbacks[o]=a.enterCallbacks[o]||[]);return()=>new Promise((s,c)=>{const i=u=>{u===!1?c(fn(4,{from:n,to:r})):u instanceof Error?c(u):bu(u)?c(fn(2,{from:r,to:u})):(t&&a.enterCallbacks[o]===t&&typeof u=="function"&&t.push(u),s())},l=e.call(a&&a.instances[o],r,n,i);let d=Promise.resolve(l);e.length<3&&(d=d.then(i)),d.catch(u=>c(u))})}function Za(e,r,n,a){const o=[];for(const t of e)for(const s in t.components){let c=t.components[s];if(!(r!=="beforeRouteEnter"&&!t.instances[s]))if($u(c)){const l=(c.__vccOpts||c)[r];l&&o.push(Cr(l,n,a,t,s))}else{let i=c();o.push(()=>i.then(l=>{if(!l)return Promise.reject(new Error(`Couldn't resolve component "${s}" at "${t.path}"`));const d=Qd(l)?l.default:l;t.components[s]=d;const m=(d.__vccOpts||d)[r];return m&&Cr(m,n,a,t,s)()}))}}return o}function $u(e){return typeof e=="object"||"displayName"in e||"props"in e||"__vccOpts"in e}function Yt(e){const r=Te(Na),n=Te(Ho),a=M(()=>r.resolve(ee(e.to))),o=M(()=>{const{matched:i}=a.value,{length:l}=i,d=i[l-1],u=n.matched;if(!d||!u.length)return-1;const m=u.findIndex(hn.bind(null,d));if(m>-1)return m;const f=Zt(i[l-2]);return l>1&&Zt(d)===f&&u[u.length-1].path!==f?u.findIndex(hn.bind(null,i[l-2])):m}),t=M(()=>o.value>-1&&Xu(n.params,a.value.params)),s=M(()=>o.value>-1&&o.value===n.matched.length-1&&Ci(n.params,a.value.params));function c(i={}){return Zu(i)?r[ee(e.replace)?"replace":"push"](ee(e.to)).catch(zn):Promise.resolve()}return{route:a,href:M(()=>a.value.href),isActive:t,isExactActive:s,navigate:c}}const Gu=ue({name:"RouterLink",compatConfig:{MODE:3},props:{to:{type:[String,Object],required:!0},replace:Boolean,activeClass:String,exactActiveClass:String,custom:Boolean,ariaCurrentValue:{type:String,default:"page"}},useLink:Yt,setup(e,{slots:r}){const n=Un(Yt(e)),{options:a}=Te(Na),o=M(()=>({[Xt(e.activeClass,a.linkActiveClass,"router-link-active")]:n.isActive,[Xt(e.exactActiveClass,a.linkExactActiveClass,"router-link-exact-active")]:n.isExactActive}));return()=>{const t=r.default&&r.default(n);return e.custom?t:le("a",{"aria-current":n.isExactActive?e.ariaCurrentValue:null,href:n.href,onClick:n.navigate,class:o.value},t)}}}),Yu=Gu;function Zu(e){if(!(e.metaKey||e.altKey||e.ctrlKey||e.shiftKey)&&!e.defaultPrevented&&!(e.button!==void 0&&e.button!==0)){if(e.currentTarget&&e.currentTarget.getAttribute){const r=e.currentTarget.getAttribute("target");if(/\b_blank\b/i.test(r))return}return e.preventDefault&&e.preventDefault(),!0}}function Xu(e,r){for(const n in r){const a=r[n],o=e[n];if(typeof a=="string"){if(a!==o)return!1}else if(!sr(o)||o.length!==a.length||a.some((t,s)=>t!==o[s]))return!1}return!0}function Zt(e){return e?e.aliasOf?e.aliasOf.path:e.path:""}const Xt=(e,r,n)=>e??r??n,Ku=ue({name:"RouterView",inheritAttrs:!1,props:{name:{type:String,default:"default"},route:Object},compatConfig:{MODE:3},setup(e,{attrs:r,slots:n}){const a=Te(go),o=M(()=>e.route||a.value),t=Te(Gt,0),s=M(()=>{let l=ee(t);const{matched:d}=o.value;let u;for(;(u=d[l])&&!u.components;)l++;return l}),c=M(()=>o.value.matched[s.value]);Gr(Gt,M(()=>s.value+1)),Gr(Ju,c),Gr(go,o);const i=ge();return tr(()=>[i.value,c.value,e.name],([l,d,u],[m,f,w])=>{d&&(d.instances[u]=l,f&&f!==d&&l&&l===m&&(d.leaveGuards.size||(d.leaveGuards=f.leaveGuards),d.updateGuards.size||(d.updateGuards=f.updateGuards))),l&&d&&(!f||!hn(d,f)||!m)&&(d.enterCallbacks[u]||[]).forEach(P=>P(l))},{flush:"post"}),()=>{const l=o.value,d=e.name,u=c.value,m=u&&u.components[d];if(!m)return Kt(n.default,{Component:m,route:l});const f=u.props[d],w=f?f===!0?l.params:typeof f=="function"?f(l):f:null,q=le(m,ve({},w,r,{onVnodeUnmounted:b=>{b.component.isUnmounted&&(u.instances[d]=null)},ref:i}));return Kt(n.default,{Component:q,route:l})||q}}});function Kt(e,r){if(!e)return null;const n=e(r);return n.length===1?n[0]:n}const Fi=Ku;function Qu(e){const r=Eu(e.routes,e),n=e.parseQuery||Wu,a=e.stringifyQuery||$t,o=e.history,t=qn(),s=qn(),c=qn(),i=To(hr);let l=hr;nn&&e.scrollBehavior&&"scrollRestoration"in history&&(history.scrollRestoration="manual");const d=Ga.bind(null,x=>""+x),u=Ga.bind(null,Hu),m=Ga.bind(null,Pa);function f(x,U){let O,$;return Ai(x)?(O=r.getRecordMatcher(x),$=U):$=x,r.addRoute($,O)}function w(x){const U=r.getRecordMatcher(x);U&&r.removeRoute(U)}function P(){return r.getRoutes().map(x=>x.record)}function q(x){return!!r.getRecordMatcher(x)}function b(x,U){if(U=ve({},U||i.value),typeof x=="string"){const v=Ya(n,x,U.path),S=r.resolve({path:v.path},U),_=o.createHref(v.fullPath);return ve(v,S,{params:m(S.params),hash:Pa(v.hash),redirectedFrom:void 0,href:_})}let O;if("path"in x)O=ve({},x,{path:Ya(n,x.path,U.path).path});else{const v=ve({},x.params);for(const S in v)v[S]==null&&delete v[S];O=ve({},x,{params:u(v)}),U.params=u(U.params)}const $=r.resolve(O,U),de=x.hash||"";$.params=d(m($.params));const p=nu(a,ve({},x,{hash:Fu(de),path:$.path})),h=o.createHref(p);return ve({fullPath:p,hash:de,query:a===$t?Vu(x.query):x.query||{}},$,{redirectedFrom:void 0,href:h})}function y(x){return typeof x=="string"?Ya(n,x,i.value.path):ve({},x)}function T(x,U){if(l!==x)return fn(8,{from:U,to:x})}function j(x){return R(x)}function V(x){return j(ve(y(x),{replace:!0}))}function K(x){const U=x.matched[x.matched.length-1];if(U&&U.redirect){const{redirect:O}=U;let $=typeof O=="function"?O(x):O;return typeof $=="string"&&($=$.includes("?")||$.includes("#")?$=y($):{path:$},$.params={}),ve({query:x.query,hash:x.hash,params:"path"in $?{}:x.params},$)}}function R(x,U){const O=l=b(x),$=i.value,de=x.state,p=x.force,h=x.replace===!0,v=K(O);if(v)return R(ve(y(v),{state:typeof v=="object"?ve({},de,v.state):de,force:p,replace:h}),U||O);const S=O;S.redirectedFrom=U;let _;return!p&&au(a,$,O)&&(_=fn(16,{to:S,from:$}),We($,$,!0,!1)),(_?Promise.resolve(_):D(S,$)).catch(E=>pr(E)?pr(E,2)?E:Re(E):te(E,S,$)).then(E=>{if(E){if(pr(E,2))return R(ve({replace:h},y(E.to),{state:typeof E.to=="object"?ve({},de,E.to.state):de,force:p}),U||S)}else E=k(S,$,!0,h,de);return G(S,$,E),E})}function g(x,U){const O=T(x,U);return O?Promise.reject(O):Promise.resolve()}function H(x){const U=qr.values().next().value;return U&&typeof U.runWithContext=="function"?U.runWithContext(x):x()}function D(x,U){let O;const[$,de,p]=ep(x,U);O=Za($.reverse(),"beforeRouteLeave",x,U);for(const v of $)v.leaveGuards.forEach(S=>{O.push(Cr(S,x,U))});const h=g.bind(null,x,U);return O.push(h),Ie(O).then(()=>{O=[];for(const v of t.list())O.push(Cr(v,x,U));return O.push(h),Ie(O)}).then(()=>{O=Za(de,"beforeRouteUpdate",x,U);for(const v of de)v.updateGuards.forEach(S=>{O.push(Cr(S,x,U))});return O.push(h),Ie(O)}).then(()=>{O=[];for(const v of p)if(v.beforeEnter)if(sr(v.beforeEnter))for(const S of v.beforeEnter)O.push(Cr(S,x,U));else O.push(Cr(v.beforeEnter,x,U));return O.push(h),Ie(O)}).then(()=>(x.matched.forEach(v=>v.enterCallbacks={}),O=Za(p,"beforeRouteEnter",x,U),O.push(h),Ie(O))).then(()=>{O=[];for(const v of s.list())O.push(Cr(v,x,U));return O.push(h),Ie(O)}).catch(v=>pr(v,8)?v:Promise.reject(v))}function G(x,U,O){c.list().forEach($=>H(()=>$(x,U,O)))}function k(x,U,O,$,de){const p=T(x,U);if(p)return p;const h=U===hr,v=nn?history.state:{};O&&($||h?o.replace(x.fullPath,ve({scroll:h&&v&&v.scroll},de)):o.push(x.fullPath,de)),i.value=x,We(x,U,O,h),Re()}let I;function L(){I||(I=o.listen((x,U,O)=>{if(!ir.listening)return;const $=b(x),de=K($);if(de){R(ve(de,{replace:!0}),$).catch(zn);return}l=$;const p=i.value;nn&&uu(Dt(p.fullPath,O.delta),Oa()),D($,p).catch(h=>pr(h,12)?h:pr(h,2)?(R(h.to,$).then(v=>{pr(v,20)&&!O.delta&&O.type===Mn.pop&&o.go(-1,!1)}).catch(zn),Promise.reject()):(O.delta&&o.go(-O.delta,!1),te(h,$,p))).then(h=>{h=h||k($,p,!1),h&&(O.delta&&!pr(h,8)?o.go(-O.delta,!1):O.type===Mn.pop&&pr(h,20)&&o.go(-1,!1)),G($,p,h)}).catch(zn)}))}let ie=qn(),W=qn(),oe;function te(x,U,O){Re(x);const $=W.list();return $.length?$.forEach(de=>de(x,U,O)):console.error(x),Promise.reject(x)}function Me(){return oe&&i.value!==hr?Promise.resolve():new Promise((x,U)=>{ie.add([x,U])})}function Re(x){return oe||(oe=!x,L(),ie.list().forEach(([U,O])=>x?O(x):U()),ie.reset()),x}function We(x,U,O,$){const{scrollBehavior:de}=e;if(!nn||!de)return Promise.resolve();const p=!O&&pu(Dt(x.fullPath,0))||($||!O)&&history.state&&history.state.scroll||null;return Wn().then(()=>de(x,U,p)).then(h=>h&&du(h)).catch(h=>te(h,x,U))}const De=x=>o.go(x);let Sr;const qr=new Set,ir={currentRoute:i,listening:!0,addRoute:f,removeRoute:w,hasRoute:q,getRoutes:P,resolve:b,options:e,push:j,replace:V,go:De,back:()=>De(-1),forward:()=>De(1),beforeEach:t.add,beforeResolve:s.add,afterEach:c.add,onError:W.add,isReady:Me,install(x){const U=this;x.component("RouterLink",Yu),x.component("RouterView",Fi),x.config.globalProperties.$router=U,Object.defineProperty(x.config.globalProperties,"$route",{enumerable:!0,get:()=>ee(i)}),nn&&!Sr&&i.value===hr&&(Sr=!0,j(o.location).catch(de=>{}));const O={};for(const de in hr)Object.defineProperty(O,de,{get:()=>i.value[de],enumerable:!0});x.provide(Na,U),x.provide(Ho,Ms(O)),x.provide(go,i);const $=x.unmount;qr.add(x),x.unmount=function(){qr.delete(x),qr.size<1&&(l=hr,I&&I(),I=null,i.value=hr,Sr=!1,oe=!1),$()}}};function Ie(x){return x.reduce((U,O)=>U.then(()=>H(O)),Promise.resolve())}return ir}function ep(e,r){const n=[],a=[],o=[],t=Math.max(r.matched.length,e.matched.length);for(let s=0;s<t;s++){const c=r.matched[s];c&&(e.matched.find(l=>hn(l,c))?a.push(c):n.push(c));const i=e.matched[s];i&&(r.matched.find(l=>hn(l,i))||o.push(i))}return[n,a,o]}function Xr(){return Te(Na)}function Kr(){return Te(Ho)}const rp=({headerLinkSelector:e,headerAnchorSelector:r,delay:n,offset:a=5})=>{const o=Xr(),s=Ti(()=>{var P,q;const c=Math.max(window.scrollY,document.documentElement.scrollTop,document.body.scrollTop);if(Math.abs(c-0)<a){Qt(o,"");return}const l=window.innerHeight+c,d=Math.max(document.documentElement.scrollHeight,document.body.scrollHeight),u=Math.abs(d-l)<a,m=Array.from(document.querySelectorAll(e)),w=Array.from(document.querySelectorAll(r)).filter(b=>m.some(y=>y.hash===b.hash));for(let b=0;b<w.length;b++){const y=w[b],T=w[b+1],j=c>=(((P=y.parentElement)==null?void 0:P.offsetTop)??0)-a,V=!T||c<(((q=T.parentElement)==null?void 0:q.offsetTop)??0)-a;if(!(j&&V))continue;const R=decodeURIComponent(o.currentRoute.value.hash),g=decodeURIComponent(y.hash);if(R===g)return;if(u){for(let H=b+1;H<w.length;H++)if(R===decodeURIComponent(w[H].hash))return}Qt(o,g);return}},n);He(()=>{window.addEventListener("scroll",s)}),Jn(()=>{window.removeEventListener("scroll",s)})},Qt=async(e,r)=>{const{scrollBehavior:n}=e.options;e.options.scrollBehavior=void 0,await e.replace({query:e.currentRoute.value.query,hash:r}).finally(()=>e.options.scrollBehavior=n)},np="a.sidebar-item",ap=".header-anchor",op=300,tp=5,sp=Pr({setup(){rp({headerLinkSelector:np,headerAnchorSelector:ap,delay:op,offset:tp})}}),es=()=>window.pageYOffset||document.documentElement.scrollTop||document.body.scrollTop||0,ip=()=>window.scrollTo({top:0,behavior:"smooth"});const cp=ue({name:"BackToTop",setup(){const e=ge(0),r=M(()=>e.value>300),n=Ti(()=>{e.value=es()},100);He(()=>{e.value=es(),window.addEventListener("scroll",()=>n())});const a=le("div",{class:"back-to-top",onClick:ip});return()=>le($n,{name:"back-to-top"},()=>r.value?a:null)}}),lp=Pr({rootComponents:[cp]});const dp=le("svg",{class:"external-link-icon",xmlns:"http://www.w3.org/2000/svg","aria-hidden":"true",focusable:"false",x:"0px",y:"0px",viewBox:"0 0 100 100",width:"15",height:"15"},[le("path",{fill:"currentColor",d:"M18.8,85.1h56l0,0c2.2,0,4-1.8,4-4v-32h-8v28h-48v-48h28v-8h-32l0,0c-2.2,0-4,1.8-4,4v56C14.8,83.3,16.6,85.1,18.8,85.1z"}),le("polygon",{fill:"currentColor",points:"45.7,48.7 51.3,54.3 77.2,28.5 77.2,37.2 85.2,37.2 85.2,14.9 62.8,14.9 62.8,22.9 71.5,22.9"})]),up=ue({name:"ExternalLinkIcon",props:{locales:{type:Object,required:!1,default:()=>({})}},setup(e){const r=yn(),n=M(()=>e.locales[r.value]??{openInNewWindow:"open in new window"});return()=>le("span",[dp,le("span",{class:"external-link-icon-sr-only"},n.value.openInNewWindow)])}}),pp={"/ca/":{openInNewWindow:"Obrir en una finestra nova"},"/es/":{openInNewWindow:"Abrir en una ventana nueva"},"/en/":{openInNewWindow:"Open in a new window"},"/":{openInNewWindow:"open in new window"}},mp=Pr({enhance({app:e}){e.component("ExternalLinkIcon",le(up,{locales:pp}))}});/**
 * NProgress, (c) 2013, 2014 Rico Sta. Cruz - http://ricostacruz.com/nprogress
 * @license MIT
 */const pe={settings:{minimum:.08,easing:"ease",speed:200,trickle:!0,trickleRate:.02,trickleSpeed:800,barSelector:'[role="bar"]',parent:"body",template:'<div class="bar" role="bar"></div>'},status:null,set:e=>{const r=pe.isStarted();e=Xa(e,pe.settings.minimum,1),pe.status=e===1?null:e;const n=pe.render(!r),a=n.querySelector(pe.settings.barSelector),o=pe.settings.speed,t=pe.settings.easing;return n.offsetWidth,hp(s=>{aa(a,{transform:"translate3d("+rs(e)+"%,0,0)",transition:"all "+o+"ms "+t}),e===1?(aa(n,{transition:"none",opacity:"1"}),n.offsetWidth,setTimeout(function(){aa(n,{transition:"all "+o+"ms linear",opacity:"0"}),setTimeout(function(){pe.remove(),s()},o)},o)):setTimeout(()=>s(),o)}),pe},isStarted:()=>typeof pe.status=="number",start:()=>{pe.status||pe.set(0);const e=()=>{setTimeout(()=>{pe.status&&(pe.trickle(),e())},pe.settings.trickleSpeed)};return pe.settings.trickle&&e(),pe},done:e=>!e&&!pe.status?pe:pe.inc(.3+.5*Math.random()).set(1),inc:e=>{let r=pe.status;return r?(typeof e!="number"&&(e=(1-r)*Xa(Math.random()*r,.1,.95)),r=Xa(r+e,0,.994),pe.set(r)):pe.start()},trickle:()=>pe.inc(Math.random()*pe.settings.trickleRate),render:e=>{if(pe.isRendered())return document.getElementById("nprogress");ns(document.documentElement,"nprogress-busy");const r=document.createElement("div");r.id="nprogress",r.innerHTML=pe.settings.template;const n=r.querySelector(pe.settings.barSelector),a=e?"-100":rs(pe.status||0),o=document.querySelector(pe.settings.parent);return aa(n,{transition:"all 0 linear",transform:"translate3d("+a+"%,0,0)"}),o!==document.body&&ns(o,"nprogress-custom-parent"),o==null||o.appendChild(r),r},remove:()=>{as(document.documentElement,"nprogress-busy"),as(document.querySelector(pe.settings.parent),"nprogress-custom-parent");const e=document.getElementById("nprogress");e&&fp(e)},isRendered:()=>!!document.getElementById("nprogress")},Xa=(e,r,n)=>e<r?r:e>n?n:e,rs=e=>(-1+e)*100,hp=function(){const e=[];function r(){const n=e.shift();n&&n(r)}return function(n){e.push(n),e.length===1&&r()}}(),aa=function(){const e=["Webkit","O","Moz","ms"],r={};function n(s){return s.replace(/^-ms-/,"ms-").replace(/-([\da-z])/gi,function(c,i){return i.toUpperCase()})}function a(s){const c=document.body.style;if(s in c)return s;let i=e.length;const l=s.charAt(0).toUpperCase()+s.slice(1);let d;for(;i--;)if(d=e[i]+l,d in c)return d;return s}function o(s){return s=n(s),r[s]??(r[s]=a(s))}function t(s,c,i){c=o(c),s.style[c]=i}return function(s,c){for(const i in c){const l=c[i];l!==void 0&&Object.prototype.hasOwnProperty.call(c,i)&&t(s,i,l)}}}(),Bi=(e,r)=>(typeof e=="string"?e:Wo(e)).indexOf(" "+r+" ")>=0,ns=(e,r)=>{const n=Wo(e),a=n+r;Bi(n,r)||(e.className=a.substring(1))},as=(e,r)=>{const n=Wo(e);if(!Bi(e,r))return;const a=n.replace(" "+r+" "," ");e.className=a.substring(1,a.length-1)},Wo=e=>(" "+(e.className||"")+" ").replace(/\s+/gi," "),fp=e=>{e&&e.parentNode&&e.parentNode.removeChild(e)};const gp=()=>{He(()=>{const e=Xr(),r=new Set;r.add(e.currentRoute.value.path),e.beforeEach(n=>{r.has(n.path)||pe.start()}),e.afterEach(n=>{r.add(n.path),pe.done()})})},bp=Pr({setup(){gp()}}),vp=JSON.parse(`{"logo":"/LogoIES.png","repo":"sad2asir/sad_sources","repoLabel":"GitHub","editLink":true,"docsRepo":"https://github.com/sad2asir/sad_sources","docsBranch":"main","docsDir":"docs","lastUpdated":true,"sidebarDepth":2,"locales":{"/ca/":{"home":"/ca/","selectLanguageText":"Idioma","selectLanguageName":"Valencià","selectLanguageAriaLabel":"Idioma","editLink":false,"editLinkText":"Ajuda'ns a millorar aquesta pàgina a GitHub!","lastUpdatedText":"Última actualització","contributorsText":"Editors","notFound":["Recurs no trobat al lloc web"],"backToHome":"Tornar a l'inici","openInNewWindow":"Obrir en una finestra nova","toggleSidebar":"Mostrar/Amagar","serviceWorker":{"updatePopup":{"message":"Hi ha contingut nou disponible.","buttonText":"Actualitzar"}},"navbar":[{"text":"Aules FP","link":"https://aules.edu.gva.es/fp/login/index.php?lang=ca_valencia"},{"text":"Contingut del curs","children":[{"text":"Unitat 1 - Introduction to concurrent programming","link":"/ca/unit1/"},{"text":"Unitat 2 - Process programming in Java","link":"/ca/unitat2/"}]}],"sidebar":{"/ca/":[{"text":"SAD > Inici","link":"/ca/README.md","children":[]}],"/ca/unit1/":[{"isGroup":true,"text":"Unit 1 - Introduction to concurrent programming","children":["index.md","process.md","concurrency.md","operatingsystem.md"]}],"/ca/unit2/":[{"isGroup":true,"text":"Unit 2 - Process Programming in Java","children":["index.md","runtime.md","processbuilder.md","iostreams.md","curl_annex.md"]}]}},"/es/":{"home":"/es/","selectLanguageText":"Idioma","selectLanguageName":"Castellano","selectLanguageAriaLabel":"Idioma","editLink":false,"editLinkText":"Ayúdanos a mejorar esta página en GitHub!","lastUpdatedText":"Última actualización","contributorsText":"Editores","notFound":["No se ha encontrado el recurso solicitado"],"backToHome":"Inicio","openInNewWindow":"Abrir en una ventana nueva","toggleSidebar":"Mostrar/Ocultar","navbar":[{"text":"Aules FP","link":"https://aules.edu.gva.es/fp/login/index.php?lang=es"},{"text":"Contenido del curso","children":[{"text":"Tema 1 - Introducción a la programación concurrente","link":"/es/unit1/"},{"text":"Tema 2 - Programación de procesos en Java","link":"/es/unit2/"}]}],"sidebar":{"/es/":[{"text":"SAD > Inicio","link":"/es/README.md","children":[]}],"/es/unit1/":[{"isGroup":true,"text":"Tema 1 - Introducción a la programación concurrente","children":["index.md","process.md","concurrency.md","operatingsystem.md"]}],"/es/unit2/":[{"isGroup":true,"text":"Tema 2 - Programación de procesos en Java","children":["index.md","runtime.md","processbuilder.md","iostreams.md","curl_annex.md"]}]}},"/en/":{"home":"/en/","selectLanguageText":"Language","selectLanguageName":"English","selectLanguageAriaLabel":"Language","editLink":false,"editLinkText":"Help us to improve this page on GitHub!","lastUpdatedText":"Last updated","contributorsText":"Editors","notFound":["Not found"],"backToHome":"Home","openInNewWindow":"Open in a new window","toggleSidebar":"Hide/Show","navbar":[{"text":"Aules FP","link":"https://aules.edu.gva.es/fp/login/index.php?lang=es"},{"text":"Course content","children":[{"text":"Unit 1- Introducción a la programación concurrente","link":"/en/unit1/"},{"text":"Unit 2 - Programación de procesos en Java","link":"/en/unit2/"}]}],"sidebar":{"/en/":[{"text":"SAD > Home","link":"/en/README.md","children":[]}],"/en/unit1/":[{"isGroup":true,"text":"Unit 1 - Introducción a la programación concurrente","children":["index.md","process.md","concurrency.md","operatingsystem.md"]}],"/en/unit2/":[{"isGroup":true,"text":"Unit 2 - Programación de procesos en Java","children":["index.md","runtime.md","processbuilder.md","iostreams.md","curl_annex.md"]}]}},"/":{"selectLanguageName":"English"}},"colorMode":"auto","colorModeSwitch":true,"navbar":[],"selectLanguageText":"Languages","selectLanguageAriaLabel":"Select language","sidebar":"auto","editLinkText":"Edit this page","lastUpdatedText":"Last Updated","contributors":true,"contributorsText":"Contributors","notFound":["There's nothing here.","How did we get here?","That's a Four-Oh-Four.","Looks like we've got some broken links."],"backToHome":"Take me home","openInNewWindow":"open in new window","toggleColorMode":"toggle color mode","toggleSidebar":"toggle sidebar"}`),yp=ge(vp),Ui=()=>yp,Hi=Symbol(""),wp=()=>{const e=Te(Hi);if(!e)throw new Error("useThemeLocaleData() is called without provider.");return e},Pp=(e,r)=>{const{locales:n,...a}=e;return{...a,...n==null?void 0:n[r]}},Sp=Pr({enhance({app:e}){const r=Ui(),n=e._context.provides[Mo],a=M(()=>Pp(r.value,n.value));e.provide(Hi,a),Object.defineProperties(e.config.globalProperties,{$theme:{get(){return r.value}},$themeLocale:{get(){return a.value}}})}}),qp=ue({__name:"Badge",props:{type:{type:String,required:!1,default:"tip"},text:{type:String,required:!1,default:""},vertical:{type:String,required:!1,default:void 0}},setup(e){return(r,n)=>(B(),Q("span",{class:Je(["badge",e.type]),style:Bn({verticalAlign:e.vertical})},[Pe(r.$slots,"default",{},()=>[Nr(Ae(e.text),1)])],6))}}),_e=(e,r)=>{const n=e.__vccOpts||e;for(const[a,o]of r)n[a]=o;return n},xp=_e(qp,[["__file","Badge.vue"]]),_p=ue({name:"CodeGroup",slots:Object,setup(e,{slots:r}){const n=ge(-1),a=ge([]),o=(c=n.value)=>{c<a.value.length-1?n.value=c+1:n.value=0,a.value[n.value].focus()},t=(c=n.value)=>{c>0?n.value=c-1:n.value=a.value.length-1,a.value[n.value].focus()},s=(c,i)=>{c.key===" "||c.key==="Enter"?(c.preventDefault(),n.value=i):c.key==="ArrowRight"?(c.preventDefault(),o(i)):c.key==="ArrowLeft"&&(c.preventDefault(),t(i))};return()=>{var i;const c=(((i=r.default)==null?void 0:i.call(r))||[]).filter(l=>l.type.name==="CodeGroupItem").map(l=>(l.props===null&&(l.props={}),l));return c.length===0?null:(n.value<0||n.value>c.length-1?(n.value=c.findIndex(l=>l.props.active===""||l.props.active===!0),n.value===-1&&(n.value=0)):c.forEach((l,d)=>{l.props.active=d===n.value}),le("div",{class:"code-group"},[le("div",{class:"code-group__nav"},le("ul",{class:"code-group__ul"},c.map((l,d)=>{const u=d===n.value;return le("li",{class:"code-group__li"},le("button",{ref:m=>{m&&(a.value[d]=m)},class:{"code-group__nav-tab":!0,"code-group__nav-tab-active":u},ariaPressed:u,ariaExpanded:u,onClick:()=>n.value=d,onKeydown:m=>s(m,d)},l.props.title))}))),c]))}}}),kp=["aria-selected"],Ep=ue({name:"CodeGroupItem"}),jp=ue({...Ep,props:{title:{type:String,required:!0},active:{type:Boolean,required:!1,default:!1}},setup(e){return(r,n)=>(B(),Q("div",{class:Je(["code-group-item",{"code-group-item__active":e.active}]),"aria-selected":e.active},[Pe(r.$slots,"default")],10,kp))}}),Tp=_e(jp,[["__file","CodeGroupItem.vue"]]);var Cp=Object.defineProperty,zp=Object.defineProperties,Ap=Object.getOwnPropertyDescriptors,os=Object.getOwnPropertySymbols,Ip=Object.prototype.hasOwnProperty,Lp=Object.prototype.propertyIsEnumerable,ts=(e,r,n)=>r in e?Cp(e,r,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[r]=n,Rp=(e,r)=>{for(var n in r||(r={}))Ip.call(r,n)&&ts(e,n,r[n]);if(os)for(var n of os(r))Lp.call(r,n)&&ts(e,n,r[n]);return e},Op=(e,r)=>zp(e,Ap(r));function ss(e,r){var n;const a=To();return Xs(()=>{a.value=e()},Op(Rp({},r),{flush:(n=r==null?void 0:r.flush)!=null?n:"sync"})),vn(a)}function Vo(e){return Es()?(Sc(e),!0):!1}function Mr(e){return typeof e=="function"?e():ee(e)}const Jo=typeof window<"u",Np=()=>{};function Mp(e,r){function n(...a){return new Promise((o,t)=>{Promise.resolve(e(()=>r.apply(this,a),{fn:r,thisArg:this,args:a})).then(o).catch(t)})}return n}const Wi=e=>e();function Dp(e=Wi){const r=ge(!0);function n(){r.value=!1}function a(){r.value=!0}const o=(...t)=>{r.value&&e(...t)};return{isActive:vn(r),pause:n,resume:a,eventFilter:o}}function Fp(e,r,n={}){const{immediate:a=!0}=n,o=ge(!1);let t=null;function s(){t&&(clearTimeout(t),t=null)}function c(){o.value=!1,s()}function i(...l){s(),o.value=!0,t=setTimeout(()=>{o.value=!1,t=null,e(...l)},Mr(r))}return a&&(o.value=!0,Jo&&i()),Vo(c),{isPending:vn(o),start:i,stop:c}}function Bp(e=!1,r={}){const{truthyValue:n=!0,falsyValue:a=!1}=r,o=Le(e),t=ge(e);function s(c){if(arguments.length)return t.value=c,t.value;{const i=Mr(n);return t.value=t.value===i?Mr(a):i,t.value}}return o?s:[t,s]}var is=Object.getOwnPropertySymbols,Up=Object.prototype.hasOwnProperty,Hp=Object.prototype.propertyIsEnumerable,Wp=(e,r)=>{var n={};for(var a in e)Up.call(e,a)&&r.indexOf(a)<0&&(n[a]=e[a]);if(e!=null&&is)for(var a of is(e))r.indexOf(a)<0&&Hp.call(e,a)&&(n[a]=e[a]);return n};function Vp(e,r,n={}){const a=n,{eventFilter:o=Wi}=a,t=Wp(a,["eventFilter"]);return tr(e,Mp(o,r),t)}var Jp=Object.defineProperty,$p=Object.defineProperties,Gp=Object.getOwnPropertyDescriptors,Sa=Object.getOwnPropertySymbols,Vi=Object.prototype.hasOwnProperty,Ji=Object.prototype.propertyIsEnumerable,cs=(e,r,n)=>r in e?Jp(e,r,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[r]=n,Yp=(e,r)=>{for(var n in r||(r={}))Vi.call(r,n)&&cs(e,n,r[n]);if(Sa)for(var n of Sa(r))Ji.call(r,n)&&cs(e,n,r[n]);return e},Zp=(e,r)=>$p(e,Gp(r)),Xp=(e,r)=>{var n={};for(var a in e)Vi.call(e,a)&&r.indexOf(a)<0&&(n[a]=e[a]);if(e!=null&&Sa)for(var a of Sa(e))r.indexOf(a)<0&&Ji.call(e,a)&&(n[a]=e[a]);return n};function Kp(e,r,n={}){const a=n,{eventFilter:o}=a,t=Xp(a,["eventFilter"]),{eventFilter:s,pause:c,resume:i,isActive:l}=Dp(o);return{stop:Vp(e,r,Zp(Yp({},t),{eventFilter:s})),pause:c,resume:i,isActive:l}}function Qp(e){var r;const n=Mr(e);return(r=n==null?void 0:n.$el)!=null?r:n}const qa=Jo?window:void 0,em=Jo?window.navigator:void 0;function xa(...e){let r,n,a,o;if(typeof e[0]=="string"||Array.isArray(e[0])?([n,a,o]=e,r=qa):[r,n,a,o]=e,!r)return Np;Array.isArray(n)||(n=[n]),Array.isArray(a)||(a=[a]);const t=[],s=()=>{t.forEach(d=>d()),t.length=0},c=(d,u,m,f)=>(d.addEventListener(u,m,f),()=>d.removeEventListener(u,m,f)),i=tr(()=>[Qp(r),Mr(o)],([d,u])=>{s(),d&&t.push(...n.flatMap(m=>a.map(f=>c(d,m,f,u))))},{immediate:!0,flush:"post"}),l=()=>{i(),s()};return Vo(l),l}function rm(){const e=ge(!1);return Ro()&&He(()=>{e.value=!0}),e}function $i(e){const r=rm();return M(()=>(r.value,!!e()))}function nm(e,r={}){const{window:n=qa}=r,a=$i(()=>n&&"matchMedia"in n&&typeof n.matchMedia=="function");let o;const t=ge(!1),s=l=>{t.value=l.matches},c=()=>{o&&("removeEventListener"in o?o.removeEventListener("change",s):o.removeListener(s))},i=Xs(()=>{a.value&&(c(),o=n.matchMedia(Mr(e)),"addEventListener"in o?o.addEventListener("change",s):o.addListener(s),t.value=o.matches)});return Vo(()=>{i(),c(),o=void 0}),t}function am(e={}){const{navigator:r=em,read:n=!1,source:a,copiedDuring:o=1500,legacy:t=!1}=e,s=$i(()=>r&&"clipboard"in r),c=M(()=>s.value||t),i=ge(""),l=ge(!1),d=Fp(()=>l.value=!1,o);function u(){s.value?r.clipboard.readText().then(P=>{i.value=P}):i.value=w()}c.value&&n&&xa(["copy","cut"],u);async function m(P=Mr(a)){c.value&&P!=null&&(s.value?await r.clipboard.writeText(P):f(P),i.value=P,l.value=!0,d.start())}function f(P){const q=document.createElement("textarea");q.value=P??"",q.style.position="absolute",q.style.opacity="0",document.body.appendChild(q),q.select(),document.execCommand("copy"),q.remove()}function w(){var P,q,b;return(b=(q=(P=document==null?void 0:document.getSelection)==null?void 0:P.call(document))==null?void 0:q.toString())!=null?b:""}return{isSupported:c,text:i,copied:l,copy:m}}const oa=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{},ta="__vueuse_ssr_handlers__",om=tm();function tm(){return ta in oa||(oa[ta]=oa[ta]||{}),oa[ta]}function sm(e,r){return om[e]||r}function im(e){return e==null?"any":e instanceof Set?"set":e instanceof Map?"map":e instanceof Date?"date":typeof e=="boolean"?"boolean":typeof e=="string"?"string":typeof e=="object"?"object":Number.isNaN(e)?"any":"number"}var cm=Object.defineProperty,ls=Object.getOwnPropertySymbols,lm=Object.prototype.hasOwnProperty,dm=Object.prototype.propertyIsEnumerable,ds=(e,r,n)=>r in e?cm(e,r,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[r]=n,us=(e,r)=>{for(var n in r||(r={}))lm.call(r,n)&&ds(e,n,r[n]);if(ls)for(var n of ls(r))dm.call(r,n)&&ds(e,n,r[n]);return e};const um={boolean:{read:e=>e==="true",write:e=>String(e)},object:{read:e=>JSON.parse(e),write:e=>JSON.stringify(e)},number:{read:e=>Number.parseFloat(e),write:e=>String(e)},any:{read:e=>e,write:e=>String(e)},string:{read:e=>e,write:e=>String(e)},map:{read:e=>new Map(JSON.parse(e)),write:e=>JSON.stringify(Array.from(e.entries()))},set:{read:e=>new Set(JSON.parse(e)),write:e=>JSON.stringify(Array.from(e))},date:{read:e=>new Date(e),write:e=>e.toISOString()}},ps="vueuse-storage";function pm(e,r,n,a={}){var o;const{flush:t="pre",deep:s=!0,listenToStorageChanges:c=!0,writeDefaults:i=!0,mergeDefaults:l=!1,shallow:d,window:u=qa,eventFilter:m,onError:f=g=>{console.error(g)}}=a,w=(d?To:ge)(r);if(!n)try{n=sm("getDefaultStorage",()=>{var g;return(g=qa)==null?void 0:g.localStorage})()}catch(g){f(g)}if(!n)return w;const P=Mr(r),q=im(P),b=(o=a.serializer)!=null?o:um[q],{pause:y,resume:T}=Kp(w,()=>j(w.value),{flush:t,deep:s,eventFilter:m});return u&&c&&(xa(u,"storage",R),xa(u,ps,K)),R(),w;function j(g){try{if(g==null)n.removeItem(e);else{const H=b.write(g),D=n.getItem(e);D!==H&&(n.setItem(e,H),u&&u.dispatchEvent(new CustomEvent(ps,{detail:{key:e,oldValue:D,newValue:H,storageArea:n}})))}}catch(H){f(H)}}function V(g){const H=g?g.newValue:n.getItem(e);if(H==null)return i&&P!==null&&n.setItem(e,b.write(P)),P;if(!g&&l){const D=b.read(H);return typeof l=="function"?l(D,P):q==="object"&&!Array.isArray(D)?us(us({},P),D):D}else return typeof H!="string"?H:b.read(H)}function K(g){R(g.detail)}function R(g){if(!(g&&g.storageArea!==n)){if(g&&g.key==null){w.value=P;return}if(!(g&&g.key!==e)){y();try{w.value=V(g)}catch(H){f(H)}finally{g?Wn(T):T()}}}}}function mm(e){return nm("(prefers-color-scheme: dark)",e)}const hm=()=>Ui(),Ue=()=>wp(),Gi=Symbol(""),$o=()=>{const e=Te(Gi);if(!e)throw new Error("useDarkMode() is called without provider.");return e},fm=()=>{const e=Ue(),r=mm(),n=pm("vuepress-color-scheme",e.value.colorMode),a=M({get(){return e.value.colorModeSwitch?n.value==="auto"?r.value:n.value==="dark":e.value.colorMode==="dark"},set(o){o===r.value?n.value="auto":n.value=o?"dark":"light"}});Gr(Gi,a),gm(a)},gm=e=>{const r=(n=e.value)=>{const a=window==null?void 0:window.document.querySelector("html");a==null||a.classList.toggle("dark",n)};He(()=>{tr(e,r,{immediate:!0})}),Ia(()=>r())},Yi=(...e)=>{const n=Xr().resolve(...e),a=n.matched[n.matched.length-1];if(!(a!=null&&a.redirect))return n;const{redirect:o}=a,t=se(o)?o(n):o,s=be(t)?{path:t}:t;return Yi({hash:n.hash,query:n.query,params:n.params,...s})},Go=e=>{const r=Yi(encodeURI(e));return{text:r.meta.title||e,link:r.name==="404"?e:r.fullPath}};let Ka=null,xn=null;const bm={wait:()=>Ka,pending:()=>{Ka=new Promise(e=>xn=e)},resolve:()=>{xn==null||xn(),Ka=null,xn=null}},Zi=()=>bm,Xi=Symbol("sidebarItems"),Yo=()=>{const e=Te(Xi);if(!e)throw new Error("useSidebarItems() is called without provider.");return e},vm=()=>{const e=Ue(),r=gr(),n=M(()=>ym(r.value,e.value));Gr(Xi,n)},ym=(e,r)=>{const n=e.sidebar??r.sidebar??"auto",a=e.sidebarDepth??r.sidebarDepth??2;return e.home||n===!1?[]:n==="auto"?Pm(a):X(n)?Ki(n,a):No(n)?Sm(n,a):[]},wm=(e,r)=>({text:e.title,link:e.link,children:Zo(e.children,r)}),Zo=(e,r)=>r>0?e.map(n=>wm(n,r-1)):[],Pm=e=>{const r=Ir();return[{text:r.value.title,children:Zo(r.value.headers,e)}]},Ki=(e,r)=>{const n=Kr(),a=Ir(),o=t=>{var c;let s;if(be(t)?s=Go(t):s=t,s.children)return{...s,children:s.children.map(i=>o(i))};if(s.link===n.path){const i=((c=a.value.headers[0])==null?void 0:c.level)===1?a.value.headers[0].children:a.value.headers;return{...s,children:Zo(i,r)}}return s};return e.map(t=>o(t))},Sm=(e,r)=>{const n=Kr(),a=wi(e,n.path),o=e[a]??[];return Ki(o,r)},qm="2048px",xm={mobile:qm};var Dn;(function(e){e.MOBILE="mobile"})(Dn||(Dn={}));var ws;const _m={[Dn.MOBILE]:Number.parseInt((ws=xm.mobile)==null?void 0:ws.replace("px",""),10)},Qi=(e,r)=>{const n=_m[e];Number.isInteger(n)&&He(()=>{r(n),window.addEventListener("resize",()=>r(n),!1),window.addEventListener("orientationchange",()=>r(n),!1)})},km={},Em={class:"theme-default-content"};function jm(e,r){const n=yr("Content");return B(),Q("div",Em,[ne(n)])}const Tm=_e(km,[["render",jm],["__file","HomeContent.vue"]]),Cm={key:0,class:"features"},zm=ue({__name:"HomeFeatures",setup(e){const r=gr(),n=M(()=>X(r.value.features)?r.value.features:[]);return(a,o)=>n.value.length?(B(),Q("div",Cm,[(B(!0),Q(Se,null,Rr(n.value,t=>(B(),Q("div",{key:t.title,class:"feature"},[he("h2",null,Ae(t.title),1),he("p",null,Ae(t.details),1)]))),128))])):ke("v-if",!0)}}),Am=_e(zm,[["__file","HomeFeatures.vue"]]),Im=["innerHTML"],Lm=["textContent"],Rm=ue({__name:"HomeFooter",setup(e){const r=gr(),n=M(()=>r.value.footer),a=M(()=>r.value.footerHtml);return(o,t)=>n.value?(B(),Q(Se,{key:0},[ke(" eslint-disable-next-line vue/no-v-html "),a.value?(B(),Q("div",{key:0,class:"footer",innerHTML:n.value},null,8,Im)):(B(),Q("div",{key:1,class:"footer",textContent:Ae(n.value)},null,8,Lm))],64)):ke("v-if",!0)}}),Om=_e(Rm,[["__file","HomeFooter.vue"]]),Nm=["href","rel","target","aria-label"],Mm=ue({inheritAttrs:!1}),Dm=ue({...Mm,__name:"AutoLink",props:{item:{type:Object,required:!0}},setup(e){const r=e,n=Kr(),a=Ei(),{item:o}=Ta(r),t=M(()=>Gn(o.value.link)),s=M(()=>Bd(o.value.link)||Ud(o.value.link)),c=M(()=>{if(!s.value){if(o.value.target)return o.value.target;if(t.value)return"_blank"}}),i=M(()=>c.value==="_blank"),l=M(()=>!t.value&&!s.value&&!i.value),d=M(()=>{if(!s.value){if(o.value.rel)return o.value.rel;if(i.value)return"noopener noreferrer"}}),u=M(()=>o.value.ariaLabel||o.value.text),m=M(()=>{const P=Object.keys(a.value.locales);return P.length?!P.some(q=>q===o.value.link):o.value.link!=="/"}),f=M(()=>m.value?n.path.startsWith(o.value.link):!1),w=M(()=>l.value?o.value.activeMatch?new RegExp(o.value.activeMatch).test(n.path):f.value:!1);return(P,q)=>{const b=yr("RouterLink"),y=yr("AutoLinkExternalIcon");return l.value?(B(),je(b,po({key:0,class:{"router-link-active":w.value},to:ee(o).link,"aria-label":u.value},P.$attrs),{default:Oe(()=>[Pe(P.$slots,"before"),Nr(" "+Ae(ee(o).text)+" ",1),Pe(P.$slots,"after")]),_:3},16,["class","to","aria-label"])):(B(),Q("a",po({key:1,class:"external-link",href:ee(o).link,rel:d.value,target:c.value,"aria-label":u.value},P.$attrs),[Pe(P.$slots,"before"),Nr(" "+Ae(ee(o).text)+" ",1),i.value?(B(),je(y,{key:0})):ke("v-if",!0),Pe(P.$slots,"after")],16,Nm))}}}),br=_e(Dm,[["__file","AutoLink.vue"]]),Fm={class:"hero"},Bm={key:0,id:"main-title"},Um={key:1,class:"description"},Hm={key:2,class:"actions"},Wm=ue({__name:"HomeHero",setup(e){const r=gr(),n=Do(),a=$o(),o=M(()=>a.value&&r.value.heroImageDark!==void 0?r.value.heroImageDark:r.value.heroImage),t=M(()=>r.value.heroAlt||c.value||"hero"),s=M(()=>r.value.heroHeight||280),c=M(()=>r.value.heroText===null?null:r.value.heroText||n.value.title||"Hello"),i=M(()=>r.value.tagline===null?null:r.value.tagline||n.value.description||"Welcome to your VuePress site"),l=M(()=>X(r.value.actions)?r.value.actions.map(({text:u,link:m,type:f="primary"})=>({text:u,link:m,type:f})):[]),d=()=>{if(!o.value)return null;const u=le("img",{src:Bo(o.value),alt:t.value,height:s.value});return r.value.heroImageDark===void 0?u:le(Fo,()=>u)};return(u,m)=>(B(),Q("header",Fm,[ne(d),c.value?(B(),Q("h1",Bm,Ae(c.value),1)):ke("v-if",!0),i.value?(B(),Q("p",Um,Ae(i.value),1)):ke("v-if",!0),l.value.length?(B(),Q("p",Hm,[(B(!0),Q(Se,null,Rr(l.value,f=>(B(),je(br,{key:f.text,class:Je(["action-button",[f.type]]),item:f},null,8,["class","item"]))),128))])):ke("v-if",!0)]))}}),Vm=_e(Wm,[["__file","HomeHero.vue"]]),Jm={class:"home"},$m=ue({__name:"Home",setup(e){return(r,n)=>(B(),Q("main",Jm,[ne(Vm),ne(Am),ne(Tm),ne(Om)]))}}),Gm=_e($m,[["__file","Home.vue"]]),Ym=ue({__name:"NavbarBrand",setup(e){const r=yn(),n=Do(),a=Ue(),o=$o(),t=M(()=>a.value.home||r.value),s=M(()=>n.value.title),c=M(()=>o.value&&a.value.logoDark!==void 0?a.value.logoDark:a.value.logo),i=()=>{if(!c.value)return null;const l=le("img",{class:"logo",src:Bo(c.value),alt:s.value});return a.value.logoDark===void 0?l:le(Fo,()=>l)};return(l,d)=>{const u=yr("RouterLink");return B(),je(u,{to:t.value},{default:Oe(()=>[ne(i),s.value?(B(),Q("span",{key:0,class:Je(["site-name",{"can-hide":c.value}])},Ae(s.value),3)):ke("v-if",!0)]),_:1},8,["to"])}}}),Zm=_e(Ym,[["__file","NavbarBrand.vue"]]),Xm=ue({__name:"DropdownTransition",setup(e){const r=a=>{a.style.height=a.scrollHeight+"px"},n=a=>{a.style.height=""};return(a,o)=>(B(),je($n,{name:"dropdown",onEnter:r,onAfterEnter:n,onBeforeLeave:r},{default:Oe(()=>[Pe(a.$slots,"default")]),_:3}))}}),ec=_e(Xm,[["__file","DropdownTransition.vue"]]),Km=["aria-label"],Qm={class:"title"},eh=he("span",{class:"arrow down"},null,-1),rh=["aria-label"],nh={class:"title"},ah={class:"navbar-dropdown"},oh={class:"navbar-dropdown-subtitle"},th={key:1},sh={class:"navbar-dropdown-subitem-wrapper"},ih=ue({__name:"NavbarDropdown",props:{item:{type:Object,required:!0}},setup(e){const r=e,{item:n}=Ta(r),a=M(()=>n.value.ariaLabel||n.value.text),o=ge(!1),t=Kr();tr(()=>t.path,()=>{o.value=!1});const s=i=>{i.detail===0?o.value=!o.value:o.value=!1},c=(i,l)=>l[l.length-1]===i;return(i,l)=>(B(),Q("div",{class:Je(["navbar-dropdown-wrapper",{open:o.value}])},[he("button",{class:"navbar-dropdown-title",type:"button","aria-label":a.value,onClick:s},[he("span",Qm,Ae(ee(n).text),1),eh],8,Km),he("button",{class:"navbar-dropdown-title-mobile",type:"button","aria-label":a.value,onClick:l[0]||(l[0]=d=>o.value=!o.value)},[he("span",nh,Ae(ee(n).text),1),he("span",{class:Je(["arrow",o.value?"down":"right"])},null,2)],8,rh),ne(ec,null,{default:Oe(()=>[fa(he("ul",ah,[(B(!0),Q(Se,null,Rr(ee(n).children,d=>(B(),Q("li",{key:d.text,class:"navbar-dropdown-item"},[d.children?(B(),Q(Se,{key:0},[he("h4",oh,[d.link?(B(),je(br,{key:0,item:d,onFocusout:u=>c(d,ee(n).children)&&d.children.length===0&&(o.value=!1)},null,8,["item","onFocusout"])):(B(),Q("span",th,Ae(d.text),1))]),he("ul",sh,[(B(!0),Q(Se,null,Rr(d.children,u=>(B(),Q("li",{key:u.link,class:"navbar-dropdown-subitem"},[ne(br,{item:u,onFocusout:m=>c(u,d.children)&&c(d,ee(n).children)&&(o.value=!1)},null,8,["item","onFocusout"])]))),128))])],64)):(B(),je(br,{key:1,item:d,onFocusout:u=>c(d,ee(n).children)&&(o.value=!1)},null,8,["item","onFocusout"]))]))),128))],512),[[wa,o.value]])]),_:1})],2))}}),ch=_e(ih,[["__file","NavbarDropdown.vue"]]),ms=e=>decodeURI(e).replace(/#.*$/,"").replace(/(index)?\.(md|html)$/,""),lh=(e,r)=>{if(r.hash===e)return!0;const n=ms(r.path),a=ms(e);return n===a},rc=(e,r)=>e.link&&lh(e.link,r)?!0:e.children?e.children.some(n=>rc(n,r)):!1,nc=e=>!Gn(e)||/github\.com/.test(e)?"GitHub":/bitbucket\.org/.test(e)?"Bitbucket":/gitlab\.com/.test(e)?"GitLab":/gitee\.com/.test(e)?"Gitee":null,dh={GitHub:":repo/edit/:branch/:path",GitLab:":repo/-/edit/:branch/:path",Gitee:":repo/edit/:branch/:path",Bitbucket:":repo/src/:branch/:path?mode=edit&spa=0&at=:branch&fileviewer=file-view-default"},uh=({docsRepo:e,editLinkPattern:r})=>{if(r)return r;const n=nc(e);return n!==null?dh[n]:null},ph=({docsRepo:e,docsBranch:r,docsDir:n,filePathRelative:a,editLinkPattern:o})=>{if(!a)return null;const t=uh({docsRepo:e,editLinkPattern:o});return t?t.replace(/:repo/,Gn(e)?e:`https://github.com/${e}`).replace(/:branch/,r).replace(/:path/,yi(`${vi(n)}/${a}`)):null},mh={key:0,class:"navbar-items"},hh=ue({__name:"NavbarItems",setup(e){const r=()=>{const d=Xr(),u=yn(),m=Ei(),f=Do(),w=hm(),P=Ue();return M(()=>{const q=Object.keys(m.value.locales);if(q.length<2)return[];const b=d.currentRoute.value.path,y=d.currentRoute.value.fullPath;return[{text:`${P.value.selectLanguageText}`,ariaLabel:`${P.value.selectLanguageAriaLabel??P.value.selectLanguageText}`,children:q.map(j=>{var D,G;const V=((D=m.value.locales)==null?void 0:D[j])??{},K=((G=w.value.locales)==null?void 0:G[j])??{},R=`${V.lang}`,g=K.selectLanguageName??R;let H;if(R===f.value.lang)H=y;else{const k=b.replace(u.value,j);d.getRoutes().some(I=>I.path===k)?H=y.replace(b,k):H=K.home??j}return{text:g,link:H}})}]})},n=()=>{const d=Ue(),u=M(()=>d.value.repo),m=M(()=>u.value?nc(u.value):null),f=M(()=>u.value&&!Gn(u.value)?`https://github.com/${u.value}`:u.value),w=M(()=>f.value?d.value.repoLabel?d.value.repoLabel:m.value===null?"Source":m.value:null);return M(()=>!f.value||!w.value?[]:[{text:w.value,link:f.value}])},a=d=>be(d)?Go(d):d.children?{...d,children:d.children.map(a)}:d,o=()=>{const d=Ue();return M(()=>(d.value.navbar||[]).map(a))},t=ge(!1),s=o(),c=r(),i=n(),l=M(()=>[...s.value,...c.value,...i.value]);return Qi(Dn.MOBILE,d=>{window.innerWidth<d?t.value=!0:t.value=!1}),(d,u)=>l.value.length?(B(),Q("nav",mh,[(B(!0),Q(Se,null,Rr(l.value,m=>(B(),Q("div",{key:m.text,class:"navbar-item"},[m.children?(B(),je(ch,{key:0,item:m,class:Je(t.value?"mobile":"")},null,8,["item","class"])):(B(),je(br,{key:1,item:m},null,8,["item"]))]))),128))])):ke("v-if",!0)}}),ac=_e(hh,[["__file","NavbarItems.vue"]]),fh=["title"],gh={class:"icon",focusable:"false",viewBox:"0 0 32 32"},bh=Zl('<path d="M16 12.005a4 4 0 1 1-4 4a4.005 4.005 0 0 1 4-4m0-2a6 6 0 1 0 6 6a6 6 0 0 0-6-6z" fill="currentColor"></path><path d="M5.394 6.813l1.414-1.415l3.506 3.506L8.9 10.318z" fill="currentColor"></path><path d="M2 15.005h5v2H2z" fill="currentColor"></path><path d="M5.394 25.197L8.9 21.691l1.414 1.415l-3.506 3.505z" fill="currentColor"></path><path d="M15 25.005h2v5h-2z" fill="currentColor"></path><path d="M21.687 23.106l1.414-1.415l3.506 3.506l-1.414 1.414z" fill="currentColor"></path><path d="M25 15.005h5v2h-5z" fill="currentColor"></path><path d="M21.687 8.904l3.506-3.506l1.414 1.415l-3.506 3.505z" fill="currentColor"></path><path d="M15 2.005h2v5h-2z" fill="currentColor"></path>',9),vh=[bh],yh={class:"icon",focusable:"false",viewBox:"0 0 32 32"},wh=he("path",{d:"M13.502 5.414a15.075 15.075 0 0 0 11.594 18.194a11.113 11.113 0 0 1-7.975 3.39c-.138 0-.278.005-.418 0a11.094 11.094 0 0 1-3.2-21.584M14.98 3a1.002 1.002 0 0 0-.175.016a13.096 13.096 0 0 0 1.825 25.981c.164.006.328 0 .49 0a13.072 13.072 0 0 0 10.703-5.555a1.01 1.01 0 0 0-.783-1.565A13.08 13.08 0 0 1 15.89 4.38A1.015 1.015 0 0 0 14.98 3z",fill:"currentColor"},null,-1),Ph=[wh],Sh=ue({__name:"ToggleColorModeButton",setup(e){const r=Ue(),n=$o(),a=()=>{n.value=!n.value};return(o,t)=>(B(),Q("button",{class:"toggle-color-mode-button",title:ee(r).toggleColorMode,onClick:a},[fa((B(),Q("svg",gh,vh,512)),[[wa,!ee(n)]]),fa((B(),Q("svg",yh,Ph,512)),[[wa,ee(n)]])],8,fh))}}),qh=_e(Sh,[["__file","ToggleColorModeButton.vue"]]),xh=["title"],_h=he("div",{class:"icon","aria-hidden":"true"},[he("span"),he("span"),he("span")],-1),kh=[_h],Eh=ue({__name:"ToggleSidebarButton",emits:["toggle"],setup(e){const r=Ue();return(n,a)=>(B(),Q("div",{class:"toggle-sidebar-button",title:ee(r).toggleSidebar,"aria-expanded":"false",role:"button",tabindex:"0",onClick:a[0]||(a[0]=o=>n.$emit("toggle"))},kh,8,xh))}}),jh=_e(Eh,[["__file","ToggleSidebarButton.vue"]]),Th=ue({__name:"Navbar",emits:["toggle-sidebar"],setup(e){const r=Ue(),n=ge(null),a=ge(null),o=ge(0),t=M(()=>o.value?{maxWidth:o.value+"px"}:{});Qi(Dn.MOBILE,c=>{var l;const i=s(n.value,"paddingLeft")+s(n.value,"paddingRight");window.innerWidth<c?o.value=0:o.value=n.value.offsetWidth-i-(((l=a.value)==null?void 0:l.offsetWidth)||0)});function s(c,i){var u,m,f;const l=(f=(m=(u=c==null?void 0:c.ownerDocument)==null?void 0:u.defaultView)==null?void 0:m.getComputedStyle(c,null))==null?void 0:f[i],d=Number.parseInt(l,10);return Number.isNaN(d)?0:d}return(c,i)=>{const l=yr("NavbarSearch");return B(),Q("header",{ref_key:"navbar",ref:n,class:"navbar"},[ne(jh,{onToggle:i[0]||(i[0]=d=>c.$emit("toggle-sidebar"))}),he("span",{ref_key:"navbarBrand",ref:a},[ne(Zm)],512),he("div",{class:"navbar-items-wrapper",style:Bn(t.value)},[Pe(c.$slots,"before"),ne(ac,{class:"can-hide"}),Pe(c.$slots,"after"),ee(r).colorModeSwitch?(B(),je(qh,{key:0})):ke("v-if",!0),ne(l)],4)],512)}}}),Ch=_e(Th,[["__file","Navbar.vue"]]),zh={class:"page-meta"},Ah={key:0,class:"meta-item edit-link"},Ih={key:1,class:"meta-item last-updated"},Lh={class:"meta-item-label"},Rh={class:"meta-item-info"},Oh={key:2,class:"meta-item contributors"},Nh={class:"meta-item-label"},Mh={class:"meta-item-info"},Dh=["title"],Fh=ue({__name:"PageMeta",setup(e){const r=()=>{const i=Ue(),l=Ir(),d=gr();return M(()=>{if(!(d.value.editLink??i.value.editLink??!0))return null;const{repo:m,docsRepo:f=m,docsBranch:w="main",docsDir:P="",editLinkText:q}=i.value;if(!f)return null;const b=ph({docsRepo:f,docsBranch:w,docsDir:P,filePathRelative:l.value.filePathRelative,editLinkPattern:d.value.editLinkPattern??i.value.editLinkPattern});return b?{text:q??"Edit this page",link:b}:null})},n=()=>{const i=Ue(),l=Ir(),d=gr();return M(()=>{var f,w;return!(d.value.lastUpdated??i.value.lastUpdated??!0)||!((f=l.value.git)!=null&&f.updatedTime)?null:new Date((w=l.value.git)==null?void 0:w.updatedTime).toLocaleString()})},a=()=>{const i=Ue(),l=Ir(),d=gr();return M(()=>{var m;return d.value.contributors??i.value.contributors??!0?((m=l.value.git)==null?void 0:m.contributors)??null:null})},o=Ue(),t=r(),s=n(),c=a();return(i,l)=>{const d=yr("ClientOnly");return B(),Q("footer",zh,[ee(t)?(B(),Q("div",Ah,[ne(br,{class:"meta-item-label",item:ee(t)},null,8,["item"])])):ke("v-if",!0),ee(s)?(B(),Q("div",Ih,[he("span",Lh,Ae(ee(o).lastUpdatedText)+": ",1),ne(d,null,{default:Oe(()=>[he("span",Rh,Ae(ee(s)),1)]),_:1})])):ke("v-if",!0),ee(c)&&ee(c).length?(B(),Q("div",Oh,[he("span",Nh,Ae(ee(o).contributorsText)+": ",1),he("span",Mh,[(B(!0),Q(Se,null,Rr(ee(c),(u,m)=>(B(),Q(Se,{key:m},[he("span",{class:"contributor",title:`email: ${u.email}`},Ae(u.name),9,Dh),m!==ee(c).length-1?(B(),Q(Se,{key:0},[Nr(", ")],64)):ke("v-if",!0)],64))),128))])])):ke("v-if",!0)])}}}),Bh=_e(Fh,[["__file","PageMeta.vue"]]),Uh={key:0,class:"page-nav"},Hh={class:"inner"},Wh={key:0,class:"prev"},Vh={key:1,class:"next"},Jh=ue({__name:"PageNav",setup(e){const r=i=>i===!1?null:be(i)?Go(i):No(i)?i:!1,n=(i,l,d)=>{const u=i.findIndex(m=>m.link===l);if(u!==-1){const m=i[u+d];return m!=null&&m.link?m:null}for(const m of i)if(m.children){const f=n(m.children,l,d);if(f)return f}return null},a=gr(),o=Yo(),t=Kr(),s=M(()=>{const i=r(a.value.prev);return i!==!1?i:n(o.value,t.path,-1)}),c=M(()=>{const i=r(a.value.next);return i!==!1?i:n(o.value,t.path,1)});return(i,l)=>s.value||c.value?(B(),Q("nav",Uh,[he("p",Hh,[s.value?(B(),Q("span",Wh,[ne(br,{item:s.value},null,8,["item"])])):ke("v-if",!0),c.value?(B(),Q("span",Vh,[ne(br,{item:c.value},null,8,["item"])])):ke("v-if",!0)])])):ke("v-if",!0)}}),$h=_e(Jh,[["__file","PageNav.vue"]]),Gh={class:"page"},Yh={class:"theme-default-content"},Zh=ue({__name:"Page",setup(e){return(r,n)=>{const a=yr("Content");return B(),Q("main",Gh,[Pe(r.$slots,"top"),he("div",Yh,[Pe(r.$slots,"content-top"),ne(a),Pe(r.$slots,"content-bottom")]),ne(Bh),ne($h),Pe(r.$slots,"bottom")])}}}),Xh=_e(Zh,[["__file","Page.vue"]]),Kh=["onKeydown"],Qh={class:"sidebar-item-children"},ef=ue({__name:"SidebarItem",props:{item:{type:Object,required:!0},depth:{type:Number,required:!1,default:0}},setup(e){const r=e,{item:n,depth:a}=Ta(r),o=Kr(),t=Xr(),s=M(()=>rc(n.value,o)),c=M(()=>({"sidebar-item":!0,"sidebar-heading":a.value===0,active:s.value,collapsible:n.value.collapsible})),i=M(()=>n.value.collapsible?s.value:!0),[l,d]=Bp(i.value),u=f=>{n.value.collapsible&&(f.preventDefault(),d())},m=t.afterEach(f=>{Wn(()=>{l.value=i.value})});return Jn(()=>{m()}),(f,w)=>{var q;const P=yr("SidebarItem",!0);return B(),Q("li",null,[ee(n).link?(B(),je(br,{key:0,class:Je(c.value),item:ee(n)},null,8,["class","item"])):(B(),Q("p",{key:1,tabindex:"0",class:Je(c.value),onClick:u,onKeydown:Ad(u,["enter"])},[Nr(Ae(ee(n).text)+" ",1),ee(n).collapsible?(B(),Q("span",{key:0,class:Je(["arrow",ee(l)?"down":"right"])},null,2)):ke("v-if",!0)],42,Kh)),(q=ee(n).children)!=null&&q.length?(B(),je(ec,{key:2},{default:Oe(()=>[fa(he("ul",Qh,[(B(!0),Q(Se,null,Rr(ee(n).children,b=>(B(),je(P,{key:`${ee(a)}${b.text}${b.link}`,item:b,depth:ee(a)+1},null,8,["item","depth"]))),128))],512),[[wa,ee(l)]])]),_:1})):ke("v-if",!0)])}}}),rf=_e(ef,[["__file","SidebarItem.vue"]]),nf={key:0,class:"sidebar-items"},af=ue({__name:"SidebarItems",setup(e){const r=Kr(),n=Yo();return He(()=>{tr(()=>r.hash,a=>{const o=document.querySelector(".sidebar");if(!o)return;const t=document.querySelector(`.sidebar a.sidebar-item[href="${r.path}${a}"]`);if(!t)return;const{top:s,height:c}=o.getBoundingClientRect(),{top:i,height:l}=t.getBoundingClientRect();i<s?t.scrollIntoView(!0):i+l>s+c&&t.scrollIntoView(!1)})}),(a,o)=>ee(n).length?(B(),Q("ul",nf,[(B(!0),Q(Se,null,Rr(ee(n),t=>(B(),je(rf,{key:`${t.text}${t.link}`,item:t},null,8,["item"]))),128))])):ke("v-if",!0)}}),of=_e(af,[["__file","SidebarItems.vue"]]),tf={class:"sidebar"},sf=ue({__name:"Sidebar",setup(e){return(r,n)=>(B(),Q("aside",tf,[ne(ac),Pe(r.$slots,"top"),ne(of),Pe(r.$slots,"bottom")]))}}),cf=_e(sf,[["__file","Sidebar.vue"]]),lf=ue({__name:"Layout",setup(e){const r=Ir(),n=gr(),a=Ue(),o=M(()=>n.value.navbar!==!1&&a.value.navbar!==!1),t=Yo(),s=ge(!1),c=q=>{s.value=typeof q=="boolean"?q:!s.value},i={x:0,y:0},l=q=>{i.x=q.changedTouches[0].clientX,i.y=q.changedTouches[0].clientY},d=q=>{const b=q.changedTouches[0].clientX-i.x,y=q.changedTouches[0].clientY-i.y;Math.abs(b)>Math.abs(y)&&Math.abs(b)>40&&(b>0&&i.x<=80?c(!0):c(!1))},u=M(()=>[{"no-navbar":!o.value,"no-sidebar":!t.value.length,"sidebar-open":s.value},n.value.pageClass]);let m;He(()=>{m=Xr().afterEach(()=>{c(!1)})}),Ia(()=>{m()});const f=Zi(),w=f.resolve,P=f.pending;return(q,b)=>(B(),Q("div",{class:Je(["theme-container",u.value]),onTouchstart:l,onTouchend:d},[Pe(q.$slots,"navbar",{},()=>[o.value?(B(),je(Ch,{key:0,onToggleSidebar:c},{before:Oe(()=>[Pe(q.$slots,"navbar-before")]),after:Oe(()=>[Pe(q.$slots,"navbar-after")]),_:3})):ke("v-if",!0)]),he("div",{class:"sidebar-mask",onClick:b[0]||(b[0]=y=>c(!1))}),Pe(q.$slots,"sidebar",{},()=>[ne(cf,null,{top:Oe(()=>[Pe(q.$slots,"sidebar-top")]),bottom:Oe(()=>[Pe(q.$slots,"sidebar-bottom")]),_:3})]),Pe(q.$slots,"page",{},()=>[ee(n).home?(B(),je(Gm,{key:0})):(B(),je($n,{key:1,name:"fade-slide-y",mode:"out-in",onBeforeEnter:ee(w),onBeforeLeave:ee(P)},{default:Oe(()=>[(B(),je(Xh,{key:ee(r).path},{top:Oe(()=>[Pe(q.$slots,"page-top")]),"content-top":Oe(()=>[Pe(q.$slots,"page-content-top")]),"content-bottom":Oe(()=>[Pe(q.$slots,"page-content-bottom")]),bottom:Oe(()=>[Pe(q.$slots,"page-bottom")]),_:3}))]),_:3},8,["onBeforeEnter","onBeforeLeave"]))])],34))}}),df=_e(lf,[["__file","Layout.vue"]]),uf={class:"theme-container"},pf={class:"page"},mf={class:"theme-default-content"},hf=he("h1",null,"404",-1),ff=ue({__name:"NotFound",setup(e){const r=yn(),n=Ue(),a=n.value.notFound??["Not Found"],o=()=>a[Math.floor(Math.random()*a.length)],t=n.value.home??r.value,s=n.value.backToHome??"Back to home";return(c,i)=>{const l=yr("RouterLink");return B(),Q("div",uf,[he("main",pf,[he("div",mf,[hf,he("blockquote",null,Ae(o()),1),ne(l,{to:ee(t)},{default:Oe(()=>[Nr(Ae(ee(s)),1)]),_:1},8,["to"])])])])}}}),gf=_e(ff,[["__file","NotFound.vue"]]);const bf=Pr({enhance({app:e,router:r}){e.component("Badge",xp),e.component("CodeGroup",_p),e.component("CodeGroupItem",Tp),e.component("AutoLinkExternalIcon",()=>{const a=e.component("ExternalLinkIcon");return a?le(a):null}),e.component("NavbarSearch",()=>{const a=e.component("Docsearch")||e.component("SearchBox");return a?le(a):null});const n=r.options.scrollBehavior;r.options.scrollBehavior=async(...a)=>(await Zi().wait(),n(...a))},setup(){fm(),vm()},layouts:{Layout:df,NotFound:gf}}),vf={enhance:({app:e})=>{e.component("CCLicense-component",re(()=>z(()=>import("./CCLicense-component-4c685eb5.js"),[]))),e.component("DocumentCover-component",re(()=>z(()=>import("./DocumentCover-component-a28468e4.js"),[]))),e.component("DownloadPDF-component",re(()=>z(()=>import("./DownloadPDF-component-c90422f8.js"),[])))}};/*! medium-zoom 1.0.8 | MIT License | https://github.com/francoischalifour/medium-zoom */var Ur=Object.assign||function(e){for(var r=1;r<arguments.length;r++){var n=arguments[r];for(var a in n)Object.prototype.hasOwnProperty.call(n,a)&&(e[a]=n[a])}return e},sa=function(r){return r.tagName==="IMG"},yf=function(r){return NodeList.prototype.isPrototypeOf(r)},la=function(r){return r&&r.nodeType===1},hs=function(r){var n=r.currentSrc||r.src;return n.substr(-4).toLowerCase()===".svg"},fs=function(r){try{return Array.isArray(r)?r.filter(sa):yf(r)?[].slice.call(r).filter(sa):la(r)?[r].filter(sa):typeof r=="string"?[].slice.call(document.querySelectorAll(r)).filter(sa):[]}catch{throw new TypeError(`The provided selector is invalid.
Expects a CSS selector, a Node element, a NodeList or an array.
See: https://github.com/francoischalifour/medium-zoom`)}},wf=function(r){var n=document.createElement("div");return n.classList.add("medium-zoom-overlay"),n.style.background=r,n},Pf=function(r){var n=r.getBoundingClientRect(),a=n.top,o=n.left,t=n.width,s=n.height,c=r.cloneNode(),i=window.pageYOffset||document.documentElement.scrollTop||document.body.scrollTop||0,l=window.pageXOffset||document.documentElement.scrollLeft||document.body.scrollLeft||0;return c.removeAttribute("id"),c.style.position="absolute",c.style.top=a+i+"px",c.style.left=o+l+"px",c.style.width=t+"px",c.style.height=s+"px",c.style.transform="",c},rn=function(r,n){var a=Ur({bubbles:!1,cancelable:!1,detail:void 0},n);if(typeof window.CustomEvent=="function")return new CustomEvent(r,a);var o=document.createEvent("CustomEvent");return o.initCustomEvent(r,a.bubbles,a.cancelable,a.detail),o},Sf=function e(r){var n=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},a=window.Promise||function(k){function I(){}k(I,I)},o=function(k){var I=k.target;if(I===H){w();return}T.indexOf(I)!==-1&&P({target:I})},t=function(){if(!(V||!g.original)){var k=window.pageYOffset||document.documentElement.scrollTop||document.body.scrollTop||0;Math.abs(K-k)>R.scrollOffset&&setTimeout(w,150)}},s=function(k){var I=k.key||k.keyCode;(I==="Escape"||I==="Esc"||I===27)&&w()},c=function(){var k=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{},I=k;if(k.background&&(H.style.background=k.background),k.container&&k.container instanceof Object&&(I.container=Ur({},R.container,k.container)),k.template){var L=la(k.template)?k.template:document.querySelector(k.template);I.template=L}return R=Ur({},R,I),T.forEach(function(ie){ie.dispatchEvent(rn("medium-zoom:update",{detail:{zoom:D}}))}),D},i=function(){var k=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};return e(Ur({},R,k))},l=function(){for(var k=arguments.length,I=Array(k),L=0;L<k;L++)I[L]=arguments[L];var ie=I.reduce(function(W,oe){return[].concat(W,fs(oe))},[]);return ie.filter(function(W){return T.indexOf(W)===-1}).forEach(function(W){T.push(W),W.classList.add("medium-zoom-image")}),j.forEach(function(W){var oe=W.type,te=W.listener,Me=W.options;ie.forEach(function(Re){Re.addEventListener(oe,te,Me)})}),D},d=function(){for(var k=arguments.length,I=Array(k),L=0;L<k;L++)I[L]=arguments[L];g.zoomed&&w();var ie=I.length>0?I.reduce(function(W,oe){return[].concat(W,fs(oe))},[]):T;return ie.forEach(function(W){W.classList.remove("medium-zoom-image"),W.dispatchEvent(rn("medium-zoom:detach",{detail:{zoom:D}}))}),T=T.filter(function(W){return ie.indexOf(W)===-1}),D},u=function(k,I){var L=arguments.length>2&&arguments[2]!==void 0?arguments[2]:{};return T.forEach(function(ie){ie.addEventListener("medium-zoom:"+k,I,L)}),j.push({type:"medium-zoom:"+k,listener:I,options:L}),D},m=function(k,I){var L=arguments.length>2&&arguments[2]!==void 0?arguments[2]:{};return T.forEach(function(ie){ie.removeEventListener("medium-zoom:"+k,I,L)}),j=j.filter(function(ie){return!(ie.type==="medium-zoom:"+k&&ie.listener.toString()===I.toString())}),D},f=function(){var k=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{},I=k.target,L=function(){var W={width:document.documentElement.clientWidth,height:document.documentElement.clientHeight,left:0,top:0,right:0,bottom:0},oe=void 0,te=void 0;if(R.container)if(R.container instanceof Object)W=Ur({},W,R.container),oe=W.width-W.left-W.right-R.margin*2,te=W.height-W.top-W.bottom-R.margin*2;else{var Me=la(R.container)?R.container:document.querySelector(R.container),Re=Me.getBoundingClientRect(),We=Re.width,De=Re.height,Sr=Re.left,qr=Re.top;W=Ur({},W,{width:We,height:De,left:Sr,top:qr})}oe=oe||W.width-R.margin*2,te=te||W.height-R.margin*2;var ir=g.zoomedHd||g.original,Ie=hs(ir)?oe:ir.naturalWidth||oe,x=hs(ir)?te:ir.naturalHeight||te,U=ir.getBoundingClientRect(),O=U.top,$=U.left,de=U.width,p=U.height,h=Math.min(Math.max(de,Ie),oe)/de,v=Math.min(Math.max(p,x),te)/p,S=Math.min(h,v),_=(-$+(oe-de)/2+R.margin+W.left)/S,E=(-O+(te-p)/2+R.margin+W.top)/S,F="scale("+S+") translate3d("+_+"px, "+E+"px, 0)";g.zoomed.style.transform=F,g.zoomedHd&&(g.zoomedHd.style.transform=F)};return new a(function(ie){if(I&&T.indexOf(I)===-1){ie(D);return}var W=function We(){V=!1,g.zoomed.removeEventListener("transitionend",We),g.original.dispatchEvent(rn("medium-zoom:opened",{detail:{zoom:D}})),ie(D)};if(g.zoomed){ie(D);return}if(I)g.original=I;else if(T.length>0){var oe=T;g.original=oe[0]}else{ie(D);return}if(g.original.dispatchEvent(rn("medium-zoom:open",{detail:{zoom:D}})),K=window.pageYOffset||document.documentElement.scrollTop||document.body.scrollTop||0,V=!0,g.zoomed=Pf(g.original),document.body.appendChild(H),R.template){var te=la(R.template)?R.template:document.querySelector(R.template);g.template=document.createElement("div"),g.template.appendChild(te.content.cloneNode(!0)),document.body.appendChild(g.template)}if(g.original.parentElement&&g.original.parentElement.tagName==="PICTURE"&&g.original.currentSrc&&(g.zoomed.src=g.original.currentSrc),document.body.appendChild(g.zoomed),window.requestAnimationFrame(function(){document.body.classList.add("medium-zoom--opened")}),g.original.classList.add("medium-zoom-image--hidden"),g.zoomed.classList.add("medium-zoom-image--opened"),g.zoomed.addEventListener("click",w),g.zoomed.addEventListener("transitionend",W),g.original.getAttribute("data-zoom-src")){g.zoomedHd=g.zoomed.cloneNode(),g.zoomedHd.removeAttribute("srcset"),g.zoomedHd.removeAttribute("sizes"),g.zoomedHd.removeAttribute("loading"),g.zoomedHd.src=g.zoomed.getAttribute("data-zoom-src"),g.zoomedHd.onerror=function(){clearInterval(Me),console.warn("Unable to reach the zoom image target "+g.zoomedHd.src),g.zoomedHd=null,L()};var Me=setInterval(function(){g.zoomedHd.complete&&(clearInterval(Me),g.zoomedHd.classList.add("medium-zoom-image--opened"),g.zoomedHd.addEventListener("click",w),document.body.appendChild(g.zoomedHd),L())},10)}else if(g.original.hasAttribute("srcset")){g.zoomedHd=g.zoomed.cloneNode(),g.zoomedHd.removeAttribute("sizes"),g.zoomedHd.removeAttribute("loading");var Re=g.zoomedHd.addEventListener("load",function(){g.zoomedHd.removeEventListener("load",Re),g.zoomedHd.classList.add("medium-zoom-image--opened"),g.zoomedHd.addEventListener("click",w),document.body.appendChild(g.zoomedHd),L()})}else L()})},w=function(){return new a(function(k){if(V||!g.original){k(D);return}var I=function L(){g.original.classList.remove("medium-zoom-image--hidden"),document.body.removeChild(g.zoomed),g.zoomedHd&&document.body.removeChild(g.zoomedHd),document.body.removeChild(H),g.zoomed.classList.remove("medium-zoom-image--opened"),g.template&&document.body.removeChild(g.template),V=!1,g.zoomed.removeEventListener("transitionend",L),g.original.dispatchEvent(rn("medium-zoom:closed",{detail:{zoom:D}})),g.original=null,g.zoomed=null,g.zoomedHd=null,g.template=null,k(D)};V=!0,document.body.classList.remove("medium-zoom--opened"),g.zoomed.style.transform="",g.zoomedHd&&(g.zoomedHd.style.transform=""),g.template&&(g.template.style.transition="opacity 150ms",g.template.style.opacity=0),g.original.dispatchEvent(rn("medium-zoom:close",{detail:{zoom:D}})),g.zoomed.addEventListener("transitionend",I)})},P=function(){var k=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{},I=k.target;return g.original?w():f({target:I})},q=function(){return R},b=function(){return T},y=function(){return g.original},T=[],j=[],V=!1,K=0,R=n,g={original:null,zoomed:null,zoomedHd:null,template:null};Object.prototype.toString.call(r)==="[object Object]"?R=r:(r||typeof r=="string")&&l(r),R=Ur({margin:0,background:"#fff",scrollOffset:40,container:null,template:null},R);var H=wf(R.background);document.addEventListener("click",o),document.addEventListener("keyup",s),document.addEventListener("scroll",t),window.addEventListener("resize",w);var D={open:f,close:w,toggle:P,update:c,clone:i,attach:l,detach:d,on:u,off:m,getOptions:q,getImages:b,getZoomedImage:y};return D};function qf(e,r){r===void 0&&(r={});var n=r.insertAt;if(!(!e||typeof document>"u")){var a=document.head||document.getElementsByTagName("head")[0],o=document.createElement("style");o.type="text/css",n==="top"&&a.firstChild?a.insertBefore(o,a.firstChild):a.appendChild(o),o.styleSheet?o.styleSheet.cssText=e:o.appendChild(document.createTextNode(e))}}var xf=".medium-zoom-overlay{position:fixed;top:0;right:0;bottom:0;left:0;opacity:0;transition:opacity .3s;will-change:opacity}.medium-zoom--opened .medium-zoom-overlay{cursor:pointer;cursor:zoom-out;opacity:1}.medium-zoom-image{cursor:pointer;cursor:zoom-in;transition:transform .3s cubic-bezier(.2,0,.2,1)!important}.medium-zoom-image--hidden{visibility:hidden}.medium-zoom-image--opened{position:relative;cursor:pointer;cursor:zoom-out;will-change:transform}";qf(xf);const _f=Sf,kf=Symbol("mediumZoom");const Ef=":not(a) > img",jf={},Tf=500,Cf=Pr({enhance({app:e,router:r}){const n=_f(jf);n.refresh=(a=Ef)=>{n.detach(),n.attach(a)},e.provide(kf,n),r.afterEach(()=>{setTimeout(()=>n.refresh(),Tf)})}}),zf=e=>e instanceof Element?document.activeElement===e&&(["TEXTAREA","SELECT","INPUT"].includes(e.tagName)||e.hasAttribute("contenteditable")):!1,Af=(e,r)=>r.some(n=>{if(be(n))return n===e.key;const{key:a,ctrl:o=!1,shift:t=!1,alt:s=!1}=n;return a===e.key&&o===e.ctrlKey&&t===e.shiftKey&&s===e.altKey}),If=/[^\x00-\x7F]/,Lf=e=>e.split(/\s+/g).map(r=>r.trim()).filter(r=>!!r),gs=e=>e.replace(/[-/\\^$*+?.()|[\]{}]/g,"\\$&"),bs=(e,r)=>{const n=r.join(" "),a=Lf(e);if(If.test(e))return a.some(s=>n.toLowerCase().indexOf(s)>-1);const o=e.endsWith(" ");return new RegExp(a.map((s,c)=>a.length===c+1&&!o?`(?=.*\\b${gs(s)})`:`(?=.*\\b${gs(s)}\\b)`).join("")+".+","gi").test(n)},Rf=({input:e,hotKeys:r})=>{if(r.value.length===0)return;const n=a=>{e.value&&Af(a,r.value)&&!zf(a.target)&&(a.preventDefault(),e.value.focus())};He(()=>{document.addEventListener("keydown",n)}),Jn(()=>{document.removeEventListener("keydown",n)})},Of=[{title:"Installation notes",headers:[{level:2,title:"1. Arquitectura",slug:"_1-arquitectura",link:"#_1-arquitectura",children:[{level:3,title:"1.1 Entorno de desarrollo",slug:"_1-1-entorno-de-desarrollo",link:"#_1-1-entorno-de-desarrollo",children:[]},{level:3,title:"1.2 Entorno de pruebas",slug:"_1-2-entorno-de-pruebas",link:"#_1-2-entorno-de-pruebas",children:[]},{level:3,title:"1.3 Entorno de producción",slug:"_1-3-entorno-de-produccion",link:"#_1-3-entorno-de-produccion",children:[]}]},{level:2,title:"2. Instalación del entorno",slug:"_2-instalacion-del-entorno",link:"#_2-instalacion-del-entorno",children:[]},{level:2,title:"No hacer caso a partir de aquí...",slug:"no-hacer-caso-a-partir-de-aqui",link:"#no-hacer-caso-a-partir-de-aqui",children:[]}],path:"/InstallationNotes.html",pathLocale:"/",extraFields:[`---\r
...
<DownloadPDF-component />\r
\r
<DocumentCover-component titulo="1.1. Understanding Ethical Hacking & Penetration Testing" />\r
\r
# 1.1. Understanding Ethical Hacking & Penetration Testing\r
# 1.1. Comprendiendo el hacking ético y las pruebas de penetración\r
# 1.1. Comprendre el hacking ètic i les proves de penetració\r
...
<DownloadPDF-component />\r
\r
<DocumentCover-component titulo="1.2. Exploring Penetration Testing Methodologies" />\r
# 1.2. Exploring Penetration Testing Methodologies\r
\r
## 1.2.1. Overview\r
\r
...
\r
:::\r
`]},{title:"",headers:[],path:"/404.html",pathLocale:"/",extraFields:[""]}],Nf=ge(Of),Mf=()=>Nf,Df=({searchIndex:e,routeLocale:r,query:n,maxSuggestions:a})=>{const o=M(()=>e.value.filter(t=>t.pathLocale===r.value));return M(()=>{const t=n.value.trim().toLowerCase();if(!t)return[];const s=[],c=(i,l)=>{bs(t,[l.title])&&s.push({link:`${i.path}#${l.slug}`,title:i.title,header:l.title});for(const d of l.children){if(s.length>=a.value)return;c(i,d)}};for(const i of o.value){if(s.length>=a.value)break;if(bs(t,[i.title,...i.extraFields])){s.push({link:i.path,title:i.title});continue}for(const l of i.headers){if(s.length>=a.value)break;c(i,l)}}return s})},Ff=e=>{const r=ge(0);return{focusIndex:r,focusNext:()=>{r.value<e.value.length-1?r.value+=1:r.value=0},focusPrev:()=>{r.value>0?r.value-=1:r.value=e.value.length-1}}},Bf=ue({name:"SearchBox",props:{locales:{type:Object,required:!1,default:()=>({})},hotKeys:{type:Array,required:!1,default:()=>[]},maxSuggestions:{type:Number,required:!1,default:5}},setup(e){const{locales:r,hotKeys:n,maxSuggestions:a}=Ta(e),o=Xr(),t=yn(),s=Mf(),c=ge(null),i=ge(!1),l=ge(""),d=M(()=>r.value[t.value]??{}),u=Df({searchIndex:s,routeLocale:t,query:l,maxSuggestions:a}),{focusIndex:m,focusNext:f,focusPrev:w}=Ff(u);Rf({input:c,hotKeys:n});const P=M(()=>i.value&&!!u.value.length),q=()=>{P.value&&w()},b=()=>{P.value&&f()},y=T=>{if(!P.value)return;const j=u.value[T];j&&o.push(j.link).then(()=>{l.value="",m.value=0})};return()=>le("form",{class:"search-box",role:"search"},[le("input",{ref:c,type:"search",placeholder:d.value.placeholder,autocomplete:"off",spellcheck:!1,value:l.value,onFocus:()=>i.value=!0,onBlur:()=>i.value=!1,onInput:T=>l.value=T.target.value,onKeydown:T=>{switch(T.key){case"ArrowUp":{q();break}case"ArrowDown":{b();break}case"Enter":{T.preventDefault(),y(m.value);break}}}}),P.value&&le("ul",{class:"suggestions",onMouseleave:()=>m.value=-1},u.value.map(({link:T,title:j,header:V},K)=>le("li",{class:["suggestion",{focus:m.value===K}],onMouseenter:()=>m.value=K,onMousedown:()=>y(K)},le("a",{href:T,onClick:R=>R.preventDefault()},[le("span",{class:"page-title"},j),V&&le("span",{class:"page-header"},`> ${V}`)]))))])}});const Uf={"/en/":{placeholder:"Search"},"/es/":{placeholder:"Buscar"},"/ca/":{placeholder:"Cercar"}},Hf=["s","/"],Wf=5,Vf=Pr({enhance({app:e}){e.component("SearchBox",r=>le(Bf,{locales:Uf,hotKeys:Hf,maxSuggestions:Wf,...r}))}});const Jf={};function $f(){const e=ge(!1);return Ro()&&He(()=>{e.value=!0}),e}function Gf(e){return $f(),M(()=>!!e())}const Yf=()=>Gf(()=>typeof window<"u"&&window.navigator&&"userAgent"in window.navigator),Zf=()=>{const e=Yf();return M(()=>e.value&&/\b(?:Android|iPhone)/i.test(navigator.userAgent))},Xf=e=>{const r=yn();return M(()=>e[r.value])},Kf=250,Qf=3e3,eg={"/ca/":{copy:"Copia",copied:"Copiat",hint:"Copia bloc de codi"},"/es/":{copy:"Copia",copied:"Copiado",hint:"Copia bloque de código"},"/en/":{copy:"Copy",copied:"Copied",hint:"Copy code block"},"/":{copy:"Copia",copied:"Copiat",hint:"Copia bloc de codi"}},rg=!1,ng=['.theme-default-content div[class*="language-"] pre'],vs=!1,Qa=new Map,ag=()=>{const{copy:e}=am({legacy:!0}),r=Xf(eg),n=Ir(),a=Zf(),o=c=>{if(!c.hasAttribute("copy-code-registered")){const i=document.createElement("button");i.type="button",i.classList.add("copy-code-button"),i.innerHTML='<div class="copy-icon" />',i.setAttribute("aria-label",r.value.copy),i.setAttribute("data-copied",r.value.copied),c.parentElement&&c.parentElement.insertBefore(i,c),c.setAttribute("copy-code-registered","")}},t=()=>Wn().then(()=>new Promise(c=>{setTimeout(()=>{ng.forEach(i=>{document.querySelectorAll(i).forEach(o)}),c()},Kf)})),s=(c,i,l)=>{let{innerText:d=""}=i;/language-(shellscript|shell|bash|sh|zsh)/.test(c.classList.toString())&&(d=d.replace(/^ *(\$|>) /gm,"")),e(d).then(()=>{l.classList.add("copied"),clearTimeout(Qa.get(l));const u=setTimeout(()=>{l.classList.remove("copied"),l.blur(),Qa.delete(l)},Qf);Qa.set(l,u)})};He(()=>{(!a.value||vs)&&t(),xa("click",c=>{const i=c.target;if(i.matches('div[class*="language-"] > button.copy')){const l=i.parentElement,d=i.nextElementSibling;d&&s(l,d,i)}else if(i.matches('div[class*="language-"] div.copy-icon')){const l=i.parentElement,d=l.parentElement,u=l.nextElementSibling;u&&s(d,u,l)}}),tr(()=>n.value.path,()=>{(!a.value||vs)&&t()})})};var og=Pr({setup:()=>{ag()}});const ia=[sp,lp,mp,bp,Sp,bf,vf,Cf,Vf,Jf,og],tg=[["v-56dd2a2a","/InstallationNotes.html",{title:"Installation notes"},[":md"]],["v-8daa1a0e","/",{title:""},["/README.md"]],["v-2d0a7df8","/ca/",{title:"SAD - Lloc web de documentació"},["/ca/README.md"]],["v-2d0a870d","/en/",{title:"SAD - Página  de documentación"},["/en/README.md"]],["v-2d0a87a8","/es/",{title:"SAD - Página  de documentación"},["/es/README.md"]],["v-724914a8","/ca/ethical_hacking/a%20UnderstandingETandPT.html",{title:"1.1. Understanding Ethical Hacking & Penetration Testing"},["/ca/ethical_hacking/a UnderstandingETandPT.html","/ca/ethical_hacking/a UnderstandingETandPT.md",":md"]],["v-88f7c0c8","/ca/ethical_hacking/b%20Pentesting%20methodologies.html",{title:"1.2. Exploring Penetration Testing Methodologies"},["/ca/ethical_hacking/b Pentesting methodologies.html","/ca/ethical_hacking/b Pentesting methodologies.md",":md"]],["v-bd71d732","/ca/ethical_hacking/",{title:"1. Introduction to Ethical Hacking and Penetration Testing"},["/ca/ethical_hacking/index.md"]],["v-f39b1880","/ca/unit1/concurrency.html",{title:"1.2 Concurrency"},[":md"]],["v-3568b29a","/ca/unit1/",{title:"1 Introduction"},["/ca/unit1/index.md"]],["v-4d403dc3","/ca/unit1/operatingsystem.html",{title:"1.3 Processes in the OS"},[":md"]],["v-62d86b64","/ca/unit1/process.html",{title:"1.1 Processes, programs, threads"},[":md"]],["v-02f7a31f","/ca/unit2/curl_annex.html",{title:"2.4 Annex I - Curl"},[":md"]],["v-3568b2b9","/ca/unit2/",{title:"2 Introduction"},["/ca/unit2/index.md"]],["v-0b12bee5","/ca/unit2/iostreams.html",{title:"2.3 Handling Process Streams"},[":md"]],["v-69cbc2b4","/ca/unit2/processbuilder.html",{title:"2.2 Process management in Java - ProcessBuilder and Process"},[":md"]],["v-4144fd3a","/ca/unit2/runtime.html",{title:"2.1 Running processes in Java with Runtime"},[":md"]],["v-45db6c9a","/en/ethical_hacking/a%20UnderstandingETandPT.html",{title:"1.1. Understanding Ethical Hacking & Penetration Testing"},["/en/ethical_hacking/a UnderstandingETandPT.html","/en/ethical_hacking/a UnderstandingETandPT.md",":md"]],["v-1bb62067","/en/ethical_hacking/b%20Pentesting%20methodologies.html",{title:"1.2. Exploring Penetration Testing Methodologies"},["/en/ethical_hacking/b Pentesting methodologies.html","/en/ethical_hacking/b Pentesting methodologies.md",":md"]],["v-3804537c","/en/ethical_hacking/",{title:"1. Introduction to Ethical Hacking and Penetration Testing"},["/en/ethical_hacking/index.md"]],["v-5aa74f15","/en/unit1/concurrency.html",{title:"1.2 Concurrencia"},[":md"]],["v-b73e5022","/en/unit1/",{title:"1 Introducción"},["/en/unit1/index.md"]],["v-4b0532d0","/en/unit1/operatingsystem.html",{title:"1.3 Procesos en el SO"},[":md"]],["v-3f423939","/en/unit1/process.html",{title:"1.1 Procesos, programas, hilos"},[":md"]],["v-287508f8","/es/ethical_hacking/a%20UnderstandingETandPT.html",{title:"1.1. Understanding Ethical Hacking & Penetration Testing"},["/es/ethical_hacking/a UnderstandingETandPT.html","/es/ethical_hacking/a UnderstandingETandPT.md",":md"]],["v-4448d028","/es/ethical_hacking/b%20Pentesting%20methodologies.html",{title:"1.2. Exploring Penetration Testing Methodologies"},["/es/ethical_hacking/b Pentesting methodologies.html","/es/ethical_hacking/b Pentesting methodologies.md",":md"]],["v-0eddbe17","/es/ethical_hacking/",{title:"1. Introduction to Ethical Hacking and Penetration Testing"},["/es/ethical_hacking/index.md"]],["v-8100edac","/en/unit2/curl_annex.html",{title:"2.4 Anexo I - Curl"},[":md"]],["v-b73e4fe4","/en/unit2/",{title:"2 Introducción"},["/en/unit2/index.md"]],["v-74406b7a","/en/unit2/iostreams.html",{title:"2.3 Gestión de la E-S de un proceso"},[":md"]],["v-348bab3f","/en/unit2/processbuilder.html",{title:"2.2 Gestión de procesos en Java - ProcessBuilder y Process"},[":md"]],["v-1daecb0f","/en/unit2/runtime.html",{title:"2.1 Creación de procesos en Java con Runtime"},[":md"]],["v-46af1970","/es/unit1/concurrency.html",{title:"1.2 Concurrencia"},[":md"]],["v-a8728f6c","/es/unit1/",{title:"1 Introducción"},["/es/unit1/index.md"]],["v-e2dae91a","/es/unit1/operatingsystem.html",{title:"1.3 Procesos en el SO"},[":md"]],["v-75292dd8","/es/unit1/process.html",{title:"1.1 Procesos, programas, hilos"},[":md"]],["v-3277876f","/es/unit2/curl_annex.html",{title:"2.4 Anexo I - Curl"},[":md"]],["v-a8728f2e","/es/unit2/",{title:"2 Introducción"},["/es/unit2/index.md"]],["v-14dd1095","/es/unit2/iostreams.html",{title:"2.3 Gestión de la E-S de un proceso"},[":md"]],["v-5320ff04","/es/unit2/processbuilder.html",{title:"2.2 Gestión de procesos en Java - ProcessBuilder y Process"},[":md"]],["v-b8500a2c","/es/unit2/runtime.html",{title:"2.1 Creación de procesos en Java con Runtime"},[":md"]],["v-3706649a","/404.html",{title:""},[]]];var ys=ue({name:"Vuepress",setup(){const e=Gd();return()=>le(e.value)}}),sg=()=>tg.reduce((e,[r,n,a,o])=>(e.push({name:r,path:n,component:ys,meta:a},{path:n.endsWith("/")?n+"index.html":n.substring(0,n.length-5),redirect:n},...o.map(t=>({path:t===":md"?n.substring(0,n.length-5)+".md":t,redirect:n}))),e),[{name:"404",path:"/:catchAll(.*)",component:ys}]),ig=gu,cg=()=>{const e=Qu({history:ig(vi("/apuntes/")),routes:sg(),scrollBehavior:(r,n,a)=>a||(r.hash?{el:r.hash}:{top:0})});return e.beforeResolve(async(r,n)=>{var a;(r.path!==n.path||n===hr)&&([Tr.value]=await Promise.all([mr.resolvePageData(r.name),(a=Pi[r.name])==null?void 0:a.__asyncLoader()]))}),e},lg=e=>{e.component("ClientOnly",Fo),e.component("Content",Kd)},dg=(e,r,n)=>{const a=M(()=>mr.resolveLayouts(n)),o=ss(()=>r.currentRoute.value.path),t=ss(()=>mr.resolveRouteLocale(an.value.locales,o.value)),s=M(()=>mr.resolveSiteLocaleData(an.value,t.value)),c=M(()=>mr.resolvePageFrontmatter(Tr.value)),i=M(()=>mr.resolvePageHeadTitle(Tr.value,s.value)),l=M(()=>mr.resolvePageHead(i.value,c.value,s.value)),d=M(()=>mr.resolvePageLang(Tr.value,s.value)),u=M(()=>mr.resolvePageLayout(Tr.value,a.value));return e.provide(Hd,a),e.provide(qi,c),e.provide(Jd,i),e.provide(xi,l),e.provide(_i,d),e.provide(ki,u),e.provide(Mo,t),e.provide(ji,s),Object.defineProperties(e.config.globalProperties,{$frontmatter:{get:()=>c.value},$head:{get:()=>l.value},$headTitle:{get:()=>i.value},$lang:{get:()=>d.value},$page:{get:()=>Tr.value},$routeLocale:{get:()=>t.value},$site:{get:()=>an.value},$siteLocale:{get:()=>s.value},$withBase:{get:()=>Bo}}),{layouts:a,pageData:Tr,pageFrontmatter:c,pageHead:l,pageHeadTitle:i,pageLang:d,pageLayout:u,routeLocale:t,siteData:an,siteLocaleData:s}},ug=()=>{const e=Vd(),r=$d(),n=ge([]),a=()=>{e.value.forEach(t=>{const s=pg(t);s&&n.value.push(s)})},o=()=>{document.documentElement.lang=r.value,n.value.forEach(t=>{t.parentNode===document.head&&document.head.removeChild(t)}),n.value.splice(0,n.value.length),e.value.forEach(t=>{const s=mg(t);s!==null&&(document.head.appendChild(s),n.value.push(s))})};Gr(Yd,o),He(()=>{a(),o(),tr(()=>e.value,o)})},pg=([e,r,n=""])=>{const a=Object.entries(r).map(([c,i])=>be(i)?`[${c}=${JSON.stringify(i)}]`:i===!0?`[${c}]`:"").join(""),o=`head > ${e}${a}`;return Array.from(document.querySelectorAll(o)).find(c=>c.innerText===n)||null},mg=([e,r,n])=>{if(!be(e))return null;const a=document.createElement(e);return No(r)&&Object.entries(r).forEach(([o,t])=>{be(t)?a.setAttribute(o,t):t===!0&&a.setAttribute(o,"")}),be(n)&&a.appendChild(document.createTextNode(n)),a},hg=Rd,fg=async()=>{var n;const e=hg({name:"VuepressApp",setup(){var a;ug();for(const o of ia)(a=o.setup)==null||a.call(o);return()=>[le(Fi),...ia.flatMap(({rootComponents:o=[]})=>o.map(t=>le(t)))]}}),r=cg();lg(e),dg(e,r,ia);for(const a of ia)await((n=a.enhance)==null?void 0:n.call(a,{app:e,router:r,siteData:an}));return e.use(r),{app:e,router:r}};fg().then(({app:e,router:r})=>{r.isReady().then(()=>{e.mount("#app")})});export{_e as _,he as a,ne as b,Q as c,fg as createVueApp,Nr as d,Zl as e,ke as f,B as o,yr as r,Ae as t,Oe as w};
